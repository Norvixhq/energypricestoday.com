...
const BREAKING_NEWS = [
  { title: "Trump Orders Full Naval Blockade of Strait of Hormuz After Islamabad Talks Collapse", cat: "Geopolitics", slug: "geopolitics", time: "Breaking" },
  { title: "Oil Prices Expected to Surge as Markets Open Monday — Analysts Warn of $110+ WTI", cat: "Oil Prices", slug: "oil-prices", time: "2h ago" },
  { title: "Iran Blames U.S. for Failure of 21-Hour Islamabad Negotiations", cat: "Geopolitics", slug: "geopolitics", time: "4h ago" },
  { title: "Two-Week Ceasefire Expires April 22 — No Extension Path After Failed Talks", cat: "Geopolitics", slug: "geopolitics", time: "6h ago" },
  { title: "Israel-Lebanon Direct Negotiations Set for Tuesday in Washington", cat: "Geopolitics", slug: "geopolitics", time: "8h ago" },
  { title: "Saudi Aramco Restores East-West Pipeline Capacity After Drone Damage", cat: "Oil Prices", slug: "oil-prices", time: "10h ago" },
  { title: "U.S. Gas Prices Hold at $4.13 National Average as Ceasefire Uncertainty Persists", cat: "Gas Prices", slug: "gas-prices", time: "12h ago" },
  { title: "Pakistan Urges Continued Diplomacy — Foreign Minister Says Ceasefire Must Hold", cat: "Geopolitics", slug: "geopolitics", time: "14h ago" },
];
...
const US_GAS_NATIONAL = { regular: 4.125, mid: 4.572, premium: 4.946, diesel: 5.574, source: "AAA Daily Fuel Gauge Report", updated: "As of April 13, 2026" };
