...
const COMMODITIES = [
  { name: "WTI Crude", price: 103.50, change: 1.65, pct: 1.62, unit: "$/bbl", spark: [95.42,98.07,102.18,101.85,102.00,101.85,103.50], loading: false },
  { name: "Brent Crude", price: 106.92, change: 1.17, pct: 1.11, unit: "$/bbl", spark: [101.29,104.21,107.77,107.05,106.50,105.75,106.92], loading: false },
  { name: "Natural Gas", price: 2.83, change: 0.02, pct: 0.71, unit: "$/MMBtu", spark: [2.72,2.71,2.76,2.79,2.81,2.82,2.83], loading: false },
  { name: "Gasoline RBOB", price: 3.56, change: 0.05, pct: 1.43, unit: "$/gal", spark: [3.28,3.42,3.53,3.51,3.52,3.53,3.56], loading: false },
  { name: "Heating Oil", price: 4.27, change: 0.04, pct: 0.95, unit: "$/gal", spark: [3.96,4.12,4.25,4.23,4.24,4.23,4.27], loading: false },
  { name: "Murban Crude", price: 110.20, change: 1.10, pct: 1.01, unit: "$/bbl", spark: [103.10,107.40,109.50,109.10,109.50,109.10,110.20], loading: false },
  { name: "Diesel ULSD", price: 4.27, change: 0.04, pct: 0.95, unit: "$/gal", spark: [3.96,4.12,4.25,4.23,4.24,4.23,4.27], loading: false },
  { name: "Jet Fuel", price: 4.66, change: 0.05, pct: 1.08, unit: "$/gal", spark: [4.31,4.49,4.63,4.61,4.62,4.61,4.66], loading: false },
...
const BREAKING_NEWS = [
  ...
  { title: "WTI on Track for ~10% Weekly Gain as Hormuz Closure Drags On", cat: "Oil Markets", slug: "oil-prices", time: "2h" },
  { title: "Trump Warns Iran to Reach a Deal or Face 'Annihilation'", cat: "Geopolitics", slug: "geopolitics", time: "3h" },
  { title: "Treasury Secretary Bessent: 'China Has a Much Bigger Interest in Reopening the Strait Than the U.S. Does'", cat: "Geopolitics", slug: "geopolitics", time: "5h" },
  ...
  { title: "AAA National Gas Average Reaches $4.534, Highest Since 2022", cat: "Gas Prices", slug: "gas-prices", time: "2h" },
];

const MARKET_DRIVERS = [
  { cat: "Deal Largely Negotiated", icon: "check-circle", title: "Trump: U.S.-Iran Agreement 'Largely Negotiated'; Strait of Hormuz to Reopen", desc: "President Trump said on Truth Social Saturday that an agreement involving the United States, Iran, and several regional countries had been \"largely negotiated\" and that the Strait of Hormuz will be reopened. \"Final aspects and details of the Deal are currently being discussed, and will be announced shortly.\" The framework under discussion: a 60-day ceasefire extension during which Iran clears mines from the strait, the U.S. lifts its naval blockade, and parallel negotiations begin on Iran's nuclear program and frozen Iranian assets. A flurry of regional diplomacy (Pakistan, Qatar, Saudi Arabia, UAE, Turkey, Egypt, Jordan, Bahrain) is pressing Washington to accept." },
  { cat: "60-Day MOU Framework", icon: "file-text", title: "U.S. and Iran Near 60-Day Memorandum of Understanding to Extend Ceasefire and Reopen Hormuz", desc: "The Washington Post and Financial Times reported the U.S. and Iran are close to extending their ceasefire by 60 days under a framework that would gradually reopen the Strait of Hormuz and launch discussions on Tehran's highly enriched uranium stockpile. During the 60-day period, the strait would be open with no tolls and Iran would clear the mines it deployed to let ships pass freely; in exchange, the U.S. lifts its blockade on Iranian ports and issues some sanctions relief. Iran's foreign ministry described the draft as a \"framework agreement\" with details to be worked out over 30 to 60 days." },
  { cat: "Sticking Points Remain", icon: "alert-triangle", title: "Iran Says Hormuz 'Will Have Costs'; Tolls and Uranium Still Unresolved", desc: "Iran's foreign ministry said Tuesday that navigation through the Strait of Hormuz \"will have costs,\" reigniting concerns about a permanent transit-fee regime even as a broader peace framework takes shape. Iran's Fars news agency reported the strait \"would remain under Iran's management\" per the latest exchanged text. Secretary of State Marco Rubio said any deal could still take several days to complete, with unresolved issues including Tehran's frozen assets and Iran's hesitation to guarantee unrestricted passage. Brent fell to roughly $98–$99 Tuesday as traders weighed deal progress against unresolved details." },
  { cat: "Defensive Strikes Resume", icon: "shield", title: "U.S. CENTCOM Conducts Defensive Strikes in Southern Iran; IRGC Claims F-35 Engagement", desc: "U.S. Central Command said Tuesday it conducted \"self-defense strikes\" in southern Iran, targeting missile launch sites and Iranian boats attempting to emplace mines in the Strait of Hormuz. Iran's Revolutionary Guard Corps claimed it engaged an F-35 fighter jet and several drones after they allegedly entered Iranian airspace. The dual posture — diplomatic engagement combined with publicly visible military readiness — preserves Washington's negotiating leverage even as a 60-day framework agreement nears finalization. Trump honored 13 service members killed during Operation Epic Fury in Memorial Day remarks at Arlington." },
  { cat: "Memorial Day Pullback", icon: "fuel", title: "Memorial Day Travel Ends; AAA National Slips to $4.491 as Some States See Relief", desc: "The four-year-high Memorial Day weekend gas prices began easing Tuesday, with AAA's national average slipping to $4.491 — down from $4.552 on Friday. Some states saw notable pullbacks: Michigan fell 20 cents week-on-week to $4.63, while Oregon set a Memorial Day all-time record at $5.32. AAA spokesperson: \"While the recent drop is welcome, continued volatility and higher crude oil prices could quickly push pump prices higher again.\" The pullback reflects easing crude prices (WTI briefly below $90 Monday) on deal-progression news, though state-level dispersion remains wide." },
  { cat: "Oil Slides on Deal Optimism", icon: "trending-down", title: "WTI Briefly Below $90 for First Time in Three Weeks; Brent Touches Five-Week Low", desc: "WTI crude briefly fell below $90 a barrel Monday for the first time in almost three weeks amid signs the U.S. and Iran were progressing toward an agreement to reopen the Strait of Hormuz. Brent traded around $98–$100 Tuesday, near a five-week low, before defensive-strikes news caused a partial rebound. Markets are now balancing peace optimism against unresolved tolls and uranium issues. UBS noted observed global oil inventories dropped a combined 246 million barrels in March and April; cumulative production losses could exceed 1 billion barrels by the end of May. Energy executives still warn full normalization may not occur until 2027." },
];

const FEATURED_ARTICLES = [
  { id: 101, title: "Trump: U.S.-Iran Agreement 'Largely Negotiated'; Strait of Hormuz to Reopen Under 60-Day Framework", excerpt: "President Trump said on Truth Social Saturday that an agreement involving the United States, Iran, and several regional countries had been \"largely negotiated\" and that the Strait of Hormuz will be reopened. The framework under discussion: a 60-day ceasefire extension during which Iran clears mines and the U.S. lifts its naval blockade, with parallel negotiations on Iran's nuclear program. A flurry of regional diplomacy (Pakistan, Qatar, Saudi Arabia, UAE, Turkey, Egypt, Jordan, Bahrain) is pressing Washington to accept. Final details still being discussed.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 26, 2026", readTime: "6 min", featured: true },
  { id: 102, title: "U.S. CENTCOM Conducts Defensive Strikes in Southern Iran; IRGC Claims F-35 Engagement", excerpt: "U.S. Central Command said Tuesday it conducted \"self-defense strikes\" in southern Iran, targeting missile launch sites and Iranian boats attempting to emplace mines in the Strait of Hormuz. Iran's Revolutionary Guard Corps claimed it engaged an F-35 fighter jet and several drones after they allegedly entered Iranian airspace. The dual posture \u2014 diplomatic engagement combined with publicly visible military readiness \u2014 preserves Washington's negotiating leverage even as a 60-day framework agreement nears finalization.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 26, 2026", readTime: "5 min" },
  { id: 103, title: "Memorial Day Weekend Ends with $4.491 National Average; Oil Prices Slide on Deal Optimism", excerpt: "AAA's national average for regular gasoline slipped to $4.491 Tuesday \u2014 down from $4.552 Friday \u2014 as the four-year-high Memorial Day weekend ended and crude prices retreated on U.S.-Iran deal-progression news. Michigan fell 20 cents week-on-week. Oregon set a Memorial Day all-time record at $5.32. WTI briefly fell below $90 Monday for the first time in nearly three weeks; Brent traded near five-week lows around $98\u2013$99 Tuesday.", cat: "Gas Prices", slug: "gas-prices", author: "EnergyPricesToday Editorial", date: "May 26, 2026", readTime: "5 min" },
  { id: 104, title: "U.S. Oil Rig Count Jumps 10 to 425 \u2014 Biggest Weekly Gain Since 2022", excerpt: "Baker Hughes reported Friday May 22 the U.S. oil rig count rose by 10 to 425 \u2014 the largest single-week increase in oil-directed drilling since 2022. The acceleration is concentrated in West Texas (Permian) and South Texas (Eagle Ford). Rising rigs today translate to higher production volumes six to twelve months out \u2014 a forward-looking signal U.S. shale is starting to monetize the sustained elevated-price environment. Next release Friday May 29.", cat: "Oil Markets", slug: "oil-prices", author: "EnergyPricesToday Editorial", date: "May 22, 2026", readTime: "5 min" },
  { id: 105, title: "Iran Says Hormuz 'Will Have Costs'; Tolls and Uranium Still Unresolved", excerpt: "Iran's foreign ministry said Tuesday that navigation through the Strait of Hormuz \"will have costs,\" reigniting concerns about a permanent transit-fee regime even as a broader peace framework takes shape. Iran's Fars news agency reported the strait \"would remain under Iran's management\" per the latest exchanged text. Secretary of State Rubio said any deal could still take several days, with unresolved issues including Tehran's frozen assets and Iran's hesitation to guarantee unrestricted passage.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 26, 2026", readTime: "5 min" },
  { id: 106, title: "Trump Threatens Renewed Iran Strikes if Talks Fail; Markets Swing on Mixed Signals", excerpt: "President Trump threatened renewed military strikes if U.S.-Iran talks fail to produce a deal, Bloomberg reported Friday May 22. The threat punctuated a week of mixed signals \u2014 Tehran said the latest U.S. proposal narrowed differences, but disputes over uranium and Hormuz tolls quickly reignited tensions. The diplomatic track has since shifted decisively toward a 60-day framework agreement, though military readiness remains visible.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 22, 2026", readTime: "5 min" },
];

const COMPANY_NEWS = [
  { id: 201, title: "Trump: U.S.-Iran Agreement 'Largely Negotiated'; Strait of Hormuz to Reopen Under 60-Day Framework", date: "May 26, 2026" },
  { id: 202, title: "U.S. CENTCOM Conducts Defensive Strikes in Southern Iran; IRGC Claims F-35 Engagement", date: "May 26, 2026" },
  { id: 203, title: "Memorial Day Weekend Ends with $4.491 National Average; Oil Prices Slide on Deal Optimism", date: "May 26, 2026" },
  { id: 204, title: "U.S. Oil Rig Count Jumps 10 to 425 \u2014 Biggest Weekly Gain Since 2022", date: "May 22, 2026" },
  { id: 205, title: "Iran Says Hormuz 'Will Have Costs'; Tolls and Uranium Still Unresolved", date: "May 26, 2026" },
  { id: 206, title: "Trump Threatens Renewed Iran Strikes if Talks Fail; Markets Swing on Mixed Signals", date: "May 22, 2026" },
];

const GEO_ITEMS = [
  { id: 301, region: "United States", title: "Trump: Agreement with Iran 'Largely Negotiated'; Hormuz to Reopen Under 60-Day Framework", desc: "President Trump said Saturday an agreement involving the U.S., Iran, and several regional countries had been \"largely negotiated\" and that the Strait of Hormuz will be reopened. The framework under discussion: a 60-day ceasefire extension during which Iran clears mines and the U.S. lifts its naval blockade, with parallel negotiations on Iran's nuclear program and frozen assets. Final details still being worked out. Rubio said completion could take \"several more days.\"" },
  { id: 302, region: "Iran", title: "Iran Foreign Ministry: Hormuz Navigation 'Will Have Costs'; Strait 'Remains Under Iran\u2019s Management'", desc: "Iran's foreign ministry said Tuesday that navigation through the Strait of Hormuz \"will have costs,\" complicating the deal track even as a 60-day MOU framework takes shape. Iran's Fars news agency reported the strait \"would remain under Iran's management\" per the latest exchanged text. Iran's foreign ministry spokesperson Esmail Baghaei described the draft as a \"framework agreement.\" Nuclear issues are not part of current negotiations per Baghaei; lifting sanctions \"explicitly included in the text.\" Iran's 87-day internet blackout partially lifted today." },
  { id: 303, region: "Strait of Hormuz", title: "U.S. CENTCOM Defensive Strikes; IRGC Claims F-35 Engagement as Mines Set to Be Cleared", desc: "U.S. Central Command said Tuesday it conducted \"self-defense strikes\" in southern Iran, targeting missile launch sites and Iranian boats attempting to emplace mines in the strait. Iran's IRGC claimed it engaged an F-35 fighter jet and several drones in Iranian airspace. Under the proposed 60-day framework, Iran would clear the mines it deployed to let ships pass freely with no tolls during that period. WTI briefly fell below $90 Monday; Brent traded around $98\u2013$99 Tuesday near five-week lows." },
  { id: 304, region: "Regional Diplomacy", title: "Pakistan, Qatar, Saudi Arabia, UAE, Turkey, Egypt, Jordan, Bahrain Press Washington to Accept Deal", desc: "A flurry of regional diplomacy preceded Trump's \"largely negotiated\" announcement. Pakistani and Qatari negotiators held talks with Iranian counterparts Thursday and Friday while staying in regular contact with U.S. envoy Steve Witkoff. Saudi Arabia, the UAE, and Qatar \u2014 the same Gulf states that asked Trump to call off the May 19 planned strike \u2014 are again urging diplomatic resolution. Trump credited the regional partners for facilitating the framework. G7 leaders summit June 15\u201317 in Evian." },
  { id: 305, region: "Global Markets", title: "Oil Slides on Deal Optimism; WTI Briefly Below $90, Brent Touches Five-Week Low", desc: "WTI crude briefly fell below $90 a barrel Monday for the first time in almost three weeks amid signs the U.S. and Iran were progressing toward an agreement. Brent traded around $98\u2013$100 Tuesday near five-week lows before defensive-strikes news caused a partial rebound. UBS: observed global oil inventories dropped 246 million barrels combined in March and April; cumulative production losses could exceed 1 billion barrels by end of May. MUFG: \"Full normalization of Middle East oil supply may not occur until 2027 due to the scale of disruptions.\"" },
  { id: 306, region: "U.S. Consumers", title: "Memorial Day Weekend Ends with $4.491 National Average; State-Level Pullbacks Begin", desc: "AAA's national average slipped to $4.491 Tuesday from $4.552 Friday as the four-year-high Memorial Day weekend ended. Michigan fell 20 cents week-on-week to $4.63. Oregon set a Memorial Day all-time record at $5.32. AAA-The Auto Club Group: \"While the recent drop is welcome, continued volatility and higher crude oil prices could quickly push pump prices higher again.\" GasBuddy's summer model still points to a $4.80 nationwide average if conditions persist; deal progression has injected real downside potential for the first time since February." },
];
...
const RIG_COUNT_DATA = {
  // U.S. — Baker Hughes North America Rig Count, May 15, 2026
  us_total: 561, us_total_change: 10, us_oil: 425, us_oil_change: 10, us_gas: 128, us_gas_change: 0, us_misc: 8, us_misc_change: 0,
  us_land: 540, us_offshore: 11, us_inland: 0,
  us_directional: 49, us_horizontal: 490, us_vertical: 12,
  us_yoy: -25, us_yoy_total: 576,
  us_gom: 10,
  // Canada — May 15, 2026 (unchanged from prior week)
  canada_total: 124, canada_change: 0, canada_oil: 76, canada_gas: 48,
  canada_yoy: -8, canada_yoy_total: 132,
  // North America
  na_total: 675, na_change: 3, na_yoy: -33, na_yoy_total: 708,
  ...
  source: "Baker Hughes", updated: "U.S./Canada: May 15, 2026 | International: April 2026"
};
...
const GAS_PRICES_BY_STATE = [
  { state:"Alabama", abbr:"AL", regular:4.229, mid:4.728, premium:5.184, diesel:5.994 },
  { state:"Alaska", abbr:"AK", regular:5.148, mid:5.394, premium:5.656, diesel:6.598 },
  { state:"Arizona", abbr:"AZ", regular:5.143, mid:5.572, premium:5.925, diesel:6.69 },
  { state:"Arkansas", abbr:"AR", regular:4.029, mid:4.536, premium:4.953, diesel:5.722 },
  { state:"California", abbr:"CA", regular:6.15, mid:6.42, premium:6.62, diesel:6.89 },
  { state:"Colorado", abbr:"CO", regular:4.373, mid:4.821, premium:5.184, diesel:5.721 },
  { state:"Connecticut", abbr:"CT", regular:4.54, mid:5.149, premium:5.587, diesel:6.578 },
  { state:"Delaware", abbr:"DE", regular:4.387, mid:5.062, premium:5.403, diesel:6.406 },
  { state:"District of Columbia", abbr:"DC", regular:4.788, mid:5.456, premium:5.879, diesel:6.57 },
  { state:"Florida", abbr:"FL", regular:4.576, mid:5.098, premium:5.467, diesel:6.223 },
  { state:"Georgia", abbr:"GA", regular:4.058, mid:4.575, premium:5.047, diesel:5.811 },
  { state:"Hawaii", abbr:"HI", regular:5.65, mid:5.88, premium:6.11, diesel:5.46 },
  { state:"Idaho", abbr:"ID", regular:4.804, mid:5.142, premium:5.444, diesel:6.13 },
  { state:"Illinois", abbr:"IL", regular:4.82, mid:5.469, premium:5.992, diesel:6.024 },
  { state:"Indiana", abbr:"IN", regular:4.272, mid:4.885, premium:5.439, diesel:6.018 },
  { state:"Iowa", abbr:"IA", regular:4.019, mid:4.269, premium:4.954, diesel:5.611 },
  { state:"Kansas", abbr:"KS", regular:4.025, mid:4.475, premium:4.825, diesel:5.555 },
  { state:"Kentucky", abbr:"KY", regular:4.392, mid:5.016, premium:5.493, diesel:5.94 },
  { state:"Louisiana", abbr:"LA", regular:4.01, mid:4.44, premium:4.79, diesel:5.52 },
  { state:"Maine", abbr:"ME", regular:4.442, mid:5.047, premium:5.591, diesel:6.516 },
  { state:"Maryland", abbr:"MD", regular:4.527, mid:5.211, premium:5.566, diesel:6.46 },
  { state:"Massachusetts", abbr:"MA", regular:4.417, mid:5.081, premium:5.507, diesel:6.539 },
  { state:"Michigan", abbr:"MI", regular:4.315, mid:4.982, premium:5.616, diesel:5.833 },
  { state:"Minnesota", abbr:"MN", regular:4.093, mid:4.576, premium:5.125, diesel:5.647 },
  { state:"Mississippi", abbr:"MS", regular:4.0, mid:4.43, premium:4.78, diesel:5.49 },
  { state:"Missouri", abbr:"MO", regular:4.057, mid:4.514, premium:4.863, diesel:5.43 },
  { state:"Montana", abbr:"MT", regular:4.315, mid:4.656, premium:5.04, diesel:5.554 },
  { state:"Nebraska", abbr:"NE", regular:4.03, mid:4.475, premium:4.825, diesel:5.555 },
  { state:"Nevada", abbr:"NV", regular:5.495, mid:5.852, premium:6.174, diesel:6.984 },
  { state:"New Hampshire", abbr:"NH", regular:4.391, mid:5.009, premium:5.526, diesel:6.469 },
  { state:"New Jersey", abbr:"NJ", regular:4.426, mid:5.045, premium:5.34, diesel:6.485 },
  { state:"New Mexico", abbr:"NM", regular:4.348, mid:4.825, premium:5.172, diesel:6.015 },
  { state:"New York", abbr:"NY", regular:4.602, mid:5.166, premium:5.592, diesel:6.637 },
  { state:"North Carolina", abbr:"NC", regular:4.254, mid:4.751, premium:5.198, diesel:6.331 },
  { state:"North Dakota", abbr:"ND", regular:4.04, mid:4.49, premium:4.84, diesel:5.58 },
  { state:"Ohio", abbr:"OH", regular:4.173, mid:4.772, premium:5.346, diesel:5.977 },
  { state:"Oklahoma", abbr:"OK", regular:4.03, mid:4.47, premium:4.82, diesel:5.54 },
  { state:"Oregon", abbr:"OR", regular:5.538, mid:5.792, premium:6.095, diesel:7.014 },
  { state:"Pennsylvania", abbr:"PA", regular:4.566, mid:5.06, premium:5.482, diesel:6.721 },
  { state:"Rhode Island", abbr:"RI", regular:4.412, mid:5.16, premium:5.637, diesel:6.436 },
  { state:"South Carolina", abbr:"SC", regular:4.171, mid:4.67, premium:5.118, diesel:6.195 },
  { state:"South Dakota", abbr:"SD", regular:4.074, mid:4.271, premium:4.799, diesel:5.371 },
  { state:"Tennessee", abbr:"TN", regular:4.253, mid:4.771, premium:5.209, diesel:6.017 },
  { state:"Texas", abbr:"TX", regular:4.01, mid:4.46, premium:4.81, diesel:5.53 },
  { state:"Utah", abbr:"UT", regular:4.66, mid:4.973, premium:5.251, diesel:5.955 },
  { state:"Vermont", abbr:"VT", regular:4.546, mid:5.099, premium:5.614, diesel:6.532 },
  { state:"Virginia", abbr:"VA", regular:4.38, mid:4.91, premium:5.332, diesel:6.364 },
  { state:"Washington", abbr:"WA", regular:5.77, mid:5.92, premium:6.08, diesel:5.69 },
  { state:"West Virginia", abbr:"WV", regular:4.343, mid:4.806, premium:5.318, diesel:6.137 },
  { state:"Wisconsin", abbr:"WI", regular:4.166, mid:4.735, premium:5.393, diesel:5.513 },
  { state:"Wyoming", abbr:"WY", regular:4.284, mid:4.631, premium:4.96, diesel:5.61 }
];
