...
const BREAKING_NEWS = [
  { title: "Israel and Lebanon Begin 10-Day Ceasefire at 5 P.M. Thursday, Trump Announces", cat: "Geopolitics", slug: "geopolitics", time: "1h" },
  { title: "Trump Says U.S. 'Very Close' to Deal with Iran as Ceasefire Nears April 22 Expiration", cat: "Geopolitics", slug: "geopolitics", time: "2h" },
  { title: "WTI Jumps 3.7% to $94.62 on Surprise 9.13 Million Barrel U.S. Inventory Draw", cat: "Oil Markets", slug: "oil-prices", time: "3h" },
  { title: "AAA National Gas Average Falls 7 Cents to $4.09 — First Decline in Weeks", cat: "Gas Prices", slug: "gas-prices", time: "4h" },
  { title: "Pakistan PM Sharif Visits Qatar, Turkey in Continued U.S.-Iran Mediation Effort", cat: "Geopolitics", slug: "geopolitics", time: "5h" },
  { title: "Strait of Hormuz Remains Closed to Most Commercial Traffic Despite Ceasefire", cat: "Geopolitics", slug: "geopolitics", time: "6h" },
  { title: "Brent Rises 4% as Doubts Resurface Over Scope of Iran Deal", cat: "Oil Markets", slug: "oil-prices", time: "7h" },
  { title: "EIA Reports Second Consecutive Weekly Crude Draw, Cushing Stocks Below 5-Year Average", cat: "Oil Markets", slug: "oil-prices", time: "8h" },
];

const MARKET_DRIVERS = [
  { cat: "Ceasefire Extension", icon: "globe", title: "Two-Week Extension Under Discussion", desc: "April 8 ceasefire expires April 22. Both sides reportedly considering 2-week extension. Trump says U.S. is 'very close' to a deal with Iran. Strait of Hormuz remains closed to most commercial traffic." },
  { cat: "Israel-Lebanon", icon: "shield", title: "10-Day Ceasefire Begins Thursday 5 P.M.", desc: "Israel and Lebanon agreed to a 10-day ceasefire effective 5 PM local time April 16. Israel to respond only to 'imminent threats from Hezbollah.' Netanyahu rejected Hezbollah's demanded terms." },
  { cat: "Crude Oil", icon: "trending-up", title: "WTI Up 3.7% on Inventory Shock", desc: "U.S. crude inventories fell 9.13 million barrels — far above the 154,000 barrel increase analysts expected. WTI closed up $3.40 at $94.62; Brent up 4%. Second consecutive weekly draw." },
  { cat: "Gas Prices", icon: "fuel", title: "AAA National Falls 7 Cents to $4.09", desc: "First weekly decline in the national average since the conflict began. Pump prices easing as crude trades below $100, though still 29% above year-ago levels. Texas at $3.74, Oklahoma cheapest at $3.44." },
  { cat: "OPEC+", icon: "users", title: "April 206K bpd Increase Proceeds", desc: "OPEC+ proceeding with planned April output increase despite conflict. Saudi Arabia restored East-West Pipeline capacity. No emergency meeting called; market monitoring for shifts if ceasefire collapses." },
  { cat: "Refining", icon: "tool", title: "Gasoline Futures Up 3.1%, Cracks Widen", desc: "RBOB gasoline up $0.0945 Thursday. Summer blend transition and refinery turnarounds tightening distillate supply. U.S. refinery utilization at ~87%, Gulf Coast ramping for driving season." },
];

const FEATURED_ARTICLES = [
  { id: 101, title: "Israel-Lebanon Ceasefire Takes Effect as Hormuz Remains Closed", excerpt: "The 10-day Israel-Lebanon ceasefire beginning at 5 PM Thursday marks a significant de-escalation, but the Strait of Hormuz remains effectively blocked and the broader U.S.-Iran ceasefire expires April 22.", cat: "Geopolitics", slug: "geopolitics", author: "Staff", date: "Apr 16, 2026", readTime: "7 min", featured: true },
  { id: 102, title: "Surprise 9.13 Million Barrel Crude Draw Sends WTI Above $94", excerpt: "U.S. crude inventories fell 9.13 million barrels last week, far above the 154,000 barrel increase analysts expected. Second consecutive weekly draw signals tightening supply.", cat: "Oil Markets", slug: "oil-prices", author: "Staff", date: "Apr 16, 2026", readTime: "5 min" },
  { id: 103, title: "AAA Gas Average Falls 7 Cents in First Weekly Decline of Conflict", excerpt: "The national average dropped to $4.09 — the first weekly decline since the Iran conflict began. Crude trading below $100 is slowly flowing through to the pump.", cat: "Gas Prices", slug: "gas-prices", author: "Staff", date: "Apr 16, 2026", readTime: "4 min" },
  { id: 104, title: "OPEC+ Proceeds with April Output Increase Despite Conflict", excerpt: "The 206,000 bpd April increase moves forward without adjustment. Saudi Arabia has restored East-West Pipeline capacity. Market watching for emergency meeting if ceasefire collapses.", cat: "Oil Markets", slug: "oil-prices", author: "Staff", date: "Apr 15, 2026", readTime: "6 min" },
  { id: 105, title: "Pakistan Mediation Effort Intensifies Ahead of April 22 Deadline", excerpt: "Pakistan PM Sharif visits Qatar and Turkey while Army Chief Munir continues Iran engagement. Pakistani officials may return to Washington this week for next round of U.S.-Iran talks.", cat: "Geopolitics", slug: "geopolitics", author: "Staff", date: "Apr 15, 2026", readTime: "6 min" },
];

const COMPANY_NEWS = [
  { id: 201, title: "ExxonMobil Q1 Earnings Expected to Benefit from Elevated Crude Prices", date: "Apr 16, 2026" },
  { id: 202, title: "Chevron-Hess Arbitration Ruling Expected in Coming Weeks", date: "Apr 15, 2026" },
  { id: 203, title: "Cheniere Sees Strong Q1 LNG Demand Amid Hormuz Disruption", date: "Apr 15, 2026" },
  { id: 204, title: "Shell Reports Higher Q1 Upstream Earnings, Maintains Dividend", date: "Apr 14, 2026" },
...
const GEO_ITEMS = [
  { id: 301, region: "Middle East", title: "Israel and Lebanon Begin 10-Day Ceasefire at 5 P.M. Thursday", desc: "Trump announced the agreement Thursday. Israel will 'respond only to imminent threats from Hezbollah.' Netanyahu rejected Hezbollah-demanded terms. Uncertainty remains over how Hezbollah responds." },
  { id: 302, region: "Middle East", title: "Trump Says U.S. 'Very Close' to Deal with Iran", desc: "Speaking outside the White House Thursday, Trump voiced optimism the war will end soon. Pakistani officials traveling to Iran ahead of possibly returning to Washington for next round of U.S.-Iran talks." },
  { id: 303, region: "Persian Gulf", title: "Strait of Hormuz Remains Closed Despite Ceasefire Framework", desc: "90%+ of commercial shipping still blocked. ADNOC CEO says 230 loaded oil tankers waiting inside the Gulf. China's UN ambassador calls for strait to be 'safeguarded' for international navigation." },
  { id: 304, region: "Diplomacy", title: "Pakistan PM Sharif Tours Qatar, Turkey in Mediation Effort", desc: "Sharif visited Saudi Arabia Thursday before departing for Qatar. Army Chief Asim Munir continuing diplomatic engagement with Iran. Pakistan recognized for 'constructive role' in de-escalation." },
  { id: 305, region: "Russia", title: "Russian Oil Exports Shift Further Toward Asian Markets", desc: "Moscow redirects crude flows to India and China at $10-15 discount. EU oil embargo holding but enforcement varies. Nord Stream destroyed; remaining pipeline gas minimal." },
  { id: 306, region: "Americas", title: "Venezuela Sanctions Remain in Place Amid Election Concerns", desc: "U.S. sanctions on Venezuelan crude continue. Production at ~800,000 bpd, well below 2015 peak. Limited upside without infrastructure investment and sanctions relief." },
];
...
const GAS_PRICES_BY_STATE = [
  { state:"Alabama", abbr:"AL", regular:3.82, mid:4.266, premium:4.675, diesel:5.4 },
  { state:"Alaska", abbr:"AK", regular:4.643, mid:4.864, premium:5.097, diesel:5.94 },
  { state:"Arizona", abbr:"AZ", regular:4.638, mid:5.022, premium:5.338, diesel:6.023 },
  { state:"Arkansas", abbr:"AR", regular:3.642, mid:4.095, premium:4.467, diesel:5.156 },
  { state:"California", abbr:"CA", regular:5.864, mid:6.108, premium:6.286, diesel:7.625 },
  { state:"Colorado", abbr:"CO", regular:3.948, mid:4.351, premium:4.675, diesel:5.155 },
  { state:"Connecticut", abbr:"CT", regular:4.074, mid:4.619, premium:5.01, diesel:5.898 },
  { state:"Delaware", abbr:"DE", regular:3.957, mid:4.561, premium:4.867, diesel:5.765 },
  { state:"District of Columbia", abbr:"DC", regular:4.276, mid:4.873, premium:5.252, diesel:5.871 },
  { state:"Florida", abbr:"FL", regular:4.127, mid:4.594, premium:4.926, diesel:5.602 },
  { state:"Georgia", abbr:"GA", regular:3.666, mid:4.129, premium:4.552, diesel:5.237 },
  { state:"Hawaii", abbr:"HI", regular:5.659, mid:5.894, premium:6.136, diesel:7.122 },
  { state:"Idaho", abbr:"ID", regular:4.336, mid:4.637, premium:4.906, diesel:5.523 },
  { state:"Illinois", abbr:"IL", regular:4.35, mid:4.931, premium:5.398, diesel:5.427 },
  { state:"Indiana", abbr:"IN", regular:3.857, mid:4.406, premium:4.902, diesel:5.422 },
  { state:"Iowa", abbr:"IA", regular:3.632, mid:3.855, premium:4.469, diesel:5.057 },
  { state:"Kansas", abbr:"KS", regular:3.502, mid:3.829, premium:4.164, diesel:4.757 },
  { state:"Kentucky", abbr:"KY", regular:3.966, mid:4.526, premium:4.952, diesel:5.351 },
  { state:"Louisiana", abbr:"LA", regular:3.736, mid:4.175, premium:4.561, diesel:5.235 },
  { state:"Maine", abbr:"ME", regular:4.009, mid:4.552, premium:5.039, diesel:5.868 },
  { state:"Maryland", abbr:"MD", regular:4.096, mid:4.709, premium:5.027, diesel:5.826 },
  { state:"Massachusetts", abbr:"MA", regular:3.957, mid:4.55, premium:4.933, diesel:5.857 },
  { state:"Michigan", abbr:"MI", regular:3.896, mid:4.495, premium:5.061, diesel:5.256 },
  { state:"Minnesota", abbr:"MN", regular:3.697, mid:4.13, premium:4.622, diesel:5.088 },
  { state:"Mississippi", abbr:"MS", regular:3.736, mid:4.164, premium:4.561, diesel:5.229 },
  { state:"Missouri", abbr:"MO", regular:3.665, mid:4.075, premium:4.387, diesel:4.894 },
  { state:"Montana", abbr:"MT", regular:3.896, mid:4.202, premium:4.545, diesel:5.006 },
  { state:"Nebraska", abbr:"NE", regular:3.626, mid:3.796, premium:4.258, diesel:4.896 },
  { state:"Nevada", abbr:"NV", regular:4.953, mid:5.273, premium:5.56, diesel:6.287 },
  { state:"New Hampshire", abbr:"NH", regular:3.945, mid:4.499, premium:4.962, diesel:5.805 },
  { state:"New Jersey", abbr:"NJ", regular:3.985, mid:4.538, premium:4.803, diesel:5.827 },
  { state:"New Mexico", abbr:"NM", regular:3.927, mid:4.355, premium:4.664, diesel:5.418 },
  { state:"New York", abbr:"NY", regular:4.118, mid:4.624, premium:5.005, diesel:5.941 },
  { state:"North Carolina", abbr:"NC", regular:3.841, mid:4.288, premium:4.687, diesel:5.701 },
  { state:"North Dakota", abbr:"ND", regular:3.612, mid:3.954, premium:4.37, diesel:4.882 },
  { state:"Ohio", abbr:"OH", regular:3.771, mid:4.306, premium:4.821, diesel:5.385 },
  { state:"Oklahoma", abbr:"OK", regular:3.435, mid:3.852, premium:4.139, diesel:4.756 },
  { state:"Oregon", abbr:"OR", regular:4.992, mid:5.218, premium:5.491, diesel:6.311 },
  { state:"Pennsylvania", abbr:"PA", regular:4.121, mid:4.563, premium:4.94, diesel:6.051 },
  { state:"Rhode Island", abbr:"RI", regular:3.967, mid:4.643, premium:5.069, diesel:5.785 },
  { state:"South Carolina", abbr:"SC", regular:3.769, mid:4.215, premium:4.615, diesel:5.58 },
  { state:"South Dakota", abbr:"SD", regular:3.68, mid:3.856, premium:4.331, diesel:4.843 },
  { state:"Tennessee", abbr:"TN", regular:3.84, mid:4.305, premium:4.697, diesel:5.42 },
  { state:"Texas", abbr:"TX", regular:3.743, mid:4.22, premium:4.596, diesel:5.259 },
  { state:"Utah", abbr:"UT", regular:4.206, mid:4.487, premium:4.735, diesel:5.365 },
  { state:"Vermont", abbr:"VT", regular:4.081, mid:4.586, premium:5.048, diesel:5.869 },
  { state:"Virginia", abbr:"VA", regular:3.954, mid:4.429, premium:4.808, diesel:5.73 },
  { state:"Washington", abbr:"WA", regular:5.388, mid:5.661, premium:5.897, diesel:6.938 },
  { state:"West Virginia", abbr:"WV", regular:3.922, mid:4.338, premium:4.796, diesel:5.529 },
  { state:"Wisconsin", abbr:"WI", regular:3.764, mid:4.273, premium:4.863, diesel:4.969 },
  { state:"Wyoming", abbr:"WY", regular:3.87, mid:4.182, premium:4.475, diesel:5.056 }
];
