...
const MARKET_DRIVERS = [
  { cat: "Trump Cancels Strike", icon: "alert-triangle", title: "Trump Calls Off Planned Iran Strike After Saudi, Qatar, UAE Asked Him to 'Hold Off'", desc: "President Trump said yesterday he called off a planned military strike on Iran scheduled for Tuesday after leaders from Saudi Arabia, Qatar, and the UAE urged him to \"hold off,\" adding that serious negotiations were now underway. Tehran has yet to confirm the claim. Oil prices retreated on the news — WTI fell toward $103 from above $107 Monday, Brent eased toward $110 from $112.93. Markets remain elevated as the Strait of Hormuz stays effectively closed and Tehran's nuclear program remains the central obstacle preventing a breakthrough in negotiations." },
  { cat: "G7 Paris Communiqué", icon: "users", title: "G7 Finance Ministers Conclude Paris Meeting; Joint Statement Pledges Fiscal Restraint", desc: "G7 finance ministers and central bank governors concluded their two-day Paris meeting yesterday with a joint statement pledging not to expand fiscal spending excessively as the Iran war pushes the global economy toward inflation risks. French FM Roland Lescure hosted; U.S. Treasury Secretary Scott Bessent urged sanctions alignment on Tehran. The expanded participation — Brazil, India, Kenya, South Korea, Syria, Ukraine, UAE, Qatar as guests — reflected concern about supply-chain fragmentation. France urged the IMF and World Bank to increase assistance to vulnerable countries. G7 leaders summit follows June 15-17 in Evian." },
  { cat: "Pentagon Contingency", icon: "anchor", title: "Pentagon Has Prepared Range of Military Plans for Iran in Case Trump Resumes Attacks", desc: "CNN reported the Pentagon has prepared a range of military plans for Iran in case President Trump decides to resume attacks. The contingency planning continues even as Trump confirmed yesterday he called off the Tuesday strike. The dual posture — diplomatic engagement via Pakistan and visible military readiness — gives Washington negotiating leverage. Iran's revised peace proposal includes transferring 60%-enriched uranium to Russia and gradually reopening Hormuz; the U.S. characterized the revisions as \"token\" improvements." },
  { cat: "U.S. Russia Waiver", icon: "bar-chart", title: "U.S. Issues Fresh Waiver Permitting Sale of Russian Crude Already Loaded Onto Tankers", desc: "The U.S. issued a fresh waiver permitting the sale of Russian crude oil and petroleum products already loaded onto tankers, providing a release valve for global supply during the Persian Gulf disruption. The move comes as Russia is now centrally positioned in the U.S.-Iran negotiations — Iran's revised proposal includes transferring enriched uranium to Russian custody. Russia remains one of few major producers operating outside the Persian Gulf disruption zone. The waiver does not extend to new Russian crude shipments or to vessels not yet loaded." },
  { cat: "Aramco CEO Warning", icon: "trending-up", title: "Saudi Aramco CEO Nasser: Hormuz Reopening Past Mid-June Pushes Market Normalization to 2027", desc: "Saudi Aramco CEO Amin Nasser told investors on the company's first-quarter earnings call: \"If the Strait of Hormuz opens today, it will still take months for the market to rebalance, and if its opening is delayed by a few more weeks, then normalization will last into 2027.\" The IEA's monthly oil market report released last week separately confirmed global oil inventories are declining rapidly. EIA assesses 10.5 million bpd of Persian Gulf crude production was shut in during April; shut-ins are expected to peak near 10.8 million bpd in May." },
  { cat: "Federal Gas Tax", icon: "fuel", title: "Trump Considers Suspending 18.4-Cent Federal Gasoline Tax; AAA National Average $4.515", desc: "President Trump told CBS News this week he wants to suspend the federal 18.4-cent-per-gallon gasoline tax \"for a period of time,\" adding that once prices fall he would \"let it phase back in.\" AAA's national average sits at $4.515 today — flat over the past several days but up 43.6% year-over-year. California above $6.15; Washington $5.77; Hawaii $5.64. Cheapest pump markets: Oklahoma $3.94, Mississippi $3.98, Louisiana $4.00. Six states remain above $5 per gallon." },
];

const FEATURED_ARTICLES = [
  { id: 101, title: "Trump Calls Off Planned Iran Strike After Gulf States Ask for 'Hold Off'", excerpt: "President Trump said he called off a planned military strike on Iran scheduled for Tuesday after leaders from Saudi Arabia, Qatar, and the UAE urged him to \"hold off,\" adding that serious negotiations were now underway. Tehran has not yet confirmed the claim. Oil prices retreated on the news — WTI fell toward $103 from above $107 Monday; Brent eased toward $110. The Strait of Hormuz remains effectively closed, and the Pentagon has prepared a range of military plans in case Trump resumes attacks.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 20, 2026", readTime: "6 min", featured: true },
  { id: 102, title: "G7 Finance Ministers Conclude Paris Meeting with Joint Statement Pledging Fiscal Restraint", excerpt: "G7 finance ministers and central bank governors concluded their two-day Paris meeting yesterday with a joint statement pledging not to expand fiscal spending excessively as the Iran war pushes the global economy toward inflation risks. French FM Roland Lescure hosted; Treasury Secretary Bessent urged sanctions alignment. The expanded participation — Brazil, India, Kenya, South Korea, Syria, Ukraine, UAE, Qatar — reflected concern about supply-chain fragmentation. G7 leaders summit follows June 15-17 in Evian.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 19, 2026", readTime: "6 min" },
  { id: 103, title: "Pentagon Has Prepared Range of Military Plans for Iran in Case Trump Resumes Attacks", excerpt: "CNN reported the Pentagon has prepared a range of military plans for Iran in case President Trump decides to resume attacks. The contingency planning continues even as Trump confirmed yesterday he called off the Tuesday strike. The dual posture — diplomatic engagement via Pakistan and visible military readiness — gives Washington negotiating leverage. Iran's revised peace proposal includes transferring 60%-enriched uranium to Russia.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 20, 2026", readTime: "5 min" },
  { id: 104, title: "Iran's Revised Peace Proposal: Transfer Enriched Uranium to Russia, Drop Financial Demands", excerpt: "Iranian media reported Tehran's revised peace proposal — delivered via Pakistan — includes transferring its 60%-enriched uranium stockpile to Russia rather than the United States, a significant shift from Iran's previous position. Iran also dropped its demand for direct U.S. financial compensation in favor of economic concessions and international guarantees, and offered to begin gradually reopening Hormuz in exchange for lifting the U.S. blockade. The U.S. rejected the Russia destination.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 18, 2026", readTime: "6 min" },
  { id: 105, title: "UAE Nuclear Facility Attacked Over Weekend in Persian Gulf Escalation", excerpt: "Energy infrastructure across the Persian Gulf came under attack the prior weekend, including a nuclear facility in the United Arab Emirates. The attack came as the UAE — having formally departed OPEC effective May 1 — has positioned itself as a primary U.S. security partner in the Gulf. WTI whipsawed between $108 and $105 in Monday's session; Brent traded between $111 and $102. Saudi Aramco CEO Nasser warned market normalization is pushed to 2027 if Hormuz reopening is delayed past mid-June.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 18, 2026", readTime: "5 min" },
  { id: 106, title: "Baker Hughes Rig Count Climbs to 551 — Third Consecutive Weekly Gain", excerpt: "The U.S. rig count rose by 3 to 551 in the week ended May 15, 2026, the third consecutive weekly increase, according to Baker Hughes. Oil rigs gained 5 to 415 while gas rigs slipped 1 to 128 and misc rigs fell 1 to 8. The Permian Basin added 1 rig. Year over year the U.S. count is down 25 from 576. Canada was unchanged at 124. Combined North America count rose 3 to 675. Next release Friday May 22.", cat: "Oil Markets", slug: "oil-prices", author: "EnergyPricesToday Editorial", date: "May 16, 2026", readTime: "5 min" },
];

const COMPANY_NEWS = [
  { id: 201, title: "Trump Calls Off Planned Iran Strike After Gulf States Ask for 'Hold Off'", date: "May 20, 2026" },
  { id: 202, title: "Pentagon Has Prepared Range of Military Plans for Iran in Case Trump Resumes Attacks", date: "May 20, 2026" },
  { id: 203, title: "G7 Finance Ministers Conclude Paris Meeting with Joint Statement Pledging Fiscal Restraint", date: "May 19, 2026" },
  { id: 204, title: "Iran's Revised Peace Proposal: Transfer Enriched Uranium to Russia, Drop Financial Demands", date: "May 18, 2026" },
  { id: 205, title: "UAE Nuclear Facility Attacked Over Weekend in Persian Gulf Escalation", date: "May 18, 2026" },
  { id: 206, title: "Baker Hughes Rig Count Climbs to 551 — Third Consecutive Weekly Gain", date: "May 16, 2026" },
];

const GEO_ITEMS = [
  { id: 301, region: "United States", title: "Trump Calls Off Planned Iran Strike After Saudi, Qatar, UAE Asked Him to 'Hold Off'", desc: "President Trump said yesterday he called off a planned military strike on Iran scheduled for Tuesday after leaders from Saudi Arabia, Qatar, and the UAE urged him to \"hold off,\" adding that serious negotiations were now underway. Tehran has not confirmed the claim. WTI retreated toward $103 from above $107 Monday; Brent eased toward $110. The Pentagon has prepared a range of military plans in case Trump resumes attacks." },
  { id: 302, region: "Europe", title: "G7 Finance Ministers Conclude Paris Meeting; Joint Statement Pledges Fiscal Restraint", desc: "G7 finance ministers and central bank governors concluded their two-day Paris meeting yesterday with a joint statement pledging not to expand fiscal spending excessively as the Iran war pushes the global economy toward inflation risks. French FM Lescure hosted; Bessent urged sanctions alignment on Tehran. France urged the IMF and World Bank to increase assistance to vulnerable countries. G7 leaders summit follows June 15-17 in Evian." },
  { id: 303, region: "Iran", title: "Iran's Revised Proposal: Uranium to Russia, Hormuz Gradual Reopening for Blockade Lift", desc: "Tehran's revised peace proposal — delivered via Pakistan — includes transferring 60%-enriched uranium to Russia (a major shift from Iran's prior position), dropping financial-compensation demands, and gradually reopening Hormuz in exchange for lifting the U.S. blockade. Washington rejected the Russia destination, suggesting an unspecified third country. Iran's Tasnim news agency said Tehran still views U.S. conditions as overly demanding despite revisions." },
  ...
  { id: 305, region: "UAE", title: "UAE Nuclear Facility Attacked Over the Weekend; Persian Gulf Escalation Continues", desc: "Energy infrastructure across the Persian Gulf came under attack the prior weekend, including a nuclear facility in the United Arab Emirates. The UAE — having formally departed OPEC effective May 1 — has positioned itself as a primary U.S. security partner in the Gulf and was among the Gulf states that asked Trump to call off Tuesday's planned strike. ADCOP pipeline carries available bypass volumes that don't transit Hormuz." },
  { id: 306, region: "Russia", title: "U.S. Issues Fresh Waiver Permitting Sale of Russian Crude Already Loaded Onto Tankers", desc: "The U.S. issued a fresh waiver permitting the sale of Russian crude oil and petroleum products already loaded onto tankers — providing a release valve for global supply during the Persian Gulf disruption. Russia is now centrally positioned in the U.S.-Iran negotiations: Iran's revised proposal includes transferring enriched uranium to Russian custody. Russia remains one of few major producers operating outside the Persian Gulf disruption zone." },
];
