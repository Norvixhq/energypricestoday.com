...
const BREAKING_NEWS = [
  { title: "Trump Says New Iran Talks Could Happen in Next Two Days — Second Islamabad Round Discussed", cat: "Geopolitics", slug: "geopolitics", time: "Breaking" },
  { title: "U.S. Naval Blockade Now in Effect — Iran Accuses Washington of Piracy", cat: "Geopolitics", slug: "geopolitics", time: "2h ago" },
  { title: "20,000 Vessels Stranded Globally as Hormuz Shipping Collapses Over 90%", cat: "Geopolitics", slug: "geopolitics", time: "4h ago" },
  { title: "Israel-Lebanon Talks Begin in Washington as Hezbollah Rejects Negotiations", cat: "Geopolitics", slug: "geopolitics", time: "6h ago" },
  { title: "Oil Prices Climb Near $100 as Energy Secretary Warns Prices Will Keep Rising", cat: "Oil Prices", slug: "oil-prices", time: "8h ago" },
  { title: "Iran Armed Forces on Maximum Combat Alert Amid U.S. Blockade", cat: "Geopolitics", slug: "geopolitics", time: "10h ago" },
  { title: "Ceasefire Expires April 21 — One Week Remaining With No Deal in Place", cat: "Geopolitics", slug: "geopolitics", time: "12h ago" },
  { title: "Satellite Images Show Iran Rebuilding Underground Missile Bases During Ceasefire", cat: "Geopolitics", slug: "geopolitics", time: "14h ago" },
];

const MARKET_DRIVERS = [
  { cat: "NEW TALKS", icon: "message-circle", title: "Second Round Discussed", desc: "Trump says talks could resume in \u201Cnext two days\u201D in Islamabad. White House confirms discussions underway. Ceasefire expires April 21." },
  { cat: "NAVAL BLOCKADE", icon: "anchor", title: "Blockade Now Active", desc: "U.S. Navy enforcing port blockade on Iran. Ships entering/leaving Iranian ports interdicted. Iran calls it \u201Cpiracy\u201D and deploys forces on maximum combat alert." },
  { cat: "SHIPPING CRISIS", icon: "alert-triangle", title: "20,000 Vessels Stranded", desc: "Hormuz traffic down 90%+. 230 loaded oil tankers stuck in Persian Gulf. UN warns of worsening global economic fragility and fertilizer shortages." },
  { cat: "OIL RISING", icon: "trending-up", title: "Crude Nearing $100", desc: "Brent up 40% since war began. Energy Secretary Wright says prices will keep rising until \u201Cmeaningful ship traffic\u201D gets through Hormuz." },
  { cat: "LEBANON", icon: "map-pin", title: "Israel-Lebanon Talks Today", desc: "Ambassadors meet in Washington despite Hezbollah rejection. 2,124 killed in Lebanon since March 2. Fighting continues during ceasefire." },
  { cat: "IRAN MILITARY", icon: "shield", title: "Iran Rebuilding Bases", desc: "Satellite imagery shows Iran clearing debris from underground missile bases during ceasefire. U.S. intelligence estimates half of Iran\u2019s launchers still intact." },
];
...
const GAS_PRICES_BY_STATE = [
  { state: "Alabama", region: "South", abbr: "AL", regular: 3.854, mid: 4.291, premium: 4.699, diesel: 5.432 },
  { state: "Alaska", region: "West Coast", abbr: "AK", regular: 4.645, mid: 4.883, premium: 5.126, diesel: 5.958 },
  { state: "Arizona", region: "Mountain", abbr: "AZ", regular: 4.698, mid: 5.079, premium: 5.394, diesel: 6.134 },
  { state: "Arkansas", region: "South", abbr: "AR", regular: 3.640, mid: 4.094, premium: 4.420, diesel: 5.168 },
  { state: "California", region: "West Coast", abbr: "CA", regular: 5.893, mid: 6.118, premium: 6.308, diesel: 7.678 },
  { state: "Colorado", region: "Mountain", abbr: "CO", regular: 3.808, mid: 4.203, premium: 4.530, diesel: 5.071 },
  { state: "Connecticut", region: "Northeast", abbr: "CT", regular: 4.085, mid: 4.614, premium: 5.018, diesel: 5.914 },
  { state: "Delaware", region: "Northeast", abbr: "DE", regular: 4.013, mid: 4.616, premium: 4.923, diesel: 5.862 },
  { state: "Florida", region: "South", abbr: "FL", regular: 4.016, mid: 4.464, premium: 4.805, diesel: 5.670 },
  { state: "Georgia", region: "South", abbr: "GA", regular: 3.704, mid: 4.160, premium: 4.579, diesel: 5.282 },
  { state: "Hawaii", region: "West Coast", abbr: "HI", regular: 5.642, mid: 5.866, premium: 6.141, diesel: 7.050 },
  { state: "Idaho", region: "Mountain", abbr: "ID", regular: 4.309, mid: 4.601, premium: 4.866, diesel: 5.462 },
  { state: "Illinois", region: "Midwest", abbr: "IL", regular: 4.383, mid: 4.967, premium: 5.435, diesel: 5.461 },
  { state: "Indiana", region: "Midwest", abbr: "IN", regular: 3.940, mid: 4.487, premium: 4.976, diesel: 5.455 },
  { state: "Iowa", region: "Midwest", abbr: "IA", regular: 3.672, mid: 3.886, premium: 4.533, diesel: 5.097 },
  { state: "Kansas", region: "Midwest", abbr: "KS", regular: 3.490, mid: 3.797, premium: 4.130, diesel: 4.764 },
  { state: "Kentucky", region: "South", abbr: "KY", regular: 4.020, mid: 4.576, premium: 5.002, diesel: 5.367 },
  { state: "Louisiana", region: "South", abbr: "LA", regular: 3.764, mid: 4.190, premium: 4.578, diesel: 5.291 },
  { state: "Maine", region: "Northeast", abbr: "ME", regular: 4.043, mid: 4.585, premium: 5.074, diesel: 5.918 },
  { state: "Maryland", region: "Northeast", abbr: "MD", regular: 4.121, mid: 4.706, premium: 5.050, diesel: 5.903 },
  { state: "Massachusetts", region: "Northeast", abbr: "MA", regular: 3.968, mid: 4.553, premium: 4.952, diesel: 5.889 },
  { state: "Michigan", region: "Midwest", abbr: "MI", regular: 3.966, mid: 4.563, premium: 5.129, diesel: 5.298 },
  { state: "Minnesota", region: "Midwest", abbr: "MN", regular: 3.731, mid: 4.176, premium: 4.671, diesel: 5.117 },
  { state: "Mississippi", region: "South", abbr: "MS", regular: 3.748, mid: 4.183, premium: 4.571, diesel: 5.268 },
  { state: "Missouri", region: "Midwest", abbr: "MO", regular: 3.666, mid: 4.095, premium: 4.404, diesel: 4.909 },
  { state: "Montana", region: "Mountain", abbr: "MT", regular: 3.896, mid: 4.185, premium: 4.540, diesel: 4.999 },
  { state: "Nebraska", region: "Midwest", abbr: "NE", regular: 3.597, mid: 3.812, premium: 4.263, diesel: 4.918 },
  { state: "Nevada", region: "Mountain", abbr: "NV", regular: 4.979, mid: 5.292, premium: 5.593, diesel: 6.362 },
  { state: "New Hampshire", region: "Northeast", abbr: "NH", regular: 3.969, mid: 4.507, premium: 4.970, diesel: 5.838 },
  { state: "New Jersey", region: "Northeast", abbr: "NJ", regular: 4.032, mid: 4.560, premium: 4.831, diesel: 5.883 },
  { state: "New Mexico", region: "Mountain", abbr: "NM", regular: 3.982, mid: 4.408, premium: 4.718, diesel: 5.478 },
  { state: "New York", region: "Northeast", abbr: "NY", regular: 4.133, mid: 4.631, premium: 5.014, diesel: 5.964 },
  { state: "North Carolina", region: "South", abbr: "NC", regular: 3.893, mid: 4.326, premium: 4.731, diesel: 5.760 },
  { state: "North Dakota", region: "Midwest", abbr: "ND", regular: 3.608, mid: 3.958, premium: 4.414, diesel: 4.909 },
  { state: "Ohio", region: "Midwest", abbr: "OH", regular: 3.860, mid: 4.393, premium: 4.911, diesel: 5.400 },
  { state: "Oklahoma", region: "South", abbr: "OK", regular: 3.443, mid: 3.865, premium: 4.159, diesel: 4.782 },
  { state: "Oregon", region: "West Coast", abbr: "OR", regular: 4.989, mid: 5.221, premium: 5.500, diesel: 6.347 },
  { state: "Pennsylvania", region: "Northeast", abbr: "PA", regular: 4.149, mid: 4.588, premium: 4.964, diesel: 6.087 },
  { state: "Rhode Island", region: "Northeast", abbr: "RI", regular: 3.987, mid: 4.660, premium: 5.070, diesel: 5.818 },
  { state: "South Carolina", region: "South", abbr: "SC", regular: 3.835, mid: 4.275, premium: 4.670, diesel: 5.641 },
  { state: "South Dakota", region: "Midwest", abbr: "SD", regular: 3.675, mid: 3.819, premium: 4.358, diesel: 4.863 },
  { state: "Tennessee", region: "South", abbr: "TN", regular: 3.895, mid: 4.365, premium: 4.774, diesel: 5.466 },
  { state: "Texas", region: "South", abbr: "TX", regular: 3.807, mid: 4.281, premium: 4.655, diesel: 5.331 },
  { state: "Utah", region: "Mountain", abbr: "UT", regular: 4.208, mid: 4.490, premium: 4.729, diesel: 5.340 },
  { state: "Vermont", region: "Northeast", abbr: "VT", regular: 4.099, mid: 4.596, premium: 5.046, diesel: 5.893 },
  { state: "Virginia", region: "South", abbr: "VA", regular: 4.005, mid: 4.463, premium: 4.845, diesel: 5.773 },
  { state: "Washington", region: "West Coast", abbr: "WA", regular: 5.390, mid: 5.654, premium: 5.886, diesel: 6.947 },
  { state: "West Virginia", region: "South", abbr: "WV", regular: 3.950, mid: 4.380, premium: 4.825, diesel: 5.563 },
  { state: "Wisconsin", region: "Midwest", abbr: "WI", regular: 3.797, mid: 4.310, premium: 4.896, diesel: 4.996 },
  { state: "Wyoming", region: "Mountain", abbr: "WY", regular: 3.832, mid: 4.141, premium: 4.440, diesel: 5.020 },
  { state: "Washington D.C.", region: "Northeast", abbr: "DC", regular: 4.282, mid: 4.902, premium: 5.234, diesel: 5.848 },
];

const US_GAS_NATIONAL = { regular: 4.125, mid: 4.572, premium: 4.946, diesel: 5.574, source: "AAA Daily Fuel Gauge Report", updated: "As of April 14, 2026" };
