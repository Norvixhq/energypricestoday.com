...
const BREAKING_NEWS = [
  ...
  { title: "WTI Pulls Back to $101.85, Brent $107.05 After Three-Day Rally", cat: "Oil Markets", slug: "oil-prices", time: "4h" },
  ...
  { title: "April U.S. Inflation Accelerates as Surging Energy Prices Hit Consumer Index", cat: "Oil Markets", slug: "oil-prices", time: "6h" },
  { title: "Asian Refiners Including Japan Seek Alternatives to Persian Gulf Supplies", cat: "Geopolitics", slug: "geopolitics", time: "7h" },
...
const GEO_ITEMS = [
  ...
  { id: 305, region: "China", title: "Trump Heads to Beijing This Week; Trade May Take Priority Over Iran Talks", desc: "President Trump is set to meet Chinese President Xi Jinping in Beijing this week. Trump indicated trade negotiations would take precedence over developments surrounding the Iran conflict during the talks, tempering market expectations that the summit might produce a diplomatic breakthrough on Hormuz. Beijing has called repeatedly for the strait to reopen given how much of China's energy supply transits the waterway." },
