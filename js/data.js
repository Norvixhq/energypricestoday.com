...
const GAS_PRICES_BY_STATE = [
  { state: "Alabama", region: "South", abbr: "AL", regular: 3.52, mid: 3.95, premium: 4.32, diesel: 4.82 },
  { state: "Alaska", region: "West Coast", abbr: "AK", regular: 4.28, mid: 4.72, premium: 5.08, diesel: 5.42 },
  { state: "Arizona", region: "Mountain", abbr: "AZ", regular: 4.18, mid: 4.62, premium: 4.98, diesel: 5.38 },
  { state: "Arkansas", region: "South", abbr: "AR", regular: 3.48, mid: 3.92, premium: 4.28, diesel: 4.78 },
  { state: "California", region: "West Coast", abbr: "CA", regular: 5.93, mid: 6.15, premium: 6.35, diesel: 7.69 },
  { state: "Colorado", region: "Mountain", abbr: "CO", regular: 3.72, mid: 4.15, premium: 4.52, diesel: 4.95 },
  { state: "Connecticut", region: "Northeast", abbr: "CT", regular: 4.05, mid: 4.48, premium: 4.85, diesel: 5.38 },
  { state: "Delaware", region: "Northeast", abbr: "DE", regular: 3.82, mid: 4.25, premium: 4.62, diesel: 5.12 },
  { state: "Florida", region: "South", abbr: "FL", regular: 4.20, mid: 4.62, premium: 4.98, diesel: 5.42 },
  { state: "Georgia", region: "South", abbr: "GA", regular: 3.65, mid: 4.08, premium: 4.45, diesel: 4.92 },
  { state: "Hawaii", region: "West Coast", abbr: "HI", regular: 5.48, mid: 5.82, premium: 6.12, diesel: 6.85 },
  { state: "Idaho", region: "Mountain", abbr: "ID", regular: 3.92, mid: 4.35, premium: 4.72, diesel: 5.18 },
  { state: "Illinois", region: "Midwest", abbr: "IL", regular: 4.35, mid: 4.78, premium: 5.15, diesel: 5.58 },
  { state: "Indiana", region: "Midwest", abbr: "IN", regular: 3.95, mid: 4.38, premium: 4.75, diesel: 5.22 },
  { state: "Iowa", region: "Midwest", abbr: "IA", regular: 3.58, mid: 4.02, premium: 4.38, diesel: 4.85 },
  { state: "Kansas", region: "Midwest", abbr: "KS", regular: 3.52, mid: 3.95, premium: 4.32, diesel: 4.82 },
  { state: "Kentucky", region: "South", abbr: "KY", regular: 3.62, mid: 4.05, premium: 4.42, diesel: 4.88 },
  { state: "Louisiana", region: "South", abbr: "LA", regular: 3.45, mid: 3.88, premium: 4.25, diesel: 4.75 },
  { state: "Maine", region: "Northeast", abbr: "ME", regular: 3.98, mid: 4.42, premium: 4.78, diesel: 5.28 },
  { state: "Maryland", region: "Northeast", abbr: "MD", regular: 3.88, mid: 4.32, premium: 4.68, diesel: 5.18 },
  { state: "Massachusetts", region: "Northeast", abbr: "MA", regular: 4.02, mid: 4.45, premium: 4.82, diesel: 5.32 },
  { state: "Michigan", region: "Midwest", abbr: "MI", regular: 4.12, mid: 4.55, premium: 4.92, diesel: 5.38 },
  { state: "Minnesota", region: "Midwest", abbr: "MN", regular: 3.68, mid: 4.12, premium: 4.48, diesel: 4.95 },
  { state: "Mississippi", region: "South", abbr: "MS", regular: 3.38, mid: 3.82, premium: 4.18, diesel: 4.68 },
  { state: "Missouri", region: "Midwest", abbr: "MO", regular: 3.48, mid: 3.92, premium: 4.28, diesel: 4.78 },
  { state: "Montana", region: "Mountain", abbr: "MT", regular: 3.85, mid: 4.28, premium: 4.65, diesel: 5.12 },
  { state: "Nebraska", region: "Midwest", abbr: "NE", regular: 3.58, mid: 4.02, premium: 4.38, diesel: 4.85 },
  { state: "Nevada", region: "Mountain", abbr: "NV", regular: 4.72, mid: 5.15, premium: 5.52, diesel: 5.98 },
  { state: "New Hampshire", region: "Northeast", abbr: "NH", regular: 3.82, mid: 4.25, premium: 4.62, diesel: 5.12 },
  { state: "New Jersey", region: "Northeast", abbr: "NJ", regular: 3.88, mid: 4.32, premium: 4.68, diesel: 5.22 },
  { state: "New Mexico", region: "Mountain", abbr: "NM", regular: 3.78, mid: 4.22, premium: 4.58, diesel: 5.05 },
  { state: "New York", region: "Northeast", abbr: "NY", regular: 4.10, mid: 4.55, premium: 4.92, diesel: 5.45 },
  { state: "North Carolina", region: "South", abbr: "NC", regular: 3.72, mid: 4.15, premium: 4.52, diesel: 4.98 },
  { state: "North Dakota", region: "Midwest", abbr: "ND", regular: 3.62, mid: 4.05, premium: 4.42, diesel: 4.88 },
  { state: "Ohio", region: "Midwest", abbr: "OH", regular: 3.88, mid: 4.32, premium: 4.68, diesel: 5.15 },
  { state: "Oklahoma", region: "South", abbr: "OK", regular: 3.42, mid: 3.85, premium: 4.22, diesel: 4.72 },
  { state: "Oregon", region: "West Coast", abbr: "OR", regular: 4.55, mid: 4.98, premium: 5.35, diesel: 5.78 },
  { state: "Pennsylvania", region: "Northeast", abbr: "PA", regular: 4.15, mid: 4.58, premium: 4.95, diesel: 5.48 },
  { state: "Rhode Island", region: "Northeast", abbr: "RI", regular: 3.92, mid: 4.35, premium: 4.72, diesel: 5.22 },
  { state: "South Carolina", region: "South", abbr: "SC", regular: 3.55, mid: 3.98, premium: 4.35, diesel: 4.82 },
  { state: "South Dakota", region: "Midwest", abbr: "SD", regular: 3.62, mid: 4.05, premium: 4.42, diesel: 4.88 },
  { state: "Tennessee", region: "South", abbr: "TN", regular: 3.55, mid: 3.98, premium: 4.35, diesel: 4.85 },
  { state: "Texas", region: "South", abbr: "TX", regular: 3.82, mid: 4.30, premium: 4.67, diesel: 5.20 },
  { state: "Utah", region: "Mountain", abbr: "UT", regular: 3.85, mid: 4.28, premium: 4.65, diesel: 5.12 },
  { state: "Vermont", region: "Northeast", abbr: "VT", regular: 3.95, mid: 4.38, premium: 4.75, diesel: 5.25 },
  { state: "Virginia", region: "South", abbr: "VA", regular: 3.78, mid: 4.22, premium: 4.58, diesel: 5.08 },
  { state: "Washington", region: "West Coast", abbr: "WA", regular: 4.85, mid: 5.28, premium: 5.65, diesel: 6.12 },
  { state: "West Virginia", region: "South", abbr: "WV", regular: 3.72, mid: 4.15, premium: 4.52, diesel: 5.02 },
  { state: "Wisconsin", region: "Midwest", abbr: "WI", regular: 3.65, mid: 4.08, premium: 4.45, diesel: 4.92 },
  { state: "Wyoming", region: "Mountain", abbr: "WY", regular: 3.78, mid: 4.22, premium: 4.58, diesel: 5.05 },
  { state: "Washington D.C.", region: "Northeast", abbr: "DC", regular: 4.08, mid: 4.52, premium: 4.88, diesel: 5.38 },
];

const US_GAS_NATIONAL = { regular: 4.14, mid: 4.58, premium: 4.95, diesel: 5.42, source: "Reference prices benchmarked to AAA data", updated: "As of April 7, 2026" };
