...
const MARKET_DRIVERS = [
  { cat: "Strikes Resume", icon: "shield", title: "U.S. Strikes Iranian Military Site at Bandar Abbas; IRGC Claims Retaliatory Airbase Attack", desc: "U.S. forces struck an Iranian military site near Bandar Abbas on Thursday that Washington said threatened American troops and commercial shipping through the Strait of Hormuz, and intercepted several Iranian drones near the waterway. Iran's Islamic Revolutionary Guard Corps said it retaliated by attacking the U.S. airbase from which the Bandar Abbas strikes were launched, warning via Press TV that \"any act of aggression will not go unanswered, and if repeated, our response will be even more decisive.\" Kuwait's army said its air defenses were responding to hostile missile and drone threats Thursday morning. The renewed exchanges put a floor under a multi-day price slide even as diplomacy continued in parallel." },
  { cat: "MOU Briefed to Trump", icon: "file-text", title: "Trump Briefed on Draft MOU That Would Reopen Hormuz Over 60 Days in Synchronized Steps", desc: "U.S. officials confirmed Thursday that President Trump has been briefed on the draft memorandum of understanding with Iran. The document would see the Strait of Hormuz fully opened over the course of 60 days, with Iran loosening its grip on the waterway and the U.S. pulling back its naval blockade in synchronized steps until the strait returns to its pre-war status quo. Secretary of State Marco Rubio said Wednesday the talks have made \"some progress,\" adding that Trump prefers diplomacy and will give negotiations \"every chance to succeed.\" The framework advances on paper even as kinetic exchanges resumed on the ground." },
  { cat: "Sanctions on Shipping Agency", icon: "alert-triangle", title: "U.S. Imposes Sanctions on Iranian Agency Seeking to Control Hormuz Shipping", desc: "The U.S. imposed sanctions Wednesday on an Iranian agency attempting to control shipping through the Strait of Hormuz, a move that underscores the central unresolved dispute even as a 60-day reopening framework takes shape. The dispute over who controls the waterway — and whether Iran can charge transit tolls — remains the principal sticking point alongside Tehran's enriched-uranium stockpile and frozen Iranian assets. Iran's Fars news agency has reported the strait \"would remain under Iran's management\" per the latest exchanged text, a position Washington rejects." },
  { cat: "Oil Down 10% Since May 18", icon: "trending-down", title: "Oil Down More Than 10% Since May 18; Brent Rebounds Toward $97 on Renewed Hostilities", desc: "Oil prices have tumbled more than 10% since May 18, when Trump said he called off an imminent wave of strikes to allow more time for negotiations. Brent crude rebounded toward $96–$97 Thursday, recovering from Wednesday losses as renewed U.S.-Iran hostilities weakened expectations for a near-term peace agreement; WTI traded around $93. Citigroup said markets were finding firmer footing as investors increasingly priced out worst-case supply-disruption scenarios. The week's net direction remains sharply lower as markets weigh the advancing MOU against fresh kinetic risk." },
  { cat: "Gas Falls to $4.42", icon: "fuel", title: "AAA National Average Falls to $4.426, Down 12 Cents on the Week as Crude Retreats", desc: "AAA's national average for regular gasoline fell to $4.426 Thursday, down 12 cents from last week, as crude prices retreated on U.S.-Iran peace-talk reports. AAA cautioned the fragile situation could cause oil prices to spike again if a ceasefire deal isn't reached, and noted pump prices remain the highest they've been in four years and will likely stay elevated as the summer driving season gets underway. The drop is the first sustained pullback since the conflict began February 28, though pump prices remain roughly 50% above the pre-conflict baseline." },
  { cat: "EIA Inventory Draw", icon: "bar-chart", title: "EIA: U.S. Crude Inventories Fell 3.3 Million Barrels Last Week to 441.7 Million", desc: "The EIA reported Thursday that U.S. commercial crude oil inventories fell 3.3 million barrels in the week ending May 22 to 441.7 million barrels, about 2% below the five-year average for this time of year. Refinery inputs rose 652,000 barrels per day with utilization at 94.5%. Total motor gasoline inventories fell 2.6 million barrels and are about 6% below the five-year average. Cushing stocks fell 2.8 million barrels to 23.0 million. The continued draw reflects the structural undersupply from the Persian Gulf disruption even as crude prices retreat on diplomatic progress." },
];

const FEATURED_ARTICLES = [
  { id: 101, title: "U.S. Strikes Iranian Military Site at Bandar Abbas; IRGC Claims Retaliatory Airbase Attack", excerpt: "U.S. forces struck an Iranian military site near Bandar Abbas on Thursday that Washington said threatened American troops and Hormuz shipping, and intercepted several Iranian drones near the strait. Iran's IRGC said it retaliated against the U.S. airbase that launched the strikes, warning \"any act of aggression will not go unanswered.\" Kuwait's air defenses responded to hostile missile and drone threats Thursday morning. The renewed exchanges put a floor under a multi-day price slide even as the 60-day MOU advances in parallel.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 28, 2026", readTime: "6 min", featured: true },
  { id: 102, title: "Trump Briefed on Draft MOU That Would Reopen Hormuz Over 60 Days in Synchronized Steps", excerpt: "U.S. officials confirmed Thursday that President Trump has been briefed on the draft memorandum of understanding with Iran. The document would fully open the Strait of Hormuz over 60 days, with Iran loosening its grip on the waterway and the U.S. pulling back its naval blockade in synchronized steps until the strait returns to pre-war status quo. Rubio said the talks have made \"some progress\" and that Trump will give negotiations \"every chance to succeed.\"", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 28, 2026", readTime: "5 min" },
  { id: 103, title: "AAA National Average Falls to $4.426 as Crude Retreats; EIA Reports 3.3M-Barrel Draw", excerpt: "AAA's national average for regular gasoline fell to $4.426 Thursday, down 12 cents on the week, as crude prices retreated on U.S.-Iran peace-talk reports. Oil is down more than 10% since May 18. The EIA reported U.S. crude inventories fell 3.3 million barrels last week to 441.7 million, about 2% below the five-year average. AAA cautioned the fragile situation could push prices higher again if a ceasefire deal isn't reached; pump prices remain the highest in four years.", cat: "Gas Prices", slug: "gas-prices", author: "EnergyPricesToday Editorial", date: "May 28, 2026", readTime: "5 min" },
  { id: 104, title: "Trump: U.S.-Iran Agreement 'Largely Negotiated'; Strait of Hormuz to Reopen Under 60-Day Framework", excerpt: "President Trump said Saturday on Truth Social that an agreement involving the U.S., Iran, and several regional countries had been \"largely negotiated\" and that the Strait of Hormuz will be reopened. The framework: a 60-day ceasefire extension during which Iran clears mines, the U.S. lifts its blockade, and parallel negotiations begin on Iran's nuclear program. A flurry of regional diplomacy preceded the announcement.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 26, 2026", readTime: "6 min" },
  { id: 105, title: "U.S. Imposes Sanctions on Iranian Agency Seeking to Control Hormuz Shipping", excerpt: "The U.S. imposed sanctions Wednesday on an Iranian agency attempting to control shipping through the Strait of Hormuz, underscoring the central unresolved dispute even as a 60-day reopening framework takes shape. Who controls the waterway — and whether Iran can charge transit tolls — remains the principal sticking point alongside Tehran's enriched-uranium stockpile and frozen Iranian assets.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 28, 2026", readTime: "5 min" },
  { id: 106, title: "U.S. CENTCOM Conducts Defensive Strikes in Southern Iran; IRGC Claims F-35 Engagement", excerpt: "U.S. Central Command said Tuesday it conducted \"self-defense strikes\" in southern Iran, targeting missile launch sites and Iranian boats attempting to emplace mines in the Strait of Hormuz. Iran's IRGC claimed it engaged an F-35 fighter jet and several drones. The dual posture — diplomatic engagement combined with visible military readiness — has defined the conflict's negotiating phase.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 26, 2026", readTime: "5 min" },
];

const COMPANY_NEWS = [
  { id: 201, title: "U.S. Strikes Iranian Military Site at Bandar Abbas; IRGC Claims Retaliatory Airbase Attack", date: "May 28, 2026" },
  { id: 202, title: "Trump Briefed on Draft MOU That Would Reopen Hormuz Over 60 Days in Synchronized Steps", date: "May 28, 2026" },
  { id: 203, title: "AAA National Average Falls to $4.426 as Crude Retreats; EIA Reports 3.3M-Barrel Draw", date: "May 28, 2026" },
  { id: 204, title: "Trump: U.S.-Iran Agreement 'Largely Negotiated'; Strait of Hormuz to Reopen Under 60-Day Framework", date: "May 26, 2026" },
  { id: 205, title: "U.S. Imposes Sanctions on Iranian Agency Seeking to Control Hormuz Shipping", date: "May 28, 2026" },
  { id: 206, title: "U.S. CENTCOM Conducts Defensive Strikes in Southern Iran; IRGC Claims F-35 Engagement", date: "May 26, 2026" },
];

const GEO_ITEMS = [
  { id: 301, region: "United States", title: "U.S. Strikes Bandar Abbas Military Site; Briefs Trump on 60-Day Hormuz Reopening MOU", desc: "U.S. forces struck an Iranian military site near Bandar Abbas on Thursday that Washington said threatened American troops and Hormuz shipping, and intercepted several Iranian drones. Simultaneously, U.S. officials confirmed Trump has been briefed on the draft MOU that would fully open the strait over 60 days in synchronized steps. Rubio: talks have made \"some progress\"; Trump prefers diplomacy and will give negotiations \"every chance to succeed.\" Progress on the framework, friction on the ground." },
  { id: 302, region: "Iran", title: "IRGC Claims Retaliatory Attack on U.S. Airbase After Bandar Abbas Strikes", desc: "Iran's Islamic Revolutionary Guard Corps said Thursday it attacked the U.S. airbase from which American forces launched strikes on Bandar Abbas, warning via Press TV: \"This response is a serious warning to the enemy that any act of aggression will not go unanswered, and if repeated, our response will be even more decisive.\" Iranians are back online after a monthslong internet shutdown. Iran's negotiators continue to insist the strait \"remains under Iran's management\" even as the MOU advances." },
  { id: 303, region: "Strait of Hormuz", title: "U.S. Sanctions Iranian Shipping Agency; Draft MOU Sets Synchronized 60-Day Reopening", desc: "The U.S. imposed sanctions Wednesday on an Iranian agency attempting to control Hormuz shipping, underscoring the central dispute even as the reopening framework advances. The draft MOU would open the strait over 60 days, with Iran loosening its grip and the U.S. pulling back its naval blockade in synchronized steps until pre-war status quo returns. Kuwait's air defenses responded to hostile missile and drone threats Thursday. Roughly 20% of the world's oil and LNG normally transits the strait." },
  { id: 304, region: "Global Markets", title: "Oil Down More Than 10% Since May 18; Brent Rebounds Toward $97 on Renewed Hostilities", desc: "Oil has fallen more than 10% since May 18, when Trump called off an imminent wave of strikes for negotiations. Brent rebounded toward $96–$97 Thursday after Wednesday losses as renewed hostilities weakened near-term peace expectations; WTI traded around $93. Citigroup said markets were finding firmer footing as investors priced out worst-case supply scenarios. The renewed strikes put a floor under the multi-day slide; the week's net direction remains sharply lower." },
  { id: 305, region: "U.S. Consumers", title: "AAA National Average Falls to $4.426; First Sustained Pullback Since the War Began", desc: "AAA's national average fell to $4.426 Thursday, down 12 cents on the week, as crude retreated on peace-talk reports — the first sustained pullback since the conflict began February 28. AAA cautioned the fragile situation could push prices higher again if a deal isn't reached, and noted pump prices remain the highest in four years. Diesel eased to roughly $5.52. Pump prices remain ~50% above the pre-conflict baseline." },
  { id: 306, region: "Inventories", title: "EIA: U.S. Crude Inventories Fell 3.3 Million Barrels to 441.7 Million Last Week", desc: "The EIA reported Thursday that U.S. commercial crude inventories fell 3.3 million barrels in the week ending May 22 to 441.7 million barrels, about 2% below the five-year average. Refinery utilization rose to 94.5%; gasoline inventories fell 2.6 million barrels and sit about 6% below average. Cushing stocks fell 2.8 million barrels to 23.0 million. The continued draw reflects structural undersupply from the Persian Gulf disruption even as prices retreat on diplomatic progress." },
];
