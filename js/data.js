...
const MARKET_DRIVERS = [
  { cat: "Talks Suspended", icon: "alert-triangle", title: "Iran Halts Communication With U.S. Over Israel's Lebanon Offensive; Threatens to Close Hormuz", desc: "Iran announced Monday it is halting all communication with the United States unless Israel stops its expanding military offensive in southern Lebanon, the semi-official Tasnim news agency reported. Foreign Minister Abbas Araghchi wrote that a ceasefire between Iran and the U.S. \"constitutes, without any ambiguity, a comprehensive ceasefire across all fronts, including Lebanon.\" Tehran threatened to completely block the Strait of Hormuz and open other fronts including the Bab el-Mandeb Strait. The suspension freezes a negotiating track that had appeared, just days earlier, to be moving toward a 60-day MOU." },
  { cat: "Oil Rallies", icon: "trending-up", title: "Oil Jumps as Trump Says He 'Couldn't Care Less' Whether Iran Talks End", desc: "Oil prices rallied Monday after President Trump told CNBC he does not care if talks with Iran come to an end, stoking fears that Washington and Tehran will not reach a deal to reopen the Strait of Hormuz. West Texas Intermediate rose more than 5% to settle at $92.16 a barrel; international benchmark Brent advanced more than 4% to $94.98. \"I really don't care. I couldn't care less,\" Trump told CNBC when asked whether negotiations are over. The bounce follows the worst week for crude since mid-April and a brutal May." },
  { cat: "Lebanon Flashpoint", icon: "shield", title: "Israel Orders Troops Deeper Into Lebanon; Hezbollah Launches 20+ Attacks Before Trump-Brokered Halt", desc: "Israel ordered troops to push deeper into Lebanon over the weekend and warned residents of Beirut's southern suburb of Dahiyeh to evacuate, after Hezbollah said it launched more than 20 attacks on Israeli military targets Sunday and Monday. Late Monday, Trump posted that productive calls with Prime Minister Netanyahu and, via intermediaries, with Hezbollah, had secured pledges that \"all shooting will stop\" and that troops headed to Beirut had been turned back. The Iran-U.S. negotiating channel, however, remained suspended." },
  { cat: "Worst Month Since COVID", icon: "trending-down", title: "Brent Fell ~19% in May, Worst Month Since the Pandemic, Before Monday's Bounce", desc: "Brent crude fell almost 19% in May, its worst month since the COVID-19 pandemic, and WTI lost 16.5% month-to-date, as investors priced in optimism for a lasting U.S.-Iran ceasefire that would reopen the strait. That optimism reversed Monday on the collapse of communications. Brent and WTI closed last week down 11.1% and 9.6% respectively. ICMA's Bob Parker said prices will likely hold between $90 and $100 for the next couple of months until there is clarity on any lasting peace agreement, warning that any Hormuz reopening would likely be only partial." },
  { cat: "Gas Eases to $4.32", icon: "fuel", title: "AAA National Average Falls to $4.322 as Pumps Catch Down to May's Crude Slide", desc: "AAA's national average for regular gasoline eased to $4.322 Monday, continuing to drift lower as pump prices catch down to the sharp crude decline of May. The pullback reflects last month's roughly 19% drop in Brent; Monday's crude spike on the talks collapse has not yet reached the pump given the typical one-to-two-week wholesale-to-retail lag. AAA notes prices remain the highest in four years and that the fragile geopolitical situation could push them higher again. Six states still sit near $5 (Alaska, Hawaii, Illinois, Nevada, Oregon, Washington); California tops $6." },
  { cat: "Rig Count Edges Up", icon: "bar-chart", title: "Baker Hughes: U.S. Oil Rig Count Rises 4 to 429 in the Week Ended May 29", desc: "Baker Hughes reported Friday that the U.S. oil rig count rose by 4 to 429 in the week ended May 29; the total U.S. rig count edged up to 562. The gradual climb continues a forward-looking signal that U.S. shale is responding to the sustained elevated-price environment, though the response remains modest relative to the scale of the Persian Gulf supply that remains shut in. Rising rigs today translate to higher production six to twelve months out." },
];

const FEATURED_ARTICLES = [
  { id: 101, title: "Iran Halts Communication With U.S. Over Israel's Lebanon Offensive; Threatens to Close Hormuz", excerpt: "Iran announced Monday it is halting all communication with the United States unless Israel stops its expanding offensive in southern Lebanon, Tasnim reported. Foreign Minister Araghchi said a U.S.-Iran ceasefire must cover \"all fronts, including Lebanon.\" Tehran threatened to completely block the Strait of Hormuz and open the Bab el-Mandeb front. The suspension freezes a negotiating track that days earlier appeared to be moving toward a 60-day MOU.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "June 1, 2026", readTime: "6 min", featured: true },
  { id: 102, title: "Oil Jumps as Trump Says He 'Couldn't Care Less' Whether Iran Talks End", excerpt: "Oil rallied Monday after President Trump told CNBC he does not care if talks with Iran come to an end, stoking fears Washington and Tehran will not reach a deal to reopen the Strait of Hormuz. WTI rose more than 5% to settle at $92.16; Brent advanced more than 4% to $94.98. The bounce follows the worst week for crude since mid-April and a May in which Brent fell nearly 19% — its worst month since the pandemic.", cat: "Oil Markets", slug: "oil-prices", author: "EnergyPricesToday Editorial", date: "June 1, 2026", readTime: "5 min" },
  { id: 103, title: "Trump Brokers Israel-Hezbollah Shooting Halt as Iran Freezes U.S. Talks Over Lebanon", excerpt: "Israel ordered troops deeper into Lebanon and warned Beirut's Dahiyeh suburb to evacuate after Hezbollah launched 20+ attacks on Israeli targets. Late Monday, Trump said productive calls with Netanyahu and, via intermediaries, with Hezbollah secured pledges that \"all shooting will stop\" and that troops headed to Beirut were turned back. The Iran-U.S. channel, however, remained suspended.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "June 1, 2026", readTime: "5 min" },
  { id: 104, title: "U.S. Strikes Iranian Military Site at Bandar Abbas; IRGC Claims Retaliatory Airbase Attack", excerpt: "U.S. forces struck an Iranian military site near Bandar Abbas and intercepted drones near the strait; Iran's IRGC said it retaliated against the U.S. airbase that launched the strikes. The exchange punctuated a phase in which diplomacy and kinetic action ran in parallel — before this week's suspension of the negotiating channel over Lebanon.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 28, 2026", readTime: "6 min" },
  { id: 105, title: "AAA National Average Falls to $4.322 as Pumps Catch Down to May's Crude Slide", excerpt: "AAA's national average for regular gasoline eased to $4.322 Monday, drifting lower as pump prices catch down to the sharp crude decline of May. Monday's crude spike on the talks collapse has not yet reached the pump given the one-to-two-week lag. Prices remain the highest in four years; six states still sit near $5 and California tops $6.", cat: "Gas Prices", slug: "gas-prices", author: "EnergyPricesToday Editorial", date: "June 1, 2026", readTime: "5 min" },
  { id: 106, title: "Baker Hughes: U.S. Oil Rig Count Rises 4 to 429 in the Week Ended May 29", excerpt: "Baker Hughes reported the U.S. oil rig count rose by 4 to 429 in the week ended May 29; total U.S. rigs edged up to 562. The gradual climb continues a forward-looking signal that U.S. shale is responding to elevated prices, though the response remains modest relative to the Persian Gulf supply still shut in.", cat: "Oil Markets", slug: "oil-prices", author: "EnergyPricesToday Editorial", date: "May 29, 2026", readTime: "5 min" },
];

const COMPANY_NEWS = [
  { id: 201, title: "Iran Halts Communication With U.S. Over Israel's Lebanon Offensive; Threatens to Close Hormuz", date: "June 1, 2026" },
  { id: 202, title: "Oil Jumps as Trump Says He 'Couldn't Care Less' Whether Iran Talks End", date: "June 1, 2026" },
  { id: 203, title: "Trump Brokers Israel-Hezbollah Shooting Halt as Iran Freezes U.S. Talks Over Lebanon", date: "June 1, 2026" },
  { id: 204, title: "AAA National Average Falls to $4.322 as Pumps Catch Down to May's Crude Slide", date: "June 1, 2026" },
  { id: 205, title: "U.S. Strikes Iranian Military Site at Bandar Abbas; IRGC Claims Retaliatory Airbase Attack", date: "May 28, 2026" },
  { id: 206, title: "Baker Hughes: U.S. Oil Rig Count Rises 4 to 429 in the Week Ended May 29", date: "May 29, 2026" },
];

const GEO_ITEMS = [
  { id: 301, region: "Iran", title: "Iran Halts All Communication With U.S. Unless Israel Stops Lebanon Offensive", desc: "Iran announced Monday it is suspending all communication with the United States unless Israel halts its expanding offensive in southern Lebanon, per Tasnim. FM Araghchi: a U.S.-Iran ceasefire \"constitutes, without any ambiguity, a comprehensive ceasefire across all fronts, including Lebanon.\" Tehran threatened to completely close the Strait of Hormuz and open the Bab el-Mandeb front in retaliation. The freeze halts a track that days earlier appeared near a 60-day MOU." },
  { id: 302, region: "United States", title: "Trump: 'I Couldn't Care Less' Whether Iran Talks End; Later Touts Lebanon De-escalation", desc: "President Trump told CNBC he does not care if talks with Iran come to an end, sending oil higher. Hours later he posted that productive calls with Netanyahu and, via intermediaries, with Hezbollah had secured pledges that \"all shooting will stop\" and that troops headed to Beirut were turned back. \"Just sit back and relax, it will all work out well in the end,\" he wrote, even as the Iran-U.S. channel stayed frozen." },
  { id: 303, region: "Lebanon", title: "Israel Pushes Deeper Into Lebanon; Hezbollah Launches 20+ Strikes Before Brokered Halt", desc: "Israel ordered troops deeper into southern Lebanon and warned Beirut's Dahiyeh suburb to evacuate after Hezbollah launched more than 20 attacks on Israeli targets Sunday and Monday. Netanyahu said Hezbollah's Beirut headquarters would \"remain out of bounds.\" A late-Monday Trump-brokered understanding paused the shooting, but the episode shattered the fragile calm and became the trigger for Iran suspending nuclear-and-Hormuz diplomacy." },
  { id: 304, region: "Strait of Hormuz", title: "Hormuz-Closure Threat Returns; Tehran Warns It Could Open Bab el-Mandeb Front", desc: "With talks suspended, Iran warned it could completely block the Strait of Hormuz and open additional fronts including the Bab el-Mandeb Strait, the chokepoint linking the Red Sea to the Gulf of Aden. Hormuz has been effectively closed since the war began February 28; Iran crude loadings for May fell below 0.3 million bpd, down from 1.5 million in April per UBS. Any reopening would likely be only partial given infrastructure damage across the Gulf." },
  { id: 305, region: "Global Markets", title: "Oil Rallies After Worst Month Since the Pandemic; WTI $92, Brent $95", desc: "WTI rose more than 5% Monday to settle at $92.16 and Brent advanced more than 4% to $94.98 as the talks collapse erased hopes for a near-term Hormuz reopening. The bounce follows Brent's ~19% slide in May — its worst month since the pandemic — and a week in which both benchmarks fell more than 9%. Goldman Sachs sees 4Q26 Brent at $90 and WTI at $83 with two-sided risks; ICMA's Parker expects $90–$100 near term." },
  { id: 306, region: "U.S. Consumers", title: "AAA National Average Eases to $4.322 as Pumps Lag May's Crude Decline", desc: "AAA's national average for regular gasoline eased to $4.322 Monday, continuing to drift lower as pump prices catch down to May's crude slide. Monday's spike in crude has not yet reached the pump given the one-to-two-week lag. Prices remain the highest in four years and up roughly 50% since the war began; six states sit near $5 (Alaska, Hawaii, Illinois, Nevada, Oregon, Washington) and California tops $6." },
];
