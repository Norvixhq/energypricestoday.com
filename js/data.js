...
const COMMODITIES = [
  { name: "WTI Crude", price: 102.18, change: 4.11, pct: 4.19, unit: "$/bbl", spark: [94.81,94.81,95.42,95.42,95.42,98.07,102.18], loading: false },
  { name: "Brent Crude", price: 107.77, change: 3.56, pct: 3.42, unit: "$/bbl", spark: [100.06,100.06,101.29,101.29,101.29,104.21,107.77], loading: false },
  { name: "Natural Gas", price: 2.79, change: 0.03, pct: 1.09, unit: "$/MMBtu", spark: [2.76,2.74,2.72,2.71,2.71,2.76,2.79], loading: false },
  { name: "Gasoline RBOB", price: 3.53, change: 0.11, pct: 3.22, unit: "$/gal", spark: [3.25,3.30,3.32,3.28,3.28,3.42,3.53], loading: false },
  { name: "Heating Oil", price: 4.25, change: 0.13, pct: 3.16, unit: "$/gal", spark: [3.92,3.98,4.01,3.96,3.96,4.12,4.25], loading: false },
  { name: "Murban Crude", price: 109.50, change: 2.10, pct: 1.96, unit: "$/bbl", spark: [100.40,101.90,102.50,103.10,103.10,107.40,109.50], loading: false },
  { name: "Diesel ULSD", price: 4.25, change: 0.13, pct: 3.16, unit: "$/gal", spark: [3.92,3.98,4.01,3.96,3.96,4.12,4.25], loading: false },
  { name: "Jet Fuel", price: 4.63, change: 0.14, pct: 3.12, unit: "$/gal", spark: [4.32,4.37,4.40,4.31,4.31,4.49,4.63], loading: false },
  { name: "Coal", price: 141.8, change: 1.7, pct: 1.21, unit: "$/ton", spark: [138.9,139.1,138.4,138.4,138.4,140.1,141.8], loading: false },
  { name: "Gold", price: 4892.10, change: 35.70, pct: 0.74, unit: "$/oz", spark: [], loading: false },
];
...
const BREAKING_NEWS = [
  ...
  { title: "U.S. Considers Restart of Commercial Vessel Escorts Through Strait of Hormuz", cat: "Geopolitics", slug: "geopolitics", time: "5h" },
  { title: "Trump Heads to Beijing This Week; Set to Press Xi to Lean on Iran", cat: "Geopolitics", slug: "geopolitics", time: "6h" },
  { title: "AAA Gas Eases to $4.50 as Retail Pass-Through Lag Holds for Now", cat: "Gas Prices", slug: "gas-prices", time: "8h" },
...
const MARKET_DRIVERS = [
  { cat: "Military Posture", icon: "shield", title: "Trump Weighs Return to Military Action; National Security Team Meeting on Hormuz", desc: "Reports Tuesday indicated President Trump is preparing to meet with his national security team to weigh a potential return to military operations against Iran, alongside renewed discussions about restarting commercial vessel escorts through the Strait of Hormuz. The escalation in posture follows Trump's Sunday rejection of Iran's counterproposal as 'TOTALLY UNACCEPTABLE' and his Monday characterization of the ceasefire as 'on massive life support… 1% chance of living.'" },
  { cat: "Oil Markets", icon: "trending-up", title: "WTI Tops $102, Brent $108 as Hormuz Stalemate Deepens", desc: "WTI June futures advanced 4.2% Tuesday to settle at $102.18; Brent July futures gained 3.4% to $107.77. Both benchmarks are now up more than 45% since the U.S.-Israeli war against Iran began February 28. Citi: 'Oil prices have been volatile and can rise further if US-Iran dealmaking remains thorny.' Implied volatility climbed; Kalshi traders moved odds of WTI reaching $127 in 2026 above 70%." },
  { cat: "Stalemate", icon: "users", title: "Hochstein: 'Frozen Conflict, No War, No Oil, No Straits'; Sees $90-100 Through 2027", desc: "Amos Hochstein, former senior energy advisor to President Biden, told CNBC's 'Squawk Box' Tuesday: 'We're in a stalemate, a frozen conflict. In the meantime, the straits are closed so we're in a no war, no oil, no straits condition.' Hochstein expects oil to remain in a $90-100 range through the rest of 2026 and into 2027 even if Hormuz reopens in early June. A breakthrough this week is unlikely as Trump heads to China to meet with Xi Jinping." },
  { cat: "Diplomacy", icon: "globe", title: "Trump Heads to Beijing This Week; Set to Press Xi to Lean on Iran", desc: "President Trump is scheduled to travel to Beijing later this week to meet with President Xi Jinping. Trump may ask Xi to press Iran to accept U.S. terms during their talks, according to Henry Wilkinson, chief intelligence officer at geopolitical risk firm Dragonfly. China has called repeatedly for the Strait of Hormuz to reopen given how much of its energy supply transits the waterway." },
  { cat: "Supply Outlook", icon: "anchor", title: "Aramco: Normalization Slips Into 2027 if Hormuz Blocked Past Mid-June", desc: "Saudi Aramco CEO Amin Nasser warned the oil market will take until 2027 to normalize if the Strait of Hormuz remains blocked beyond mid-June. The market is losing roughly 100 million barrels of supply each week. The IEA continues to call this the largest supply shock on record. WTI and Brent are both up more than 45% since the conflict began February 28." },
  { cat: "Pump Prices", icon: "fuel", title: "AAA Gas Eases to $4.50 as Retail Pass-Through Lag Holds for Now", desc: "AAA reported the U.S. national average for regular gasoline at $4.504 per gallon Tuesday — down 1.6 cents from Monday and 4 cents from Friday's $4.546 peak. The modest decline reflects the multi-day lag from the May 5-9 crude pullback. The current rally back above $100 WTI will reverse the retail easing within one to two weeks. California highest at $6.16, Hawaii $5.65." },
];

const FEATURED_ARTICLES = [
  { id: 101, title: "Trump Weighs Return to Military Action; National Security Team Meeting on Hormuz", excerpt: "Reports Tuesday indicated President Trump is preparing to meet with his national security team to weigh a potential return to military operations against Iran, alongside renewed discussions about restarting commercial vessel escorts through the Strait of Hormuz. The escalation in posture follows Trump's Sunday rejection of Iran's counterproposal and Monday characterization of the ceasefire as 'on massive life support.'", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 12, 2026", readTime: "7 min", featured: true },
  { id: 102, title: "WTI Tops $102, Brent $108 as Hormuz Stalemate Deepens", excerpt: "WTI June futures advanced 4.2% Tuesday to settle at $102.18; Brent July futures gained 3.4% to $107.77. Both benchmarks are now up more than 45% since the U.S.-Israeli war against Iran began February 28. Citi sees prices rising further if dealmaking remains thorny. Implied volatility climbed; Kalshi traders moved odds of WTI reaching $127 in 2026 above 70%.", cat: "Oil Markets", slug: "oil-prices", author: "EnergyPricesToday Editorial", date: "May 12, 2026", readTime: "5 min" },
  { id: 103, title: "Hochstein: 'Frozen Conflict, No War, No Oil, No Straits'; Sees $90-100 Through 2027", excerpt: "Amos Hochstein, former senior energy advisor to President Biden, told CNBC's 'Squawk Box' Tuesday: 'We're in a stalemate, a frozen conflict. In the meantime, the straits are closed so we're in a no war, no oil, no straits condition.' He expects oil to remain in a $90-100 range through 2026 and into 2027 even if Hormuz reopens in early June.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 12, 2026", readTime: "6 min" },
  { id: 104, title: "Trump Heads to Beijing This Week; Set to Press Xi to Lean on Iran", excerpt: "President Trump is scheduled to travel to Beijing later this week to meet with President Xi Jinping. Trump may ask Xi to press Iran to accept U.S. terms during the talks, according to Henry Wilkinson of Dragonfly. China has called repeatedly for the Strait of Hormuz to reopen given how much of its energy supply transits the waterway.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 12, 2026", readTime: "5 min" },
  { id: 105, title: "Trump Rejects Iran's Counterproposal as 'Totally Unacceptable'; Threatens to Resume Bombing", excerpt: "President Trump on Sunday May 10 publicly rejected Iran's counterproposal to end the 10-week war, calling it 'TOTALLY UNACCEPTABLE' in a Truth Social post. Iran's counter demanded the U.S. lift OFAC sanctions on Iranian oil for 30 days and end the naval blockade. Iran vowed to 'never bow.'", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 11, 2026", readTime: "7 min" },
];

const COMPANY_NEWS = [
  { id: 201, title: "Trump Weighs Return to Military Action; National Security Team Meeting on Hormuz", date: "May 12, 2026" },
  { id: 202, title: "U.S. Considers Restart of Commercial Vessel Escorts Through Strait of Hormuz", date: "May 12, 2026" },
  { id: 203, title: "Aramco CEO: Hormuz Normalization Could Slip Into 2027 as 100M Barrels Lost Weekly", date: "May 11, 2026" },
  { id: 204, title: "Iran Seized U.S.-Sanctioned Ocean Koi Tanker in Gulf of Oman May 8", date: "May 8, 2026" },
  { id: 205, title: "Cenovus CEO Warns Canada Risks Losing Oil Investment After 83% Q1 Profit Jump", date: "May 7, 2026" },
  { id: 206, title: "ExxonMobil Q1 Profit Falls to 5-Year Low at $4.2B Despite Beating Estimates", date: "May 1, 2026" },
];

const GEO_ITEMS = [
  { id: 301, region: "United States", title: "Trump Weighs Return to Military Action; National Security Team Meeting on Hormuz", desc: "Reports Tuesday May 12 indicated President Trump is preparing to meet with his national security team to weigh a potential return to military operations against Iran, alongside renewed discussions about restarting commercial vessel escorts through the Strait of Hormuz — a possible Project Freedom 2.0. The escalation in posture follows Trump's Sunday rejection of Iran's counterproposal and Monday characterization of the ceasefire as 'on massive life support… 1% chance of living.' Trump heads to Beijing later this week to meet with President Xi Jinping." },
  { id: 302, region: "Persian Gulf", title: "U.S. Considers Restart of Commercial Vessel Escorts Through Strait of Hormuz", desc: "Tuesday reports indicated the U.S. is weighing a restart of commercial vessel escorts through the Strait of Hormuz, similar to the original Project Freedom initiative that was paused on May 5 to allow diplomatic space. CENTCOM has continued naval presence in the region throughout the standoff. Restarting escorts would mark an explicit U.S. signal that the deal is dead and the conflict has reentered an active military posture phase." },
  { id: 303, region: "China", title: "Trump Heads to Beijing This Week; Set to Press Xi to Lean on Iran", desc: "President Trump is scheduled to travel to Beijing later this week to meet with President Xi Jinping. Trump may ask Xi to press Iran to accept U.S. terms during their talks, according to Henry Wilkinson, chief intelligence officer at geopolitical risk firm Dragonfly. China has called for the Strait of Hormuz to reopen given how much of its energy supply transits the waterway. The visit functions as a hard deadline on the negotiating timeline." },
  { id: 304, region: "Iran", title: "Iran Vows to 'Never Bow' as Frozen Conflict Hardens Into Twelfth Week", desc: "Iranian state media has continued framing Tehran's counterproposal as a rejection of what Iranian officials describe as a U.S. demand for 'surrender.' Iranian Army spokesperson Brig. Gen. Mohammad Akraminia previously warned of 'surprising options' if adversaries made another 'miscalculation.' Tehran reportedly continues to demand a 30-day suspension of OFAC sanctions on Iranian oil sales and an end to the naval blockade. The conflict is now in its twelfth week and 79 days." },
  { id: 305, region: "Persian Gulf", title: "Aramco: Hormuz Normalization Slips Into 2027 if Strait Blocked Past Mid-June", desc: "Saudi Aramco CEO Amin Nasser warned the oil market will take until 2027 to normalize if the Strait of Hormuz remains blocked beyond mid-June. The market is losing roughly 100 million barrels of supply each week. Saudi Arabia's East-West Pipeline continues at full 5M bpd capacity; the UAE's ADCOP at full 1.8M bpd; combined bypass below the 20M+ bpd that normally transits Hormuz. The IEA continues to call this the largest supply shock on record." },
  { id: 306, region: "Israel / Lebanon", title: "Netanyahu: Conflict With Iran 'Not Over'; Israeli Strikes Continue in Lebanon", desc: "Israeli Prime Minister Benjamin Netanyahu said the war with Iran is 'not over' because 'more work is to be done.' Israeli strikes continue in Lebanon despite the extended ceasefire. Lebanese authorities continue to report Israeli operations have killed more than 2,600 people and displaced more than 1 million. The unresolved standoff hangs over the high-stakes Trump-Xi summit later this week." },
];
...
const CATEGORY_CONTENT = {
  ...
  "geopolitics": {
    articles: [
      { id: 1387, title: "Trump Weighs Return to Military Action; National Security Team Meeting on Hormuz", excerpt: "Reports Tuesday May 12 indicated President Trump is preparing to meet with his national security team to weigh a potential return to military operations against Iran, alongside renewed discussions about restarting commercial vessel escorts through the Strait of Hormuz. The escalation in posture follows Trump's Sunday rejection of Iran's counterproposal. Conflict in its twelfth week and 79 days.", date: "May 12, 2026", author: "EnergyPricesToday Editorial", readTime: "7 min" },
...
const GAS_PRICES_BY_STATE = [
  { state:"Alabama", abbr:"AL", regular:4.201, mid:4.697, premium:5.15, diesel:5.955 },
  { state:"Alaska", abbr:"AK", regular:5.114, mid:5.359, premium:5.618, diesel:6.555 },
  { state:"Arizona", abbr:"AZ", regular:5.109, mid:5.535, premium:5.886, diesel:6.646 },
  { state:"Arkansas", abbr:"AR", regular:4.003, mid:4.506, premium:4.92, diesel:5.684 },
  { state:"California", abbr:"CA", regular:6.469, mid:6.74, premium:6.937, diesel:8.423 },
  { state:"Colorado", abbr:"CO", regular:4.344, mid:4.79, premium:5.15, diesel:5.683 },
  { state:"Connecticut", abbr:"CT", regular:4.51, mid:5.115, premium:5.55, diesel:6.535 },
  { state:"Delaware", abbr:"DE", regular:4.358, mid:5.028, premium:5.368, diesel:6.364 },
  { state:"District of Columbia", abbr:"DC", regular:4.757, mid:5.42, premium:5.84, diesel:6.527 },
  { state:"Florida", abbr:"FL", regular:4.546, mid:5.064, premium:5.431, diesel:6.181 },
  { state:"Georgia", abbr:"GA", regular:4.031, mid:4.545, premium:5.013, diesel:5.773 },
  { state:"Hawaii", abbr:"HI", regular:6.289, mid:6.55, premium:6.818, diesel:7.913 },
  { state:"Idaho", abbr:"ID", regular:4.773, mid:5.108, premium:5.408, diesel:6.09 },
  { state:"Illinois", abbr:"IL", regular:4.789, mid:5.433, premium:5.953, diesel:5.984 },
  { state:"Indiana", abbr:"IN", regular:4.243, mid:4.852, premium:5.403, diesel:5.978 },
  { state:"Iowa", abbr:"IA", regular:3.993, mid:4.24, premium:4.921, diesel:5.574 },
  { state:"Kansas", abbr:"KS", regular:3.849, mid:4.212, premium:4.584, diesel:5.243 },
  { state:"Kentucky", abbr:"KY", regular:4.363, mid:4.983, premium:5.457, diesel:5.901 },
  { state:"Louisiana", abbr:"LA", regular:4.106, mid:4.594, premium:5.024, diesel:5.771 },
  { state:"Maine", abbr:"ME", regular:4.412, mid:5.013, premium:5.554, diesel:6.473 },
  { state:"Maryland", abbr:"MD", regular:4.497, mid:5.177, premium:5.529, diesel:6.417 },
  { state:"Massachusetts", abbr:"MA", regular:4.388, mid:5.047, premium:5.47, diesel:6.496 },
  { state:"Michigan", abbr:"MI", regular:4.286, mid:4.949, premium:5.579, diesel:5.794 },
  { state:"Minnesota", abbr:"MN", regular:4.066, mid:4.546, premium:5.091, diesel:5.609 },
  { state:"Mississippi", abbr:"MS", regular:4.106, mid:4.584, premium:5.024, diesel:5.765 },
  { state:"Missouri", abbr:"MO", regular:4.03, mid:4.484, premium:4.83, diesel:5.394 },
  { state:"Montana", abbr:"MT", regular:4.286, mid:4.625, premium:5.006, diesel:5.517 },
  { state:"Nebraska", abbr:"NE", regular:3.986, mid:4.174, premium:4.688, diesel:5.396 },
  { state:"Nevada", abbr:"NV", regular:5.459, mid:5.813, premium:6.133, diesel:6.938 },
  { state:"New Hampshire", abbr:"NH", regular:4.362, mid:4.976, premium:5.489, diesel:6.426 },
  { state:"New Jersey", abbr:"NJ", regular:4.397, mid:5.011, premium:5.305, diesel:6.442 },
  { state:"New Mexico", abbr:"NM", regular:4.319, mid:4.794, premium:5.138, diesel:5.975 },
  { state:"New York", abbr:"NY", regular:4.572, mid:5.132, premium:5.555, diesel:6.593 },
  { state:"North Carolina", abbr:"NC", regular:4.225, mid:4.72, premium:5.164, diesel:6.289 },
  { state:"North Dakota", abbr:"ND", regular:3.97, mid:4.351, premium:4.811, diesel:5.38 },
  { state:"Ohio", abbr:"OH", regular:4.146, mid:4.741, premium:5.311, diesel:5.938 },
  { state:"Oklahoma", abbr:"OK", regular:3.789, mid:4.251, premium:4.571, diesel:5.255 },
  { state:"Oregon", abbr:"OR", regular:5.501, mid:5.754, premium:6.055, diesel:6.967 },
  { state:"Pennsylvania", abbr:"PA", regular:4.536, mid:5.026, premium:5.446, diesel:6.677 },
  { state:"Rhode Island", abbr:"RI", regular:4.383, mid:5.126, premium:5.599, diesel:6.393 },
  { state:"South Carolina", abbr:"SC", regular:4.144, mid:4.639, premium:5.084, diesel:6.154 },
  { state:"South Dakota", abbr:"SD", regular:4.047, mid:4.242, premium:4.768, diesel:5.336 },
  { state:"Tennessee", abbr:"TN", regular:4.224, mid:4.74, premium:5.175, diesel:5.977 },
  { state:"Texas", abbr:"TX", regular:4.114, mid:4.645, premium:5.063, diesel:5.798 },
  { state:"Utah", abbr:"UT", regular:4.629, mid:4.94, premium:5.216, diesel:5.916 },
  { state:"Vermont", abbr:"VT", regular:4.516, mid:5.065, premium:5.577, diesel:6.489 },
  { state:"Virginia", abbr:"VA", regular:4.351, mid:4.877, premium:5.297, diesel:6.322 },
  { state:"Washington", abbr:"WA", regular:5.941, mid:6.245, premium:6.506, diesel:7.662 },
  { state:"West Virginia", abbr:"WV", regular:4.314, mid:4.775, premium:5.283, diesel:6.097 },
  { state:"Wisconsin", abbr:"WI", regular:4.139, mid:4.704, premium:5.358, diesel:5.476 },
  { state:"Wyoming", abbr:"WY", regular:4.255, mid:4.601, premium:4.927, diesel:5.573 }
];
