...
const MARKET_DRIVERS = [
  { cat: "G7 Paris Meeting", icon: "users", title: "G7 Finance Ministers Convene in Paris Today; Final Communiqué Tuesday", desc: "G7 finance ministers and central bank governors are meeting in Paris on Monday May 18 to address the economic fallout of the Iran war and the Strait of Hormuz closure. French Finance Minister Roland Lescure is hosting, with U.S. Treasury Secretary Scott Bessent urging alignment on Iran sanctions, German Finance Minister Lars Klingbeil declaring G7 \"the right framework\" for ending the war, and ECB President Christine Lagarde and Eurogroup President Kyriakos Pierakakis in attendance. France is pitching a \"common toolbox\" of strategic trade deals, price floors, quotas, and tariffs to combat raw-materials disruption. Final press conference Tuesday midday; the G7 leaders summit follows June 15-17 in Evian." },
  { cat: "Iran Revised Proposal", icon: "alert-triangle", title: "Iran's Revised Peace Proposal: Transfer Enriched Uranium to Russia, Drop Financial Demands", desc: "Iranian media reports today that Tehran's revised peace proposal — delivered via Pakistan — includes transferring its 60%-enriched uranium stockpile to Russia rather than the United States, a significant shift from Iran's previous position that the material \"will under no circumstances be transferred anywhere.\" Iran also dropped its demand for direct U.S. financial compensation in favor of economic concessions and international guarantees, and offered to begin gradually reopening Hormuz in exchange for lifting the U.S. blockade. The U.S. has rejected the Russia destination, reportedly suggesting an unspecified third country. Axios sources say Washington characterized the revision as \"token\" improvements." },
  { cat: "UAE Nuclear Strike", icon: "anchor", title: "UAE Nuclear Facility Attacked Over the Weekend; Persian Gulf Escalation Continues", desc: "Energy infrastructure across the Persian Gulf came under attack over the weekend, including a nuclear facility in the United Arab Emirates, adding to concerns over regional stability and potential further supply disruptions. The attack comes as the UAE — having formally departed OPEC effective May 1 — has positioned itself as a primary U.S. security partner in the Gulf. EIA assesses 10.5 million bpd of Persian Gulf crude production was shut in during April; shut-ins are expected to peak near 10.8 million bpd in May. Saudi production remains at its lowest level since 1990." },
  { cat: "Aramco CEO Warning", icon: "trending-up", title: "Saudi Aramco CEO Nasser: Hormuz Reopening Past Mid-June Pushes Market Normalization to 2027", desc: "Saudi Aramco CEO Amin Nasser told investors on the company's first-quarter earnings call: \"If the Strait of Hormuz opens today, it will still take months for the market to rebalance, and if its opening is delayed by a few more weeks, then normalization will last into 2027.\" The IEA's monthly oil market report released Monday separately confirmed global oil inventories are declining rapidly. WTI has been volatile today, briefly climbing above $108 before easing toward $105 on reports of a U.S. proposed temporary sanctions waiver; Brent traded between $102 and $111 in the same session." },
  { cat: "Federal Gas Tax", icon: "fuel", title: "Trump Considers Suspending 18.4-Cent Federal Gasoline Tax as AAA National Average Hits $4.515", desc: "President Trump told CBS News this morning that he wants to suspend the federal 18.4-cent-per-gallon gasoline tax \"for a period of time,\" adding that once prices fall he would \"let it phase back in.\" AAA's national average sits at $4.515 today, with California above $6 and six states above $5 (Alaska, Hawaii, Illinois, Nevada, Oregon, Washington). Pump prices are 53% above pre-conflict February baseline. Diesel-driven inflation has spread internationally: strikes and protests broke out in Kenya Monday after diesel jumped 50%." },
  { cat: "SPR Coordination", icon: "bar-chart", title: "G7 Coordinated Release of 400 Million Barrels From Strategic Reserves Last Month", desc: "Last month, G7 nations released 400 million barrels of their strategic petroleum reserves following a phone call between G7 leaders to address the supply shock. The move tempered the rise in prices but only temporarily. The U.S. Strategic Petroleum Reserve fell to 384.1 million barrels as of the most recent EIA print, the lowest level since October 2024. EIA's Weekly Petroleum Status Report (data for week ending May 8) showed U.S. commercial crude inventories fell by 4.3 million barrels to 452.9 million — nearly double consensus." },
];

const FEATURED_ARTICLES = [
  { id: 101, title: "G7 Finance Ministers Convene in Paris with Iran War, Hormuz Closure Topping Agenda", excerpt: "G7 finance ministers and central bank governors meet in Paris on Monday May 18 to address the economic fallout of the Iran war. French Finance Minister Roland Lescure is hosting, with U.S. Treasury Secretary Scott Bessent urging alignment on Iran sanctions and German FM Klingbeil calling G7 \"the right framework\" for ending the war. ECB President Lagarde and Eurogroup President Pierakakis are in attendance. France is pitching a \"common toolbox\" for raw-materials disruption. Final press conference Tuesday midday; G7 leaders summit follows June 15-17 in Evian.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 18, 2026", readTime: "6 min", featured: true },
  { id: 102, title: "Iran's Revised Peace Proposal: Transfer Enriched Uranium to Russia, Drop Financial Demands", excerpt: "Iranian media reported today that Tehran's revised peace proposal — delivered via Pakistan — includes transferring its 60%-enriched uranium stockpile to Russia rather than the United States, a significant shift from Iran's previous position that the material \"will under no circumstances be transferred anywhere.\" Iran also dropped its demand for direct U.S. financial compensation in favor of economic concessions and international guarantees, and offered to begin gradually reopening Hormuz in exchange for lifting the U.S. blockade. The U.S. rejected the Russia destination, suggesting a third country instead.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 18, 2026", readTime: "6 min" },
  { id: 103, title: "UAE Nuclear Facility Attacked Over the Weekend in Persian Gulf Escalation", excerpt: "Energy infrastructure across the Persian Gulf came under attack over the weekend, including a nuclear facility in the United Arab Emirates, adding to concerns over regional stability and potential further supply disruptions. The attack comes as the UAE — having formally departed OPEC effective May 1 — has positioned itself as a primary U.S. security partner in the Gulf. WTI whipsawed today between $108 and $105 on competing escalation/de-escalation signals; Brent traded between $111 and $102 in the same session.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 18, 2026", readTime: "5 min" },
  { id: 104, title: "G7 Finance Ministers Meet in Paris with Hormuz Closure at Top of Agenda", excerpt: "Setting up Monday's G7 finance ministers meeting in Paris, Eurogroup President Pierakakis said publicly that \"opening the Strait of Hormuz and bringing the conflict to a lasting end are of the utmost importance.\" Long-term borrowing costs across multiple G7 economies surged on fears of climbing inflation. The 30-year Treasury yield hit 5.121% Friday, the highest since May 2025. Brent is up 74% year-to-date.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 17, 2026", readTime: "6 min" },
  { id: 105, title: "Netanyahu Coalition Fractures Over Ultra-Orthodox Draft Dispute; Early Elections Possible", excerpt: "Israeli Prime Minister Benjamin Netanyahu is managing a coalition crisis that has turned Israel's ultra-Orthodox military draft dispute into a potential early-election trigger. The political instability adds a new dimension of uncertainty to the Israel-Iran war footing and to ceasefire negotiations. Continuing diplomatic progress is contingent on whether Netanyahu's coalition can hold long enough to deliver on the proposed 20-year Iran nuclear moratorium framework Pakistan has been mediating.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 16, 2026", readTime: "5 min" },
  { id: 106, title: "Baker Hughes Rig Count Climbs to 551 — Third Consecutive Weekly Gain", excerpt: "The U.S. rig count rose by 3 to 551 in the week ended May 15, 2026, the third consecutive weekly increase, according to Baker Hughes. Oil rigs gained 5 to 415 while gas rigs slipped 1 to 128 and misc rigs fell 1 to 8. The Permian Basin added 1 rig. Year over year the U.S. count is down 25 from 576. Canada was unchanged at 124. Combined North America count rose 3 to 675.", cat: "Oil Markets", slug: "oil-prices", author: "EnergyPricesToday Editorial", date: "May 16, 2026", readTime: "5 min" },
];

const COMPANY_NEWS = [
  { id: 201, title: "G7 Finance Ministers Convene in Paris with Iran War, Hormuz Closure Topping Agenda", date: "May 18, 2026" },
  { id: 202, title: "Iran's Revised Peace Proposal: Transfer Enriched Uranium to Russia, Drop Financial Demands", date: "May 18, 2026" },
  { id: 203, title: "UAE Nuclear Facility Attacked Over the Weekend in Persian Gulf Escalation", date: "May 18, 2026" },
  { id: 204, title: "Netanyahu Coalition Fractures Over Ultra-Orthodox Draft Dispute; Early Elections Possible", date: "May 16, 2026" },
  { id: 205, title: "Baker Hughes Rig Count Climbs to 551 — Third Consecutive Weekly Gain", date: "May 16, 2026" },
  { id: 206, title: "Trump-Xi Summit in Beijing: Both Sides Agree Strait of Hormuz Must Remain Open", date: "May 15, 2026" },
];

const GEO_ITEMS = [
  { id: 301, region: "Europe", title: "G7 Finance Ministers Convene in Paris; Final Communiqué Expected Tuesday", desc: "G7 finance ministers and central bank governors meet today in Paris hosted by French FM Roland Lescure. U.S. Treasury Secretary Scott Bessent is urging sanctions alignment on Iran; German FM Lars Klingbeil called G7 \"the right framework\" for ending the war. ECB President Christine Lagarde and Eurogroup President Kyriakos Pierakakis are present. France is pitching a \"common toolbox\" of strategic trade deals, price floors, quotas, and tariffs. Final press conference Tuesday midday; G7 leaders summit June 15-17 in Evian." },
  { id: 302, region: "Iran", title: "Iran's Revised Proposal: Uranium to Russia, Hormuz Gradual Reopening for Blockade Lift", desc: "Tehran's revised peace proposal — delivered today via Pakistan — includes transferring 60%-enriched uranium to Russia (a major shift from Iran's prior position), dropping financial-compensation demands, and gradually reopening Hormuz in exchange for lifting the U.S. blockade. Washington rejected the Russia destination, suggesting an unspecified third country. Trump: \"For Iran, the clock is ticking, and they better get moving FAST, or there won't be anything left of them. TIME IS OF THE ESSENCE!\"" },
  { id: 303, region: "UAE", title: "UAE Nuclear Facility Attacked Over the Weekend in Persian Gulf Escalation", desc: "Energy infrastructure across the Persian Gulf came under attack over the weekend, including a nuclear facility in the United Arab Emirates, adding to concerns over regional stability and potential further supply disruptions. The UAE — having formally departed OPEC effective May 1 — has positioned itself as a primary U.S. security partner in the Gulf. ADCOP pipeline carries available bypass volumes. EIA assesses 10.5 million bpd of Persian Gulf crude production was shut in during April." },
  { id: 304, region: "Saudi Arabia", title: "Aramco CEO Nasser: Hormuz Reopening Past Mid-June Pushes Market Normalization to 2027", desc: "Saudi Aramco CEO Amin Nasser told investors on the company's first-quarter earnings call: \"If the Strait of Hormuz opens today, it will still take months for the market to rebalance, and if its opening is delayed by a few more weeks, then normalization will last into 2027.\" Saudi production remains at its lowest level since 1990. Iraq, Saudi Arabia, Kuwait, the UAE, Qatar, and Bahrain collectively shut in 10.5 million bpd in April; shut-ins expected to peak near 10.8 million bpd in May." },
  { id: 305, region: "United States", title: "Trump Considers Suspending 18.4-Cent Federal Gasoline Tax; AAA National Avg $4.515", desc: "President Trump told CBS News this morning he wants to suspend the federal 18.4-cent-per-gallon gasoline tax \"for a period of time,\" adding that once prices fall he would \"let it phase back in.\" AAA national average sits at $4.515; California above $6; six states above $5 (Alaska, Hawaii, Illinois, Nevada, Oregon, Washington). Pump prices are 53% above pre-conflict February baseline. Diesel inflation has reached Kenya, where prices jumped 50% and strikes/protests broke out Monday." },
  { id: 306, region: "China", title: "Trump-Xi Summit in Beijing: Both Sides Agree Strait of Hormuz Must Remain Open", desc: "President Trump and President Xi held a two-day summit in Beijing concluding May 14. The White House readout said both leaders agreed Hormuz must remain open and that Iran cannot have a nuclear weapon. Trump told Fox News Xi offered to help broker peace. Xi opposed militarization of the strait and any effort to charge a toll, and expressed interest in purchasing more American oil." },
];
...
const RIG_COUNT_DATA = {
  ...
  us_total: 551, us_total_change: 3, us_oil: 415, us_oil_change: 5, us_gas: 128, us_gas_change: -1, us_misc: 8, us_misc_change: -1,
