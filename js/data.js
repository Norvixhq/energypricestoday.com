...
const COMMODITIES = [
  { name: "WTI Crude", price: 100.30, change: 4.74, pct: 4.96, unit: "$/bbl", spark: [88.71,94.81,94.81,95.42,95.56,95.56,100.30], loading: false },
  { name: "Brent Crude", price: 105.76, change: 4.96, pct: 4.92, unit: "$/bbl", spark: [96.77,100.06,100.06,101.29,101.29,101.29,105.76], loading: false },
  { name: "Natural Gas", price: 2.76, change: 0.05, pct: 1.85, unit: "$/MMBtu", spark: [2.74,2.76,2.74,2.72,2.71,2.71,2.76], loading: false },
  { name: "Gasoline RBOB", price: 3.42, change: 0.14, pct: 4.27, unit: "$/gal", spark: [3.21,3.25,3.30,3.32,3.28,3.28,3.42], loading: false },
  { name: "Heating Oil", price: 4.12, change: 0.16, pct: 4.04, unit: "$/gal", spark: [3.85,3.92,3.98,4.01,3.96,3.96,4.12], loading: false },
  { name: "Murban Crude", price: 107.40, change: 4.30, pct: 4.17, unit: "$/bbl", spark: [98.20,100.40,101.90,102.50,103.10,103.10,107.40], loading: false },
  { name: "Diesel ULSD", price: 4.12, change: 0.16, pct: 4.04, unit: "$/gal", spark: [3.85,3.92,3.98,4.01,3.96,3.96,4.12], loading: false },
  { name: "Jet Fuel", price: 4.49, change: 0.18, pct: 4.18, unit: "$/gal", spark: [4.18,4.32,4.37,4.40,4.31,4.31,4.49], loading: false },
  { name: "Coal", price: 140.1, change: 1.7, pct: 1.23, unit: "$/ton", spark: [138.5,138.9,139.1,138.4,138.4,138.4,140.1], loading: false },
  { name: "Gold", price: 4856.40, change: 41.20, pct: 0.86, unit: "$/oz", spark: [], loading: false },
];
...
const BREAKING_NEWS = [
  ...
  { title: "Qatari LNG Tanker Crosses Hormuz Sunday in Iran-Approved Symbolic Passage", cat: "Geopolitics", slug: "geopolitics", time: "1d" },
  { title: "AAA Gas Average Eases to $4.52, Down 3 Cents Week-on-Week", cat: "Gas Prices", slug: "gas-prices", time: "7h" },
  { title: "Trump: Ceasefire 'On Massive Life Support'; Iran Vows to 'Never Bow'", cat: "Geopolitics", slug: "geopolitics", time: "8h" },
  { title: "Iran Seized U.S.-Sanctioned Ocean Koi Tanker in Gulf of Oman May 8", cat: "Geopolitics", slug: "geopolitics", time: "3d" },
];

const MARKET_DRIVERS = [
  { cat: "Deal Collapse", icon: "alert-triangle", title: "Trump Rejects Iran's Counterproposal as 'Totally Unacceptable'; Threatens to Resume Bombing", desc: "President Trump on Sunday May 10 publicly rejected Iran's counterproposal to end the 10-week war, calling it 'TOTALLY UNACCEPTABLE!' in a Truth Social post. Iran's counter, delivered through Pakistan, demanded the U.S. lift OFAC sanctions on Iranian oil sales for 30 days and end the naval blockade, while refusing to dismantle nuclear infrastructure. Trump threatened: 'If they don't agree, the bombing starts, and it will be, sadly, at a much higher level and intensity than it was before.' Iran vowed to 'never bow.'" },
  { cat: "Oil Markets", icon: "trending-up", title: "Oil Rallies 5% as Hormuz Deal Collapses; WTI $100, Brent $106", desc: "Crude futures surged Monday May 11 after Trump's Sunday rejection of Iran's counterproposal. WTI June futures advanced 4.96% to $100.30 per barrel; Brent July futures gained 4.92% to $105.76. The rally undoes last week's relief move and re-embeds the geopolitical risk premium. Citi maintained risks remain tilted to the upside and modeled a base case of Hormuz reopening end-May with downside risk of pushout. Trump said the ceasefire is 'on massive life support… 1% chance of living.'" },
  { cat: "Gulf Strikes", icon: "shield", title: "Drones Strike Qatari Waters; UAE and Kuwait Intercept Iranian Drones", desc: "Multiple Gulf states reported drone attacks over the weekend. A drone struck a ship in Qatari waters Sunday May 10. The UAE intercepted two drones and openly blamed Tehran. Kuwait separately intercepted hostile drones. Qatar's Foreign Ministry called the strike 'a dangerous and unacceptable escalation.' The attacks come despite Qatar's role as a mediator alongside Pakistan, and undermine the ceasefire that was supposed to allow space for negotiations." },
  { cat: "Supply Warning", icon: "anchor", title: "Aramco CEO: Hormuz Normalization Could Slip Into 2027", desc: "Saudi Aramco CEO Amin Nasser warned on a Monday May 11 analyst call that the market is losing roughly 100 million barrels of supply each week and that if reopening of the Strait of Hormuz is 'delayed by a few more weeks, then normalization will last into 2027.' The IEA has called this the largest supply shock on record. Aramco's warning aligns with Citi and Goldman's tightened forecasts and signals producers are now planning around a longer disruption window." },
  { cat: "Symbolic Passage", icon: "anchor", title: "Qatari LNG Tanker Crosses Hormuz Sunday in Iran-Approved Symbolic Passage", desc: "A Qatari LNG tanker crossed the Strait of Hormuz on Sunday May 10 for the first time since the war began, in a passage reportedly approved by Iran to build confidence with Qatar and Pakistan as mediators. A Panama-flagged bulk carrier bound for Brazil also transited using a route designated by Iran's armed forces. The symbolic opening did little to ease broader market concerns as Trump rejected Iran's counterproposal the same day." },
  { cat: "Pump Prices", icon: "fuel", title: "AAA Gas Average Eases to $4.52, Down 3 Cents Week-on-Week", desc: "AAA reported the U.S. national average for regular gasoline at $4.520 per gallon May 11 — down roughly 3 cents from the May 8 peak of $4.546. The modest pullback reflects the multi-day lag from last week's crude crash. Crude rallying back this week to $100+ WTI will reverse the retail decline within 1-2 weeks. California remains highest at $6.16; Hawaii $5.65. U.S. gasoline inventories down 12 consecutive weeks." },
];

const FEATURED_ARTICLES = [
  { id: 101, title: "Trump Rejects Iran's Counterproposal as 'Totally Unacceptable'; Threatens to Resume Bombing", excerpt: "President Trump on Sunday May 10 publicly rejected Iran's counterproposal to end the 10-week war, calling it 'TOTALLY UNACCEPTABLE!' in a Truth Social post. Iran's counter, delivered through Pakistan, demanded the U.S. lift OFAC sanctions on Iranian oil sales for 30 days and end the naval blockade. Trump threatened: 'If they don't agree, the bombing starts, and it will be, sadly, at a much higher level and intensity than it was before.'", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 11, 2026", readTime: "7 min", featured: true },
  { id: 102, title: "Oil Rallies 5% as Hormuz Deal Collapses; WTI $100, Brent $106", excerpt: "Crude futures surged Monday May 11 after Trump's Sunday rejection of Iran's counterproposal. WTI June futures advanced 4.96% to $100.30 per barrel; Brent July futures gained 4.92% to $105.76. The rally undoes last week's relief move and re-embeds the geopolitical risk premium. Citi modeled a base case of end-May reopening with downside risk of pushout. Trump said the ceasefire is on 'massive life support.'", cat: "Oil Markets", slug: "oil-prices", author: "EnergyPricesToday Editorial", date: "May 11, 2026", readTime: "5 min" },
  { id: 103, title: "Drones Strike Qatari Waters; UAE and Kuwait Intercept Iranian Drones", excerpt: "Multiple Gulf states reported drone attacks over the weekend. A drone struck a ship in Qatari waters Sunday. The UAE intercepted two drones and openly blamed Tehran. Kuwait intercepted hostile drones. Qatar's Foreign Ministry called the strike 'a dangerous and unacceptable escalation.' The attacks come despite Qatar's role as a mediator alongside Pakistan.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 11, 2026", readTime: "5 min" },
  { id: 104, title: "Aramco CEO: Hormuz Normalization Could Slip Into 2027 as 100M Barrels Lost Weekly", excerpt: "Saudi Aramco CEO Amin Nasser warned on a Monday May 11 analyst call that the market is losing roughly 100 million barrels of supply each week and that if reopening of the Strait of Hormuz is 'delayed by a few more weeks, then normalization will last into 2027.' The IEA has called this the largest supply shock on record. Aramco's warning aligns with Citi and Goldman's tightened forecasts.", cat: "Oil Markets", slug: "oil-prices", author: "EnergyPricesToday Editorial", date: "May 11, 2026", readTime: "5 min" },
  { id: 105, title: "Qatari LNG Tanker Crosses Hormuz Sunday in Iran-Approved Symbolic Passage", excerpt: "A Qatari LNG tanker crossed the Strait of Hormuz on Sunday May 10 for the first time since the war began, in a passage reportedly approved by Iran to build confidence with Qatar and Pakistan as mediators. A Panama-flagged bulk carrier bound for Brazil also transited using a route designated by Iran's armed forces. The symbolic opening did little to ease market concerns as Trump rejected Iran's counterproposal the same day.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 10, 2026", readTime: "4 min" },
];

const COMPANY_NEWS = [
  { id: 201, title: "Aramco CEO: Hormuz Normalization Could Slip Into 2027 as 100M Barrels Lost Weekly", date: "May 11, 2026" },
  { id: 202, title: "Iran Seized U.S.-Sanctioned Ocean Koi Tanker in Gulf of Oman May 8", date: "May 8, 2026" },
  { id: 203, title: "Qatari LNG Tanker Crosses Hormuz Sunday in Iran-Approved Symbolic Passage", date: "May 10, 2026" },
  { id: 204, title: "Cenovus CEO Warns Canada Risks Losing Oil Investment After 83% Q1 Profit Jump", date: "May 7, 2026" },
  { id: 205, title: "ExxonMobil Q1 Profit Falls to 5-Year Low at $4.2B Despite Beating Estimates", date: "May 1, 2026" },
  { id: 206, title: "Chevron Posts Biggest Earnings Beat Since 2020 on Record Production", date: "May 1, 2026" },
];

const GEO_ITEMS = [
  { id: 301, region: "United States", title: "Trump Rejects Iran's Counterproposal as 'Totally Unacceptable'; Threatens to Resume Bombing", desc: "President Trump on Sunday May 10 publicly rejected Iran's counterproposal to end the 10-week war via Truth Social: 'I have just read the response from Iran's so-called Representatives. I don't like it — TOTALLY UNACCEPTABLE!' Iran's counter, delivered through Pakistan, demanded the U.S. lift OFAC sanctions on Iranian oil sales for 30 days and end the naval blockade. Iran refused to dismantle nuclear infrastructure but offered to transfer some highly enriched uranium to a third country. Trump threatened: 'If they don't agree, the bombing starts, and it will be, sadly, at a much higher level and intensity than before.'" },
  { id: 302, region: "Iran", title: "Iran Vows to 'Never Bow' as Trump Rejects Counteroffer", desc: "Iranian state media framed Tehran's response as a rejection of the U.S. proposal, which it characterized as a demand for 'surrender.' Iranian Army spokesperson Brig. Gen. Mohammad Akraminia warned of 'surprising options' if adversaries made another 'miscalculation.' Iran said the goal is 'to uphold the rights of the Iranian nation and defend national interests with resolute strength.' Conflict now in its twelfth week and 78 days." },
  { id: 303, region: "Qatar", title: "Drone Strikes Ship in Qatari Waters Despite Mediator Role", desc: "A drone struck a ship in Qatari waters Sunday May 10. Qatar's Foreign Ministry called the attack 'a dangerous and unacceptable escalation that threatens the security and safety of maritime trade routes and vital supplies in the region.' Qatar serves as a mediator in the conflict alongside Pakistan. Earlier in the day, a Qatari LNG tanker crossed Hormuz for the first time since the war began &mdash; an Iran-approved symbolic passage to build mediator confidence." },
  { id: 304, region: "United Arab Emirates", title: "UAE and Kuwait Intercept Iranian Drones in Weekend Strikes", desc: "The UAE said it intercepted two drones over the weekend and openly blamed Tehran. Kuwait separately intercepted hostile drones over its airspace. No casualties were reported from the strikes. The pattern matches the May 4 Fujairah Oil Industry Zone strike and the May 8 UAE missile/drone barrage, suggesting Iran maintains both intent and capability to target Gulf bypass infrastructure even as it negotiates." },
  { id: 305, region: "Persian Gulf", title: "Aramco CEO: Hormuz Normalization Could Slip Into 2027", desc: "Saudi Aramco CEO Amin Nasser warned Monday May 11 that the market is losing roughly 100 million barrels of supply each week and that if the reopening of the Strait of Hormuz is 'delayed by a few more weeks, then normalization will last into 2027.' The IEA has called this the largest supply shock on record. Saudi Arabia's East-West Pipeline continues at full 5M bpd capacity; the UAE's ADCOP at full 1.8M bpd; combined bypass below the 20M+ bpd that normally transits Hormuz." },
  { id: 306, region: "Israel / Lebanon", title: "Netanyahu: Conflict With Iran 'Not Over'; Israeli Strikes Continue in Lebanon", desc: "Israeli Prime Minister Benjamin Netanyahu said the war with Iran is 'not over' because 'more work is to be done.' Israeli strikes continue in Lebanon despite the extended ceasefire; an Israeli strike hit Kfar Tebnit Monday May 11. Lebanese authorities continue to report Israeli operations have killed more than 2,600 people and displaced more than 1 million. The unresolved standoff hangs over the high-stakes Trump-Xi summit scheduled later this week." },
];
...
const GAS_PRICES_BY_STATE = [
  { state:"Alabama", abbr:"AL", regular:4.216, mid:4.714, premium:5.168, diesel:5.976 },
  { state:"Alaska", abbr:"AK", regular:5.132, mid:5.378, premium:5.638, diesel:6.578 },
  { state:"Arizona", abbr:"AZ", regular:5.127, mid:5.555, premium:5.907, diesel:6.67 },
  { state:"Arkansas", abbr:"AR", regular:4.017, mid:4.522, premium:4.937, diesel:5.704 },
  { state:"California", abbr:"CA", regular:6.492, mid:6.764, premium:6.962, diesel:8.453 },
  { state:"Colorado", abbr:"CO", regular:4.359, mid:4.807, premium:5.168, diesel:5.703 },
  { state:"Connecticut", abbr:"CT", regular:4.526, mid:5.133, premium:5.57, diesel:6.558 },
  { state:"Delaware", abbr:"DE", regular:4.373, mid:5.046, premium:5.387, diesel:6.387 },
  { state:"District of Columbia", abbr:"DC", regular:4.774, mid:5.439, premium:5.861, diesel:6.55 },
  { state:"Florida", abbr:"FL", regular:4.562, mid:5.082, premium:5.45, diesel:6.203 },
  { state:"Georgia", abbr:"GA", regular:4.045, mid:4.561, premium:5.031, diesel:5.794 },
  { state:"Hawaii", abbr:"HI", regular:6.311, mid:6.573, premium:6.842, diesel:7.941 },
  { state:"Idaho", abbr:"ID", regular:4.79, mid:5.126, premium:5.427, diesel:6.112 },
  { state:"Illinois", abbr:"IL", regular:4.806, mid:5.452, premium:5.974, diesel:6.005 },
  { state:"Indiana", abbr:"IN", regular:4.258, mid:4.869, premium:5.422, diesel:5.999 },
  { state:"Iowa", abbr:"IA", regular:4.007, mid:4.255, premium:4.938, diesel:5.594 },
  { state:"Kansas", abbr:"KS", regular:3.863, mid:4.227, premium:4.6, diesel:5.262 },
  { state:"Kentucky", abbr:"KY", regular:4.378, mid:5.001, premium:5.476, diesel:5.922 },
  { state:"Louisiana", abbr:"LA", regular:4.121, mid:4.61, premium:5.042, diesel:5.792 },
  { state:"Maine", abbr:"ME", regular:4.428, mid:5.031, premium:5.574, diesel:6.496 },
  { state:"Maryland", abbr:"MD", regular:4.513, mid:5.195, premium:5.549, diesel:6.44 },
  { state:"Massachusetts", abbr:"MA", regular:4.404, mid:5.065, premium:5.489, diesel:6.519 },
  { state:"Michigan", abbr:"MI", regular:4.301, mid:4.967, premium:5.599, diesel:5.815 },
  { state:"Minnesota", abbr:"MN", regular:4.08, mid:4.562, premium:5.109, diesel:5.629 },
  { state:"Mississippi", abbr:"MS", regular:4.121, mid:4.6, premium:5.042, diesel:5.785 },
  { state:"Missouri", abbr:"MO", regular:4.044, mid:4.5, premium:4.847, diesel:5.413 },
  { state:"Montana", abbr:"MT", regular:4.301, mid:4.641, premium:5.024, diesel:5.537 },
  { state:"Nebraska", abbr:"NE", regular:4.0, mid:4.189, premium:4.705, diesel:5.415 },
  { state:"Nevada", abbr:"NV", regular:5.478, mid:5.834, premium:6.155, diesel:6.963 },
  { state:"New Hampshire", abbr:"NH", regular:4.377, mid:4.994, premium:5.509, diesel:6.449 },
  { state:"New Jersey", abbr:"NJ", regular:4.413, mid:5.029, premium:5.324, diesel:6.465 },
  { state:"New Mexico", abbr:"NM", regular:4.334, mid:4.811, premium:5.156, diesel:5.996 },
  { state:"New York", abbr:"NY", regular:4.588, mid:5.15, premium:5.575, diesel:6.616 },
  { state:"North Carolina", abbr:"NC", regular:4.24, mid:4.737, premium:5.182, diesel:6.311 },
  { state:"North Dakota", abbr:"ND", regular:3.984, mid:4.366, premium:4.828, diesel:5.399 },
  { state:"Ohio", abbr:"OH", regular:4.161, mid:4.758, premium:5.33, diesel:5.959 },
  { state:"Oklahoma", abbr:"OK", regular:3.802, mid:4.266, premium:4.587, diesel:5.274 },
  { state:"Oregon", abbr:"OR", regular:5.521, mid:5.774, premium:6.077, diesel:6.992 },
  { state:"Pennsylvania", abbr:"PA", regular:4.552, mid:5.044, premium:5.465, diesel:6.701 },
  { state:"Rhode Island", abbr:"RI", regular:4.399, mid:5.144, premium:5.619, diesel:6.416 },
  { state:"South Carolina", abbr:"SC", regular:4.159, mid:4.655, premium:5.102, diesel:6.176 },
  { state:"South Dakota", abbr:"SD", regular:4.061, mid:4.257, premium:4.785, diesel:5.355 },
  { state:"Tennessee", abbr:"TN", regular:4.239, mid:4.757, premium:5.193, diesel:5.998 },
  { state:"Texas", abbr:"TX", regular:4.129, mid:4.662, premium:5.081, diesel:5.819 },
  { state:"Utah", abbr:"UT", regular:4.645, mid:4.958, premium:5.235, diesel:5.937 },
  { state:"Vermont", abbr:"VT", regular:4.532, mid:5.083, premium:5.597, diesel:6.512 },
  { state:"Virginia", abbr:"VA", regular:4.366, mid:4.894, premium:5.316, diesel:6.344 },
  { state:"Washington", abbr:"WA", regular:5.962, mid:6.267, premium:6.529, diesel:7.689 },
  { state:"West Virginia", abbr:"WV", regular:4.329, mid:4.792, premium:5.302, diesel:6.119 },
  { state:"Wisconsin", abbr:"WI", regular:4.154, mid:4.721, premium:5.377, diesel:5.495 },
  { state:"Wyoming", abbr:"WY", regular:4.27, mid:4.617, premium:4.945, diesel:5.593 }
];
