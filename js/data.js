...
const BREAKING_NEWS = [
  { title: "Iran Declares Strait of Hormuz Completely Open for Commercial Traffic", cat: "Geopolitics", slug: "geopolitics", time: "1h" },
  { title: "Oil Plunges 11% as Hormuz Reopens — WTI Closes at $83.85", cat: "Oil Markets", slug: "oil-prices", time: "2h" },
  { title: "Trump Says US Blockade of Iranian Ports Will Remain in Full Force Until Peace Deal", cat: "Geopolitics", slug: "geopolitics", time: "3h" },
  { title: "Israel-Lebanon 10-Day Ceasefire Takes Effect, Hezbollah Holds Fire", cat: "Geopolitics", slug: "geopolitics", time: "4h" },
  { title: "Paris Summit: Macron and Starmer Host Coalition on Hormuz Security", cat: "Geopolitics", slug: "geopolitics", time: "5h" },
  { title: "Gas Prices Fall to $4.076 — Lowest Level Since Late March", cat: "Gas Prices", slug: "gas-prices", time: "6h" },
  { title: "S&P 500 and Nasdaq Hit Record Highs as Oil Crashes", cat: "Oil Markets", slug: "oil-prices", time: "7h" },
  { title: "Second Round of US-Iran Talks Expected This Weekend", cat: "Geopolitics", slug: "geopolitics", time: "8h" },
];

const MARKET_DRIVERS = [
  { cat: "Hormuz Reopens", icon: "anchor", title: "Iran Declares Strait Completely Open", desc: "Iranian Foreign Minister Abbas Araghchi announced the Strait of Hormuz is completely open to commercial traffic for the remainder of the ceasefire. Ships will use a coordinated route. Oil dropped 11% on the news." },
  { cat: "Crude Oil", icon: "trending-down", title: "WTI Crashes 11.45% to $83.85", desc: "Second-largest one-day decline since the war began. WTI down 24.8% over two weeks — largest two-week drop since April 2020. Still up 25% since February 28 and 45% YTD." },
  { cat: "Gas Prices", icon: "fuel", title: "AAA National Falls to $4.076", desc: "National average dropped another 1.7 cents today to $4.076, the lowest since late March. Gulf states cheapest: Oklahoma $3.42, Mississippi $3.72. California at $5.85 remains most expensive." },
  { cat: "Israel-Lebanon", icon: "shield", title: "10-Day Ceasefire Holds on Day 1", desc: "Ceasefire took effect 5 PM Thursday. Trump praised as historic day for Lebanon; demanded Israel uphold terms. Hezbollah celebrated but destruction extensive — over 40,000 homes destroyed in southern Lebanon." },
  { cat: "Diplomacy", icon: "globe", title: "Paris Summit on Hormuz Security", desc: "Macron and Starmer hosted multinational summit Friday on reopening the Strait of Hormuz as part of a defensive multilateral mission. UK, France, South Korea, and others exploring coordinated security role." },
  { cat: "US Blockade", icon: "alert-triangle", title: "Trump Keeps Blockade Despite Reopening", desc: "US naval blockade of Iranian ports remains in full force. Trump says it ends only when peace deal is signed. Iran warns of response if blockade continues; second round of US-Iran talks expected this weekend." },
];

const FEATURED_ARTICLES = [
  { id: 101, title: "Hormuz Reopens: Iran Declares Strait Open as Oil Crashes 11%", excerpt: "Iran's Foreign Minister Abbas Araghchi announced the Strait of Hormuz is completely open to commercial traffic. WTI crude closed down 11.45% to $83.85, the lowest since March 10. S&P 500 hit record highs.", cat: "Geopolitics", slug: "geopolitics", author: "Staff", date: "Apr 17, 2026", readTime: "8 min", featured: true },
  { id: 102, title: "Oil Plunges Most Since April 2020 on Hormuz Reopening News", excerpt: "The second-largest single-day oil drop since the war began. WTI now down 24.8% over two weeks — the largest two-week decline since the pandemic. Traders pricing in rapid supply normalization.", cat: "Oil Markets", slug: "oil-prices", author: "Staff", date: "Apr 17, 2026", readTime: "6 min" },
  { id: 103, title: "Paris Summit Convenes Coalition on Hormuz Security and Shipping", excerpt: "Macron and Starmer host multinational summit to discuss defensive coordination. UK, France, South Korea exploring role in maintaining freedom of navigation through the strait going forward.", cat: "Geopolitics", slug: "geopolitics", author: "Staff", date: "Apr 17, 2026", readTime: "5 min" },
  { id: 104, title: "Gas Prices Continue Slide — AAA National Falls to $4.076", excerpt: "Second consecutive day of declines. Oklahoma cheapest at $3.42, California highest at $5.85. With crude dropping sharply, wholesale gasoline will flow through to pumps over the next 1-2 weeks.", cat: "Gas Prices", slug: "gas-prices", author: "Staff", date: "Apr 17, 2026", readTime: "5 min" },
  { id: 105, title: "Israel-Lebanon Ceasefire Takes Effect as US Blockade Continues", excerpt: "The 10-day Israel-Lebanon ceasefire began Thursday 5 PM. Trump says the US naval blockade of Iranian ports remains in full force until the U.S.-Iran peace deal is signed.", cat: "Geopolitics", slug: "geopolitics", author: "Staff", date: "Apr 17, 2026", readTime: "7 min" },
];

const COMPANY_NEWS = [
  { id: 201, title: "Energy Stocks Tumble as Oil Crashes 11% on Hormuz Reopening", date: "Apr 17, 2026" },
  { id: 202, title: "ExxonMobil Shares Off 5% as Crude Sell-Off Accelerates", date: "Apr 17, 2026" },
  { id: 203, title: "Cheniere Energy Sees Q1 LNG Demand Surge Before Strait Reopens", date: "Apr 17, 2026" },
  { id: 204, title: "Shell Reports Higher Q1 Upstream Earnings, Maintains Dividend", date: "Apr 16, 2026" },
  { id: 205, title: "Saudi Aramco Restores East-West Pipeline Full Capacity", date: "Apr 12, 2026" },
  { id: 206, title: "ConocoPhillips Completes Marathon Oil Integration Synergies", date: "Apr 11, 2026" },
];

const GEO_ITEMS = [
  { id: 301, region: "Persian Gulf", title: "Iran Declares Strait of Hormuz Completely Open", desc: "Foreign Minister Abbas Araghchi announced the strait is open to all commercial traffic for the remainder of the ceasefire. Coordinated shipping route required. Oil plunged 11% on the news." },
  { id: 302, region: "Diplomacy", title: "Paris Summit Convenes Coalition on Hormuz Security", desc: "Macron and Starmer host multinational summit exploring defensive coordination. UK, France, South Korea among nations considering involvement in safeguarding waterway through which 20% of world oil passes." },
  { id: 303, region: "Middle East", title: "Israel-Lebanon Ceasefire Holds on First Full Day", desc: "10-day ceasefire took effect Thursday 5 PM. Hezbollah holding fire. Trump demanded Israel uphold terms: 'Enough is enough!' Over 40,000 homes destroyed in southern Lebanon, with displaced families slowly returning." },
  { id: 304, region: "United States", title: "Trump: Blockade Continues Until Peace Deal Signed", desc: "Despite Hormuz reopening, Trump says U.S. naval blockade of Iranian ports remains in full force. 'Until such time as our transaction with Iran is 100% complete.' Iran warns of response if blockade continues." },
  { id: 305, region: "Russia", title: "Russian Oil Exports Continue Redirect to Asian Markets", desc: "Moscow maintaining flows to India and China at $10-15 discount. EU oil embargo holding. Hormuz reopening may reduce urgency of Russian alternative supply for some European buyers." },
  { id: 306, region: "OPEC+", title: "OPEC+ April Output Increase on Track", desc: "206,000 bpd increase proceeding. Saudi Arabia East-West Pipeline at full capacity. With Hormuz reopening, expect gradual normalization of Middle East export flows through May." },
];
...
const GAS_PRICES_BY_STATE = [
  { state:"Alabama", abbr:"AL", regular:3.803, mid:4.249, premium:4.658, diesel:5.383 },
  { state:"Alaska", abbr:"AK", regular:4.626, mid:4.847, premium:5.080, diesel:5.923 },
  { state:"Arizona", abbr:"AZ", regular:4.621, mid:5.005, premium:5.321, diesel:6.006 },
  { state:"Arkansas", abbr:"AR", regular:3.625, mid:4.078, premium:4.450, diesel:5.139 },
  { state:"California", abbr:"CA", regular:5.847, mid:6.091, premium:6.269, diesel:7.608 },
  { state:"Colorado", abbr:"CO", regular:3.931, mid:4.334, premium:4.658, diesel:5.138 },
  { state:"Connecticut", abbr:"CT", regular:4.057, mid:4.602, premium:4.993, diesel:5.881 },
  { state:"Delaware", abbr:"DE", regular:3.940, mid:4.544, premium:4.850, diesel:5.748 },
  { state:"District of Columbia", abbr:"DC", regular:4.259, mid:4.856, premium:5.235, diesel:5.854 },
  { state:"Florida", abbr:"FL", regular:4.110, mid:4.577, premium:4.909, diesel:5.585 },
  { state:"Georgia", abbr:"GA", regular:3.649, mid:4.112, premium:4.535, diesel:5.220 },
  { state:"Hawaii", abbr:"HI", regular:5.642, mid:5.877, premium:6.119, diesel:7.105 },
  { state:"Idaho", abbr:"ID", regular:4.319, mid:4.620, premium:4.889, diesel:5.506 },
  { state:"Illinois", abbr:"IL", regular:4.333, mid:4.914, premium:5.381, diesel:5.410 },
  { state:"Indiana", abbr:"IN", regular:3.840, mid:4.389, premium:4.885, diesel:5.405 },
  { state:"Iowa", abbr:"IA", regular:3.615, mid:3.838, premium:4.452, diesel:5.040 },
  { state:"Kansas", abbr:"KS", regular:3.485, mid:3.812, premium:4.147, diesel:4.740 },
  { state:"Kentucky", abbr:"KY", regular:3.949, mid:4.509, premium:4.935, diesel:5.334 },
  { state:"Louisiana", abbr:"LA", regular:3.719, mid:4.158, premium:4.544, diesel:5.218 },
  { state:"Maine", abbr:"ME", regular:3.992, mid:4.535, premium:5.022, diesel:5.851 },
  { state:"Maryland", abbr:"MD", regular:4.079, mid:4.692, premium:5.010, diesel:5.809 },
  { state:"Massachusetts", abbr:"MA", regular:3.940, mid:4.533, premium:4.916, diesel:5.840 },
  { state:"Michigan", abbr:"MI", regular:3.879, mid:4.478, premium:5.044, diesel:5.239 },
  { state:"Minnesota", abbr:"MN", regular:3.680, mid:4.113, premium:4.605, diesel:5.071 },
  { state:"Mississippi", abbr:"MS", regular:3.719, mid:4.147, premium:4.544, diesel:5.212 },
  { state:"Missouri", abbr:"MO", regular:3.648, mid:4.058, premium:4.370, diesel:4.877 },
  { state:"Montana", abbr:"MT", regular:3.879, mid:4.185, premium:4.528, diesel:4.989 },
  { state:"Nebraska", abbr:"NE", regular:3.609, mid:3.779, premium:4.241, diesel:4.879 },
  { state:"Nevada", abbr:"NV", regular:4.936, mid:5.256, premium:5.543, diesel:6.270 },
  { state:"New Hampshire", abbr:"NH", regular:3.928, mid:4.482, premium:4.945, diesel:5.788 },
  { state:"New Jersey", abbr:"NJ", regular:3.968, mid:4.521, premium:4.786, diesel:5.810 },
  { state:"New Mexico", abbr:"NM", regular:3.910, mid:4.338, premium:4.647, diesel:5.401 },
  { state:"New York", abbr:"NY", regular:4.101, mid:4.607, premium:4.988, diesel:5.924 },
  { state:"North Carolina", abbr:"NC", regular:3.824, mid:4.271, premium:4.670, diesel:5.684 },
  { state:"North Dakota", abbr:"ND", regular:3.595, mid:3.937, premium:4.353, diesel:4.865 },
  { state:"Ohio", abbr:"OH", regular:3.754, mid:4.289, premium:4.804, diesel:5.368 },
  { state:"Oklahoma", abbr:"OK", regular:3.418, mid:3.835, premium:4.122, diesel:4.739 },
  { state:"Oregon", abbr:"OR", regular:4.975, mid:5.201, premium:5.474, diesel:6.294 },
  { state:"Pennsylvania", abbr:"PA", regular:4.104, mid:4.546, premium:4.923, diesel:6.034 },
  { state:"Rhode Island", abbr:"RI", regular:3.956, mid:4.626, premium:5.052, diesel:5.768 },
  { state:"South Carolina", abbr:"SC", regular:3.752, mid:4.198, premium:4.598, diesel:5.563 },
  { state:"South Dakota", abbr:"SD", regular:3.663, mid:3.839, premium:4.314, diesel:4.826 },
  { state:"Tennessee", abbr:"TN", regular:3.823, mid:4.288, premium:4.680, diesel:5.403 },
  { state:"Texas", abbr:"TX", regular:3.726, mid:4.203, premium:4.579, diesel:5.242 },
  { state:"Utah", abbr:"UT", regular:4.189, mid:4.470, premium:4.718, diesel:5.348 },
  { state:"Vermont", abbr:"VT", regular:4.075, mid:4.569, premium:5.031, diesel:5.852 },
  { state:"Virginia", abbr:"VA", regular:3.937, mid:4.412, premium:4.791, diesel:5.713 },
  { state:"Washington", abbr:"WA", regular:5.371, mid:5.644, premium:5.880, diesel:6.921 },
  { state:"West Virginia", abbr:"WV", regular:3.905, mid:4.321, premium:4.779, diesel:5.512 },
  { state:"Wisconsin", abbr:"WI", regular:3.747, mid:4.256, premium:4.846, diesel:4.952 },
  { state:"Wyoming", abbr:"WY", regular:3.853, mid:4.165, premium:4.458, diesel:5.039 }
];
