...
const COMMODITIES = [
  ...
  { name: "U.S. Diesel", price: null, change: null, pct: null, unit: "$/gal", spark: [], loading: true },
];
...
const GAS_PRICES_BY_STATE = [
  { state: "Alabama", abbr: "AL", code: "SAL", regular: 2.88, mid: 3.22, premium: 3.45, diesel: 3.35 },
  { state: "Alaska", abbr: "AK", code: "SAK", regular: 3.78, mid: 4.08, premium: 4.32, diesel: 4.18 },
  { state: "Arizona", abbr: "AZ", code: "SAZ", regular: 3.65, mid: 3.98, premium: 4.22, diesel: 4.08 },
  { state: "Arkansas", abbr: "AR", code: "SAR", regular: 2.9, mid: 3.25, premium: 3.48, diesel: 3.38 },
  { state: "California", abbr: "CA", code: "SCA", regular: 4.92, mid: 5.28, premium: 5.52, diesel: 5.48 },
  { state: "Colorado", abbr: "CO", code: "SCO", regular: 3.18, mid: 3.52, premium: 3.75, diesel: 3.62 },
  { state: "Connecticut", abbr: "CT", code: "SCT", regular: 3.48, mid: 3.82, premium: 4.05, diesel: 4.15 },
  { state: "Delaware", abbr: "DE", code: "SDE", regular: 3.22, mid: 3.55, premium: 3.78, diesel: 3.68 },
  { state: "Florida", abbr: "FL", code: "SFL", regular: 3.38, mid: 3.72, premium: 3.95, diesel: 3.82 },
  { state: "Georgia", abbr: "GA", code: "SGA", regular: 3.12, mid: 3.48, premium: 3.72, diesel: 3.58 },
  { state: "Hawaii", abbr: "HI", code: "SHI", regular: 4.68, mid: 4.95, premium: 5.18, diesel: 5.42 },
  { state: "Idaho", abbr: "ID", code: "SID", regular: 3.42, mid: 3.75, premium: 3.98, diesel: 3.85 },
  { state: "Illinois", abbr: "IL", code: "SIL", regular: 3.72, mid: 4.05, premium: 4.28, diesel: 3.98 },
  { state: "Indiana", abbr: "IN", code: "SIN", regular: 3.28, mid: 3.62, premium: 3.85, diesel: 3.72 },
  { state: "Iowa", abbr: "IA", code: "SIA", regular: 3.05, mid: 3.38, premium: 3.62, diesel: 3.52 },
  { state: "Kansas", abbr: "KS", code: "SKS", regular: 2.98, mid: 3.32, premium: 3.55, diesel: 3.45 },
  { state: "Kentucky", abbr: "KY", code: "SKY", regular: 3.02, mid: 3.35, premium: 3.58, diesel: 3.48 },
  { state: "Louisiana", abbr: "LA", code: "SLA", regular: 2.88, mid: 3.22, premium: 3.48, diesel: 3.38 },
  { state: "Maine", abbr: "ME", code: "SME", regular: 3.35, mid: 3.68, premium: 3.92, diesel: 3.85 },
  { state: "Maryland", abbr: "MD", code: "SMD", regular: 3.35, mid: 3.68, premium: 3.92, diesel: 3.82 },
  { state: "Massachusetts", abbr: "MA", code: "SMA", regular: 3.42, mid: 3.78, premium: 4.02, diesel: 4.12 },
  { state: "Michigan", abbr: "MI", code: "SMI", regular: 3.45, mid: 3.78, premium: 4.02, diesel: 3.85 },
  { state: "Minnesota", abbr: "MN", code: "SMN", regular: 3.12, mid: 3.45, premium: 3.68, diesel: 3.55 },
  { state: "Mississippi", abbr: "MS", code: "SMS", regular: 2.82, mid: 3.18, premium: 3.42, diesel: 3.32 },
  { state: "Missouri", abbr: "MO", code: "SMO", regular: 2.95, mid: 3.28, premium: 3.52, diesel: 3.42 },
  { state: "Montana", abbr: "MT", code: "SMT", regular: 3.32, mid: 3.65, premium: 3.88, diesel: 3.78 },
  { state: "Nebraska", abbr: "NE", code: "SNE", regular: 3.08, mid: 3.42, premium: 3.65, diesel: 3.52 },
  { state: "Nevada", abbr: "NV", code: "SNV", regular: 4.08, mid: 4.32, premium: 4.55, diesel: 4.42 },
  { state: "New Hampshire", abbr: "NH", code: "SNH", regular: 3.28, mid: 3.62, premium: 3.85, diesel: 3.78 },
  { state: "New Jersey", abbr: "NJ", code: "SNJ", regular: 3.32, mid: 3.65, premium: 3.88, diesel: 3.78 },
  { state: "New Mexico", abbr: "NM", code: "SNM", regular: 3.22, mid: 3.55, premium: 3.78, diesel: 3.68 },
  { state: "New York", abbr: "NY", code: "SNY", regular: 3.58, mid: 3.92, premium: 4.15, diesel: 4.12 },
  { state: "North Carolina", abbr: "NC", code: "SNC", regular: 3.15, mid: 3.52, premium: 3.75, diesel: 3.62 },
  { state: "North Dakota", abbr: "ND", code: "SND", regular: 3.12, mid: 3.45, premium: 3.68, diesel: 3.55 },
  { state: "Ohio", abbr: "OH", code: "SOH", regular: 3.32, mid: 3.65, premium: 3.88, diesel: 3.72 },
  { state: "Oklahoma", abbr: "OK", code: "SOK", regular: 2.85, mid: 3.18, premium: 3.42, diesel: 3.35 },
  { state: "Oregon", abbr: "OR", code: "SOR", regular: 3.98, mid: 4.22, premium: 4.45, diesel: 4.32 },
  { state: "Pennsylvania", abbr: "PA", code: "SPA", regular: 3.62, mid: 3.95, premium: 4.18, diesel: 4.08 },
  { state: "Rhode Island", abbr: "RI", code: "SRI", regular: 3.35, mid: 3.68, premium: 3.92, diesel: 3.82 },
  { state: "South Carolina", abbr: "SC", code: "SSC", regular: 2.98, mid: 3.32, premium: 3.55, diesel: 3.45 },
  { state: "South Dakota", abbr: "SD", code: "SSD", regular: 3.1, mid: 3.42, premium: 3.65, diesel: 3.52 },
  { state: "Tennessee", abbr: "TN", code: "STN", regular: 2.95, mid: 3.28, premium: 3.52, diesel: 3.42 },
  { state: "Texas", abbr: "TX", code: "STX", regular: 2.92, mid: 3.28, premium: 3.52, diesel: 3.42 },
  { state: "Utah", abbr: "UT", code: "SUT", regular: 3.28, mid: 3.62, premium: 3.85, diesel: 3.72 },
  { state: "Vermont", abbr: "VT", code: "SVT", regular: 3.38, mid: 3.72, premium: 3.95, diesel: 3.88 },
  { state: "Virginia", abbr: "VA", code: "SVA", regular: 3.28, mid: 3.62, premium: 3.85, diesel: 3.72 },
  { state: "Washington", abbr: "WA", code: "SWA", regular: 4.28, mid: 4.55, premium: 4.78, diesel: 4.65 },
  { state: "West Virginia", abbr: "WV", code: "SWV", regular: 3.18, mid: 3.52, premium: 3.75, diesel: 3.65 },
  { state: "Wisconsin", abbr: "WI", code: "SWI", regular: 3.08, mid: 3.42, premium: 3.65, diesel: 3.52 },
  { state: "Wyoming", abbr: "WY", code: "SWY", regular: 3.25, mid: 3.58, premium: 3.82, diesel: 3.72 },
  { state: "Washington D.C.", abbr: "DC", code: "SDC", regular: 3.52, mid: 3.85, premium: 4.08, diesel: 3.98 },
];

const US_GAS_NATIONAL = { regular: 3.33, mid: 3.72, premium: 4.05, diesel: 3.92, source: "EIA Weekly Retail", updated: "Week of Mar 31, 2026" };
