...
const MARKET_DRIVERS = [
  { cat: "Talks Still On", icon: "git-pull-request", title: "Trump Pushes Back on Reports U.S.-Iran Talks Collapsed; Says MOU Could Come Within a Week", desc: "President Trump pushed back hard on reports that U.S.-Iran communications had broken down, posting Tuesday that \"Fake News Reports that the Islamic Republic of Iran, and the U.S.A., stopped speaking a few days ago are false and erroneous.\" He said a memorandum of understanding to reopen the Strait of Hormuz could be reached within the next week, though several issues remain unresolved, and that he is now seeking written commitments from Iran on specific nuclear-related concessions after Tehran previously gave only verbal assurances. The comments reversed the prior week\u2019s narrative that Iran had frozen the channel over Israel\u2019s Lebanon offensive." },
  { cat: "Rubio: Nuclear Progress", icon: "file-text", title: "Rubio Tells Senate Iran Has Agreed to Negotiate Aspects of Its Nuclear Program", desc: "Secretary of State Marco Rubio told the Senate Foreign Relations Committee on Tuesday that Iran has agreed to negotiate aspects of its nuclear program that it had previously refused to discuss, adding that \"there is the prospect\" Tehran could negotiate its program \u2014 though he cautioned that was not a guarantee a deal would be reached. The Associated Press reported Rubio is optimistic on eventual Iran nuclear talks despite congressional skepticism. The remarks contradicted an Iranian Fars news agency report that said Tehran and Washington had not exchanged messages for several days, the last being Iran\u2019s \"clear message\" over Lebanon." },
  { cat: "Oil Rises Third Session", icon: "trending-up", title: "Brent Climbs Toward $98 for a Third Straight Session as Risk Premium Returns", desc: "Brent crude rose toward $98 a barrel Wednesday, gaining for a third consecutive session as uncertainty surrounding U.S.-Iran peace talks kept a geopolitical risk premium in oil markets; WTI traded around $96. Iranian media reports cast doubt on the progress of negotiations even as Trump maintained that discussions remain ongoing. The gains recover part of May\u2019s steep sell-off, when Brent fell almost 19% on optimism for a lasting ceasefire. The market is now pricing the uncertainty rather than betting on a clean resolution." },
  { cat: "Sixth Straight Draw", icon: "bar-chart", title: "API Reports U.S. Crude Inventories Fell 6.75 Million Barrels; EIA Data Due Today", desc: "Industry data from the American Petroleum Institute showed U.S. crude inventories declined by about 6.75 million barrels in the week ending May 29. If confirmed by official EIA government figures due Wednesday, it would mark the sixth consecutive weekly drawdown in U.S. crude stockpiles \u2014 a reflection of the structural undersupply created by the effective closure of the Strait of Hormuz, which has choked off roughly a fifth of global oil and LNG flows since the war began February 28. Depleted inventories remain a key support under prices even as diplomacy advances." },
  { cat: "Gas Slips to $4.26", icon: "fuel", title: "AAA National Average Eases to $4.261 as Pump Prices Keep Catching Down to May\u2019s Slide", desc: "AAA\u2019s national average for regular gasoline eased to $4.261 Wednesday, down from $4.290 a day earlier and $4.322 at the start of the week, as pump prices continue catching down to May\u2019s sharp crude decline. The recent three-session rebound in crude has not yet reached the pump given the typical one-to-two-week wholesale-to-retail lag. AAA notes prices remain the highest in four years; Hawaii ($5.64) and California (above $5.99) top the table while several Gulf and Plains states sit well below the national average. Whether the decline continues hinges on the direction of crude from here." },
  { cat: "Strikes Continue", icon: "shield", title: "CENTCOM Repels Iranian Missiles and Drones; Netanyahu Says Israel, U.S. Ready to Strike Again", desc: "U.S. Central Command said Tuesday it had defeated multiple Iranian ballistic missiles and drones and launched defensive strikes following \"attempted attacks,\" signaling that the military track remains active even as diplomacy advances. Prime Minister Netanyahu told CNBC that Israel and the United States are prepared to attack Iran again if necessary, and President Trump warned there would be \"a full scale return to military\" action if needed. Israel kept up strikes on southern Lebanon Tuesday, a day after Trump asked Netanyahu not to attack Beirut to avoid further escalation." },
];

const FEATURED_ARTICLES = [
  { id: 101, title: "Trump Pushes Back on Reports U.S.-Iran Talks Collapsed; Says Hormuz MOU Could Come Within a Week", excerpt: "President Trump pushed back on reports that U.S.-Iran communications had broken down, posting that \"Fake News Reports that the Islamic Republic of Iran, and the U.S.A., stopped speaking a few days ago are false and erroneous.\" He said a memorandum of understanding to reopen the Strait of Hormuz could be reached within the next week and that he is seeking written commitments from Iran on nuclear concessions. Rubio told the Senate Iran has agreed to negotiate aspects of its nuclear program it previously refused to discuss.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "June 3, 2026", readTime: "6 min", featured: true },
  { id: 102, title: "Brent Climbs Toward $98 for a Third Straight Session as Risk Premium Returns", excerpt: "Brent crude rose toward $98 a barrel Wednesday, gaining for a third consecutive session as uncertainty surrounding U.S.-Iran peace talks kept a geopolitical risk premium in oil markets; WTI traded around $96. Iranian media cast doubt on the negotiations even as Trump maintained that talks remain ongoing. The gains recover part of May\u2019s steep sell-off, when Brent fell almost 19% on ceasefire optimism.", cat: "Oil Markets", slug: "oil-prices", author: "EnergyPricesToday Editorial", date: "June 3, 2026", readTime: "5 min" },
  { id: 103, title: "AAA National Average Eases to $4.261 as Crude Draws Extend to a Sixth Straight Week", excerpt: "AAA\u2019s national average for regular gasoline eased to $4.261 Wednesday, down from $4.322 at the start of the week, as pump prices keep catching down to May\u2019s crude slide. API data showed U.S. crude inventories fell about 6.75 million barrels last week; if confirmed by the EIA, it would be the sixth consecutive weekly drawdown. The recent rebound in crude has not yet reached the pump given the one-to-two-week lag.", cat: "Gas Prices", slug: "gas-prices", author: "EnergyPricesToday Editorial", date: "June 3, 2026", readTime: "5 min" },
  { id: 104, title: "Rubio Tells Senate Iran Has Agreed to Negotiate Aspects of Its Nuclear Program", excerpt: "Secretary of State Marco Rubio told the Senate Foreign Relations Committee that Iran has agreed to negotiate aspects of its nuclear program it previously refused to discuss, adding \"there is the prospect\" Tehran could negotiate \u2014 though not a guarantee of a deal. The remarks contradicted an Iranian Fars report that Tehran and Washington had not exchanged messages for several days.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "June 3, 2026", readTime: "5 min" },
  { id: 105, title: "CENTCOM Repels Iranian Missiles and Drones; Netanyahu Says Israel, U.S. Ready to Strike Again", excerpt: "U.S. Central Command said it defeated multiple Iranian ballistic missiles and drones and launched defensive strikes following \"attempted attacks.\" Netanyahu told CNBC that Israel and the U.S. are prepared to attack Iran again if necessary, and Trump warned of \"a full scale return to military\" action if needed. Israel kept up strikes on southern Lebanon.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "June 3, 2026", readTime: "5 min" },
  { id: 106, title: "Iran Halts Communication With U.S. Over Israel\u2019s Lebanon Offensive; Threatens to Close Hormuz", excerpt: "Iran announced earlier this week it was halting communication with the U.S. unless Israel stops its Lebanon offensive, threatening to close the Strait of Hormuz. Washington has since pushed back, with Trump calling reports of a breakdown \"false and erroneous\" and Rubio reporting progress on nuclear talks \u2014 but the episode underscored how Lebanon has become entangled with the Hormuz negotiations.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "June 1, 2026", readTime: "6 min" },
];

const COMPANY_NEWS = [
  { id: 201, title: "Trump Pushes Back on Reports U.S.-Iran Talks Collapsed; Says Hormuz MOU Could Come Within a Week", date: "June 3, 2026" },
  { id: 202, title: "Brent Climbs Toward $98 for a Third Straight Session as Risk Premium Returns", date: "June 3, 2026" },
  { id: 203, title: "AAA National Average Eases to $4.261 as Crude Draws Extend to a Sixth Straight Week", date: "June 3, 2026" },
  { id: 204, title: "Rubio Tells Senate Iran Has Agreed to Negotiate Aspects of Its Nuclear Program", date: "June 3, 2026" },
  { id: 205, title: "CENTCOM Repels Iranian Missiles and Drones; Netanyahu Says Israel, U.S. Ready to Strike Again", date: "June 3, 2026" },
  { id: 206, title: "Iran Halts Communication With U.S. Over Israel\u2019s Lebanon Offensive; Threatens to Close Hormuz", date: "June 1, 2026" },
];

const GEO_ITEMS = [
  { id: 301, region: "United States", title: "Trump Disputes Talks-Collapse Reports; Says Hormuz MOU Possible Within a Week", desc: "President Trump pushed back Tuesday on reports that U.S.-Iran communications had broken down: \"Fake News Reports that the Islamic Republic of Iran, and the U.S.A., stopped speaking a few days ago are false and erroneous.\" He said a memorandum of understanding to reopen the Strait of Hormuz could be reached within the next week, with several issues still to resolve, and that he is seeking written commitments from Iran on nuclear concessions after earlier verbal assurances." },
  { id: 302, region: "Iran", title: "Mixed Signals: Tehran Media Cast Doubt Even as Rubio Reports Nuclear-Talks Progress", desc: "Secretary of State Rubio told the Senate that Iran has agreed to negotiate aspects of its nuclear program it previously refused to discuss, with \"the prospect\" of further movement. Iran\u2019s Fars news agency countered that Tehran and Washington had not exchanged messages for several days, the last being Iran\u2019s \"clear message\" over Lebanon. Iran is still seeking a halt to Israel\u2019s incursion against Hezbollah, keeping the Lebanon and Hormuz tracks entangled." },
  { id: 303, region: "Strait of Hormuz", title: "MOU to Reopen the Strait Could Come Within a Week, Trump Says \u2014 Issues Remain", desc: "Trump said an MOU to reopen the Strait of Hormuz could be reached within the next week, though several issues still need to be resolved and he will not allow Iran to control the waterway as part of a deal. The strait has been largely shut since the war began February 28, choking off about a fifth of global oil and LNG flows and driving prices up 50% or more. Analysts caution any reopening would likely be only partial given Gulf infrastructure damage." },
  { id: 304, region: "Global Markets", title: "Oil Rises a Third Straight Session as Talks Uncertainty Sustains Risk Premium", desc: "Brent rose toward $98 Wednesday, a third straight gain, while WTI traded around $96, as conflicting signals over the U.S.-Iran talks kept a geopolitical risk premium in the market. Industry data showed U.S. crude inventories fell about 6.75 million barrels last week; official EIA figures due Wednesday would mark a sixth consecutive draw. The gains recover part of May\u2019s near-19% slide, the worst month since the pandemic." },
  { id: 305, region: "Lebanon", title: "Israel Keeps Up Southern Lebanon Strikes; CENTCOM Repels Iranian Missiles and Drones", desc: "Israel continued strikes on southern Lebanon Tuesday, pressing its campaign against Hezbollah a day after Trump asked Netanyahu not to attack Beirut to avert further escalation. U.S. Central Command said it defeated multiple Iranian ballistic missiles and drones and launched defensive strikes after \"attempted attacks.\" Netanyahu told CNBC that Israel and the U.S. are prepared to strike Iran again if necessary; Trump warned of \"a full scale return to military\" action." },
  { id: 306, region: "U.S. Consumers", title: "AAA National Average Eases to $4.261 as Pumps Keep Catching Down to May\u2019s Slide", desc: "AAA\u2019s national average eased to $4.261 Wednesday, down from $4.322 at the start of the week, as pump prices keep catching down to May\u2019s crude decline. The recent three-session rebound in crude has not yet reached the pump given the one-to-two-week lag. Prices remain the highest in four years and up roughly 50% since the war began; Hawaii and California top the table while Gulf and Plains states sit well below the national average." },
];
...
const RIG_COUNT_DATA = {
  ...
  us_total: 562, us_total_change: 4, us_oil: 429, us_oil_change: 4, us_gas: 125, us_gas_change: 0, us_misc: 8, us_misc_change: 0,
