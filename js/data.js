...
const MARKET_DRIVERS = [
  { cat: "Baker Hughes Surge", icon: "bar-chart", title: "U.S. Oil Rig Count Jumps 10 to 425 — Biggest Weekly Gain Since 2022", desc: "Baker Hughes reported Friday that the U.S. oil rig count rose by 10 in the week ended May 22, 2026 to 425 — the largest single-week increase in oil-directed drilling since 2022. Total U.S. rig count climbed alongside as operators respond to the sustained elevated price environment from Persian Gulf supply disruption. West Texas (Permian) and South Texas (Eagle Ford) led the acceleration; natural gas rig activity declined in other basins. Rising rigs today translate to higher production volumes six to twelve months out — a forward-looking signal that U.S. shale is reawakening, though not yet at pre-conflict levels." },
  { cat: "Trump Renewed Threat", icon: "alert-triangle", title: "Trump Threatens Renewed Iran Strikes if Talks Fail; Bloomberg Warns of 'Wild Swings'", desc: "President Trump threatened renewed military strikes if U.S.-Iran talks fail to produce a deal, Bloomberg reported Friday. Tehran said the latest U.S. proposal narrows differences, but disputes over Iran's uranium stockpile and potential Hormuz tolls quickly reignited tensions. Markets swung wildly Thursday-Friday as traders tried to price peace vs. escalation. WTI traded between $94.75 and $99.41; Brent ~$104. Secretary of State Rubio described \"slight progress\" in mediated talks; Tehran is currently reviewing the latest U.S. proposal delivered through Pakistan with no timeline for official response." },
  { cat: "Iran-Oman Toll Framework", icon: "anchor", title: "Iran Reportedly Working with Oman on Permanent Hormuz Toll Framework", desc: "Iran is reportedly working with Oman on a framework for a permanent toll system that would formalize Tehran's control over maritime traffic through the Strait of Hormuz, according to Trading Economics reporting Friday. The Oman framework builds on Bloomberg's prior reporting that Iran is considering institutionalizing transit fees. Trump has explicitly rejected any tolling regime: \"We want it open. We want it free. We don't want them charging tolls.\" Iran has at points charged over $1 million per ship to transit the waterway. Supreme Leader Mojtaba Khamenei directive: uranium stockpile must stay in Iran." },
  { cat: "Rapidan $130 Warning", icon: "trending-up", title: "Rapidan Energy: Brent Could Surge Toward $130 if Hormuz Stays Disrupted Through August", desc: "Rapidan Energy Group warned Friday that if the Strait of Hormuz remains disrupted through August, the fallout could rival the 2008 Great Recession, with Brent crude potentially surging toward $130 a barrel and triggering a sharp hit to global demand. The warning aligns with Saudi Aramco CEO Nasser's prior assessment that market normalization is pushed to 2027 if Hormuz reopening is delayed past mid-June, and with IEA chief Birol's \"red zone\" warning for the summer. EIA reported Wednesday U.S. crude oil inventories fell 7.9 million barrels — the fourth consecutive weekly decline." },
  { cat: "Memorial Day Travel", icon: "fuel", title: "45 Million Americans Travel Memorial Day Weekend — Record High Despite $4.55 Pump Prices", desc: "AAA reports a record 45 million Americans expected to travel at least 50 miles over Memorial Day weekend — up from 44.8 million in 2025 — with 87% driving. National average gasoline sits at $4.552 today, slightly off Thursday's $4.564 peak but still the highest Memorial Day weekend level in four years. GasBuddy's summer model points to a $4.80 nationwide average; if the Hormuz closure drags into summer, the all-time record $5.02 (June 2022) is back in range. Brown University Climate Solutions Lab: cumulative gasoline burden on U.S. households since the Iran war began ~$24 billion, or ~$200 per household." },
  { cat: "Aramco 2027 Warning", icon: "users", title: "Saudi Aramco CEO Nasser: Hormuz Reopening Past Mid-June Pushes Market Normalization to 2027", desc: "Saudi Aramco CEO Amin Nasser told investors on the company's first-quarter earnings call: \"If the Strait of Hormuz opens today, it will still take months for the market to rebalance, and if its opening is delayed by a few more weeks, then normalization will last into 2027.\" Saudi production remains at the lowest level since 1990. Iraq, Saudi Arabia, Kuwait, the UAE, Qatar, and Bahrain collectively shut in 10.5 million bpd in April; shut-ins expected to peak near 10.8 million bpd in May. A Dallas Fed Energy survey found nearly 80% of oil and gas executives believe Hormuz will not fully reopen until August or later." },
];

const FEATURED_ARTICLES = [
  { id: 101, title: "U.S. Oil Rig Count Jumps 10 to 425 — Biggest Weekly Gain Since 2022", excerpt: "Baker Hughes reported Friday the U.S. oil rig count rose by 10 to 425 in the week ended May 22, 2026 — the largest single-week increase in oil-directed drilling since 2022. The acceleration is driven by sustained elevated crude prices from Persian Gulf supply disruption. West Texas (Permian) and South Texas (Eagle Ford) led the gains. Rising rigs today translate to higher production volumes six to twelve months out — a forward-looking signal that U.S. shale is reawakening, though not yet at pre-conflict levels.", cat: "Oil Markets", slug: "oil-prices", author: "EnergyPricesToday Editorial", date: "May 22, 2026", readTime: "5 min", featured: true },
  { id: 102, title: "Trump Threatens Renewed Iran Strikes if Talks Fail; Markets Swing on Mixed Signals", excerpt: "President Trump threatened renewed military strikes if U.S.-Iran talks fail to produce a deal, Bloomberg reported Friday. Tehran said the latest U.S. proposal narrows differences, but disputes over Iran's uranium stockpile and potential Hormuz tolls quickly reignited tensions. Markets swung wildly as traders priced peace vs. escalation. WTI traded between $94.75 and $99.41; Brent ~$104. Rubio described \"slight progress\" in mediated talks; Tehran is reviewing the latest U.S. proposal delivered through Pakistan.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 22, 2026", readTime: "5 min" },
  { id: 103, title: "Memorial Day Travel Hits Record 45 Million Despite Four-Year-High Pump Prices; Brown Study Tallies $24B Burden", excerpt: "AAA reports a record 45 million Americans expected to travel at least 50 miles over Memorial Day weekend — up from 44.8 million in 2025 — with 87% driving. National average gasoline sits at $4.552 today. GasBuddy's summer model points to a $4.80 nationwide average; if Hormuz closure drags into summer, the all-time record $5.02 (June 2022) is back in range. Brown University Climate Solutions Lab: cumulative gasoline burden on U.S. households since the Iran war began ~$24 billion, or ~$200 per household.", cat: "Gas Prices", slug: "gas-prices", author: "EnergyPricesToday Editorial", date: "May 22, 2026", readTime: "5 min" },
  { id: 104, title: "Trump vs Khamenei: 'We Will Get It' Clashes with Supreme Leader Order Uranium Must Stay in Iran", excerpt: "President Trump told reporters at the White House Thursday the U.S. will eventually recover Iran's stockpile of highly enriched uranium: \"We will get it... we'll probably destroy it after we get it, but we're not going to let them have it.\" Hours earlier, Supreme Leader Mojtaba Khamenei issued a directive that the uranium must not be sent abroad. The directive contradicts the transfer-to-Russia element of Iran's revised proposal.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 21, 2026", readTime: "6 min" },
  { id: 105, title: "Iran Considering Permanent Hormuz Toll System; Trump Rejects, France Dismisses NATO Role", excerpt: "Bloomberg reported Iran is considering setting up a permanent toll system on Hormuz transit, converting ad-hoc fees imposed during the conflict (over $1 million per ship at points) into a structural revenue mechanism. Trump rejected the proposal. Iran is reportedly working with Oman on a formalizing framework. France dismissed any NATO role: \"The North Atlantic Treaty applies to the North Atlantic.\"", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 21, 2026", readTime: "5 min" },
  { id: 106, title: "Memorial Day Gas Prices Hit Four-Year High $4.564; IEA Chief Birol Warns of Summer 'Red Zone'", excerpt: "AAA reported Thursday the national average for regular gas reached $4.564 — a new 2026 high and the highest Memorial Day weekend level in four years. IEA Executive Director Fatih Birol warned the global oil market will reach a \"red zone\" this summer if Hormuz doesn't reopen: \"Global oil stockpiles will deplete as demand picks up during summer travel.\"", cat: "Oil Markets", slug: "oil-prices", author: "EnergyPricesToday Editorial", date: "May 21, 2026", readTime: "5 min" },
];

const COMPANY_NEWS = [
  { id: 201, title: "U.S. Oil Rig Count Jumps 10 to 425 — Biggest Weekly Gain Since 2022", date: "May 22, 2026" },
  { id: 202, title: "Trump Threatens Renewed Iran Strikes if Talks Fail; Markets Swing on Mixed Signals", date: "May 22, 2026" },
  { id: 203, title: "Memorial Day Travel Hits Record 45 Million Despite Four-Year-High Pump Prices", date: "May 22, 2026" },
  { id: 204, title: "Trump vs Khamenei: 'We Will Get It' Clashes with Supreme Leader Order Uranium Must Stay in Iran", date: "May 21, 2026" },
  { id: 205, title: "Iran Considering Permanent Hormuz Toll System; Trump Rejects, France Dismisses NATO Role", date: "May 21, 2026" },
  { id: 206, title: "Trump Calls Off Planned Iran Strike After Saudi, Qatar, UAE Asked Him to 'Hold Off'", date: "May 20, 2026" },
];

const GEO_ITEMS = [
  { id: 301, region: "United States", title: "U.S. Oil Rig Count Jumps 10 to 425 — Biggest Weekly Gain Since 2022", desc: "Baker Hughes reported Friday the U.S. oil rig count rose by 10 to 425 in the week ended May 22 — the largest single-week gain since 2022. West Texas (Permian) and South Texas (Eagle Ford) led the acceleration as operators respond to sustained elevated crude prices from the Persian Gulf supply disruption. Rising rigs today translate to higher production volumes six to twelve months out — a forward-looking signal U.S. shale is reawakening." },
  { id: 302, region: "Iran", title: "Trump Threatens Renewed Strikes if Talks Fail; Khamenei Directive Holds on Uranium", desc: "President Trump threatened renewed military strikes on Iran if talks fail, Bloomberg reported Friday. Supreme Leader Mojtaba Khamenei's directive that Iran's uranium stockpile must stay in country remains in effect, contradicting the transfer-to-Russia element of Iran's revised proposal. Iran reportedly working with Oman on framework for a permanent Hormuz toll system. Rubio: \"slight progress\" in mediated talks; Tehran is reviewing the latest U.S. proposal." },
  { id: 303, region: "Strait of Hormuz", title: "Iran Working with Oman on Permanent Hormuz Toll Framework; Trump Continues to Reject", desc: "Iran is reportedly working with Oman on a framework for a permanent toll system on Hormuz transit, Trading Economics reported Friday. The framework formalizes earlier Bloomberg reporting that Iran is institutionalizing transit fees. Trump rejected: \"We want it open. We want it free.\" Iran has charged over $1M/ship at points. Strait remains at ~5% of pre-conflict baseline traffic per Kpler. A Dallas Fed Energy survey: nearly 80% of executives believe Hormuz reopening is August or later." },
  { id: 304, region: "Global Markets", title: "Rapidan Energy: Brent Could Surge Toward $130 if Hormuz Stays Disrupted Through August", desc: "Rapidan Energy Group warned Friday that if Hormuz remains disrupted through August, the fallout could rival the 2008 Great Recession, with Brent potentially surging toward $130 per barrel. The warning aligns with Aramco CEO Nasser's 2027-normalization warning if reopening delayed past mid-June, and IEA chief Birol's summer \"red zone\" warning. EIA Wednesday: U.S. crude inventories fell 7.9 million barrels — fourth consecutive weekly decline. SPR drew 9.9M barrels in a single week, a record." },
  { id: 305, region: "U.S. Consumers", title: "Brown Study: $24 Billion Cumulative Gasoline Burden Since the Iran War Began", desc: "Brown University's Climate Solutions Lab calculates the cumulative gasoline burden on U.S. households since the Iran war began at roughly $24 billion, or nearly $200 per household on average. AAA national average sits at $4.552 today. GasBuddy's summer model points to a $4.80 nationwide average; the all-time record $5.02 (June 2022) is back in range if Hormuz closure drags through summer. A record 45 million Americans expected to travel Memorial Day weekend." },
  { id: 306, region: "Saudi Arabia", title: "Aramco CEO Nasser: Hormuz Reopening Past Mid-June Pushes Market Normalization to 2027", desc: "Saudi Aramco CEO Amin Nasser told investors on the Q1 earnings call: \"If the Strait of Hormuz opens today, it will still take months for the market to rebalance, and if its opening is delayed by a few more weeks, then normalization will last into 2027.\" Saudi production remains at the lowest level since 1990. Iraq, Saudi Arabia, Kuwait, the UAE, Qatar, and Bahrain collectively shut in 10.5 million bpd in April." },
];
