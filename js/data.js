...
const BREAKING_NEWS = [
  { title: "Ceasefire Largely Holding Day 2 — No New Gulf State Attacks Reported April 9", cat: "Geopolitics", slug: "geopolitics", time: "Just now" },
  { title: "Strait of Hormuz Still Not Meaningfully Reopened Despite Ceasefire Terms", cat: "Geopolitics", slug: "geopolitics", time: "2h ago" },
  { title: "Vance-Led U.S. Delegation Heading to Pakistan for Saturday Talks with Iran", cat: "Geopolitics", slug: "geopolitics", time: "4h ago" },
  { title: "WTI Crude Settles at $94.41 — Biggest Single-Day Drop Since April 2020", cat: "Oil Prices", slug: "oil-prices", time: "8h ago" },
  { title: "Netanyahu Seeks Direct Lebanon Negotiations as Israel Continues Hezbollah Strikes", cat: "Geopolitics", slug: "geopolitics", time: "10h ago" },
  { title: "Satellite Imagery Shows Smoke Rising from Saudi Aramco Abqaiq Facility", cat: "Geopolitics", slug: "geopolitics", time: "12h ago" },
  { title: "Iran Warns of Strong Responses if Israeli Lebanon Strikes Continue", cat: "Geopolitics", slug: "geopolitics", time: "14h ago" },
  { title: "U.S. Gas Prices Expected to Ease if Ceasefire Holds — National Average $4.16", cat: "Gas Prices", slug: "gas-prices", time: "16h ago" },
];

const MARKET_DRIVERS = [
  { cat: "CEASEFIRE DAY 2", icon: "shield", title: "Fragile Truce Holds", desc: "No new Gulf attacks reported April 9 as ceasefire enters second day. Hormuz still effectively closed to most traffic despite deal terms." },
  { cat: "ISLAMABAD TALKS", icon: "globe", title: "Vance Leads U.S. Delegation", desc: "VP JD Vance heading to Pakistan for Saturday negotiations. Trump calls Iran leaders 'much more reasonable' in private talks." },
  { cat: "STRAIT OF HORMUZ", icon: "anchor", title: "Strait Still Blocked", desc: "Little sign of meaningful reopening — Iran paused Hormuz traffic citing Israeli Lebanon strikes as ceasefire violations." },
  { cat: "LEBANON", icon: "alert-triangle", title: "Israel Escalates in Beirut", desc: "Largest Israeli strike wave since war began — 303 killed, 1,150 wounded. Netanyahu says Lebanon excluded from ceasefire." },
  { cat: "OIL CRASH", icon: "trending-down", title: "Crude Posts Historic Drop", desc: "WTI settled $94.41 (-16.4%), Brent $94.75 (-13.3%). Biggest single-day plunge since pandemic crash of April 2020." },
  { cat: "SAUDI ARAMCO", icon: "flame", title: "Abqaiq Facility Hit", desc: "Satellite imagery confirms smoke at world\'s largest crude processing plant — handles 5% of global oil supply." },
];
...
const GAS_PRICES_BY_STATE = [
  { state: "Alabama", region: "South", abbr: "AL", regular: 3.883, mid: 4.324, premium: 4.743, diesel: 5.468 },
  { state: "Alaska", region: "West Coast", abbr: "AK", regular: 4.637, mid: 4.885, premium: 5.104, diesel: 5.862 },
  { state: "Arizona", region: "Mountain", abbr: "AZ", regular: 4.753, mid: 5.130, premium: 5.453, diesel: 6.207 },
  { state: "Arkansas", region: "South", abbr: "AR", regular: 3.656, mid: 4.094, premium: 4.443, diesel: 5.176 },
  { state: "California", region: "West Coast", abbr: "CA", regular: 5.934, mid: 6.175, premium: 6.358, diesel: 7.746 },
  { state: "Colorado", region: "Mountain", abbr: "CO", regular: 3.824, mid: 4.219, premium: 4.549, diesel: 5.144 },
  { state: "Connecticut", region: "Northeast", abbr: "CT", regular: 4.108, mid: 4.623, premium: 5.016, diesel: 5.943 },
  { state: "Delaware", region: "Northeast", abbr: "DE", regular: 4.047, mid: 4.600, premium: 4.908, diesel: 5.918 },
  { state: "Florida", region: "South", abbr: "FL", regular: 4.158, mid: 4.609, premium: 4.940, diesel: 5.784 },
  { state: "Georgia", region: "South", abbr: "GA", regular: 3.745, mid: 4.216, premium: 4.628, diesel: 5.323 },
  { state: "Hawaii", region: "West Coast", abbr: "HI", regular: 5.621, mid: 5.867, premium: 6.118, diesel: 7.037 },
  { state: "Idaho", region: "Mountain", abbr: "ID", regular: 4.322, mid: 4.605, premium: 4.870, diesel: 5.508 },
  { state: "Illinois", region: "Midwest", abbr: "IL", regular: 4.410, mid: 4.972, premium: 5.454, diesel: 5.332 },
  { state: "Indiana", region: "Midwest", abbr: "IN", regular: 4.137, mid: 4.642, premium: 5.135, diesel: 5.426 },
  { state: "Iowa", region: "Midwest", abbr: "IA", regular: 3.642, mid: 3.739, premium: 4.432, diesel: 5.097 },
  { state: "Kansas", region: "Midwest", abbr: "KS", regular: 3.442, mid: 3.760, premium: 4.090, diesel: 4.745 },
  { state: "Kentucky", region: "South", abbr: "KY", regular: 4.055, mid: 4.599, premium: 5.021, diesel: 5.341 },
  { state: "Louisiana", region: "South", abbr: "LA", regular: 3.802, mid: 4.234, premium: 4.622, diesel: 5.333 },
  { state: "Maine", region: "Northeast", abbr: "ME", regular: 4.083, mid: 4.619, premium: 5.102, diesel: 5.917 },
  { state: "Maryland", region: "Northeast", abbr: "MD", regular: 4.197, mid: 4.757, premium: 5.080, diesel: 5.962 },
  { state: "Massachusetts", region: "Northeast", abbr: "MA", regular: 3.978, mid: 4.545, premium: 4.932, diesel: 5.886 },
  { state: "Michigan", region: "Midwest", abbr: "MI", regular: 4.076, mid: 4.629, premium: 5.184, diesel: 5.273 },
  { state: "Minnesota", region: "Midwest", abbr: "MN", regular: 3.686, mid: 4.098, premium: 4.612, diesel: 5.106 },
  { state: "Mississippi", region: "South", abbr: "MS", regular: 3.774, mid: 4.213, premium: 4.603, diesel: 5.306 },
  { state: "Missouri", region: "Midwest", abbr: "MO", regular: 3.618, mid: 4.039, premium: 4.337, diesel: 4.875 },
  { state: "Montana", region: "Mountain", abbr: "MT", regular: 3.885, mid: 4.193, premium: 4.533, diesel: 4.995 },
  { state: "Nebraska", region: "Midwest", abbr: "NE", regular: 3.602, mid: 3.743, premium: 4.223, diesel: 4.921 },
  { state: "Nevada", region: "Mountain", abbr: "NV", regular: 5.015, mid: 5.323, premium: 5.619, diesel: 6.408 },
  { state: "New Hampshire", region: "Northeast", abbr: "NH", regular: 4.004, mid: 4.532, premium: 4.984, diesel: 5.843 },
  { state: "New Jersey", region: "Northeast", abbr: "NJ", regular: 4.091, mid: 4.615, premium: 4.883, diesel: 5.909 },
  { state: "New Mexico", region: "Mountain", abbr: "NM", regular: 4.047, mid: 4.481, premium: 4.790, diesel: 5.524 },
  { state: "New York", region: "Northeast", abbr: "NY", regular: 4.131, mid: 4.615, premium: 4.995, diesel: 5.957 },
  { state: "North Carolina", region: "South", abbr: "NC", regular: 3.936, mid: 4.378, premium: 4.774, diesel: 5.801 },
  { state: "North Dakota", region: "Midwest", abbr: "ND", regular: 3.560, mid: 3.948, premium: 4.346, diesel: 4.839 },
  { state: "Ohio", region: "Midwest", abbr: "OH", regular: 3.934, mid: 4.451, premium: 4.965, diesel: 5.381 },
  { state: "Oklahoma", region: "South", abbr: "OK", regular: 3.431, mid: 3.838, premium: 4.134, diesel: 4.718 },
  { state: "Oregon", region: "West Coast", abbr: "OR", regular: 5.013, mid: 5.244, premium: 5.521, diesel: 6.307 },
  { state: "Pennsylvania", region: "Northeast", abbr: "PA", regular: 4.196, mid: 4.625, premium: 5.004, diesel: 6.112 },
  { state: "Rhode Island", region: "Northeast", abbr: "RI", regular: 4.020, mid: 4.688, premium: 5.095, diesel: 5.851 },
  { state: "South Carolina", region: "South", abbr: "SC", regular: 3.860, mid: 4.305, premium: 4.699, diesel: 5.635 },
  { state: "South Dakota", region: "Midwest", abbr: "SD", regular: 3.663, mid: 3.800, premium: 4.306, diesel: 4.830 },
  { state: "Tennessee", region: "South", abbr: "TN", regular: 3.920, mid: 4.391, premium: 4.781, diesel: 5.484 },
  { state: "Texas", region: "South", abbr: "TX", regular: 3.868, mid: 4.344, premium: 4.718, diesel: 5.343 },
  { state: "Utah", region: "Mountain", abbr: "UT", regular: 4.263, mid: 4.540, premium: 4.792, diesel: 5.416 },
  { state: "Vermont", region: "Northeast", abbr: "VT", regular: 4.122, mid: 4.589, premium: 5.043, diesel: 5.924 },
  { state: "Virginia", region: "South", abbr: "VA", regular: 4.076, mid: 4.535, premium: 4.909, diesel: 5.811 },
  { state: "Washington", region: "West Coast", abbr: "WA", regular: 5.395, mid: 5.660, premium: 5.906, diesel: 6.890 },
  { state: "West Virginia", region: "South", abbr: "WV", regular: 3.986, mid: 4.422, premium: 4.853, diesel: 5.567 },
  { state: "Wisconsin", region: "Midwest", abbr: "WI", regular: 3.829, mid: 4.315, premium: 4.915, diesel: 4.992 },
  { state: "Wyoming", region: "Mountain", abbr: "WY", regular: 3.864, mid: 4.172, premium: 4.477, diesel: 5.041 },
  { state: "Washington D.C.", region: "Northeast", abbr: "DC", regular: 4.296, mid: 4.860, premium: 5.245, diesel: 5.858 },
];

const US_GAS_NATIONAL = { regular: 4.164, mid: 4.608, premium: 4.978, diesel: 5.612, source: "AAA Daily Fuel Gauge Report", updated: "As of April 8, 2026" };
