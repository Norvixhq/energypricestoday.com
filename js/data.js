...
const MARKET_DRIVERS = [
  { cat: "Trump-Xi Summit", icon: "users", title: "Beijing Agreement: Hormuz Must Remain Open, Iran Cannot Have Nuclear Weapon", desc: "President Trump and President Xi held a two-day summit in Beijing concluding Thursday May 14. The White House readout said both leaders agreed the Strait of Hormuz must remain open to support the free flow of energy, that Xi opposed militarization of the strait and any effort to charge a toll, and that Iran cannot have a nuclear weapon. Trump told Fox News that Xi offered to help broker peace: \"He said, 'I would love to be a help, if I can be of any help whatsoever.'\" Xi also expressed interest in purchasing more American oil." },
  { cat: "Iran Standoff", icon: "alert-triangle", title: "Trump Warns Iran of 'Annihilation' If No Deal", desc: "Speaking after the summit, President Trump warned Iran to reach a deal or face \"annihilation,\" saying his patience with Tehran was running out. Trump said following the summit, \"We may have to do a little cleanup work because we had a month-long ceasefire.\" The administration has reportedly proposed a 20-year verified moratorium on Iran's nuclear program, surrender of all highly enriched uranium, and free commercial traffic through the Strait of Hormuz as conditions to end hostilities. Pakistan has been acting as an intermediary." },
  { cat: "Hormuz Status", icon: "anchor", title: "Iran Allowing Some Chinese Vessel Transit; Strait Otherwise Effectively Closed", desc: "Reports indicate around 30 vessels have crossed the Strait of Hormuz in recent days, with Iran reportedly allowing transit for some Chinese ships. The strait otherwise remains under a dual blockade that has been the central obstacle in peace talks. Treasury Secretary Scott Bessent told CNBC China would use its influence on Iran to help reopen Hormuz: \"It's very much in their interest to get the strait reopened. China has a much bigger interest in reopening the strait than the U.S. does.\"" },
  ...
  { cat: "IEA Oil Market Report", icon: "trending-up", title: "Global Oil Inventories Drawing at Record 4M bpd Pace", desc: "The International Energy Agency reported crude and fuel flows through the Strait of Hormuz fell by around 4 million barrels per day in March and April, warning the global oil market could remain materially undersupplied through October even if the conflict is resolved next month. Inventories already drawing sharply mean further volatility is likely ahead of the peak summer demand season. Asian refiners including Japan are actively seeking alternatives to Persian Gulf supplies." },
  { cat: "OPEC Structural Shift", icon: "users", title: "UAE Officially Departs OPEC Effective May 1; Spare Capacity Forecasts Cut", desc: "The EIA's May Short-Term Energy Outlook (released May 12) incorporates the UAE's departure from OPEC, effective May 1, 2026. OPEC production numbers in the outlook now exclude UAE data. Because the UAE held substantial spare crude oil production capacity, EIA now expects OPEC's spare capacity to average 2.5 million bpd in 2027, compared with a previous forecast of 3.8 million bpd. EIA also reported Saudi Arabia informed OPEC its output fell to the lowest level since 1990." },
];

const FEATURED_ARTICLES = [
  { id: 101, title: "Trump-Xi Summit in Beijing: Both Sides Agree Strait of Hormuz Must Remain Open", excerpt: "President Trump and President Xi held a two-day summit in Beijing concluding Thursday May 14. The White House readout said both leaders agreed the Strait of Hormuz must remain open to support the free flow of energy, that Iran cannot have a nuclear weapon, and that Xi opposed militarization of the strait. Trump told Fox News that Xi offered to help broker peace. Xi also expressed interest in purchasing more American oil to reduce China's dependence on the strait.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 15, 2026", readTime: "6 min", featured: true },
  { id: 102, title: "Trump Warns Iran to Reach a Deal or Face 'Annihilation'", excerpt: "Speaking following his Beijing summit with Xi Jinping, President Trump warned Iran to reach a deal or face annihilation, saying his patience with Tehran was running out. The administration has reportedly proposed a 20-year verified moratorium on Iran's nuclear program, surrender of highly enriched uranium, and free commercial traffic through Hormuz. Pakistan has been acting as an intermediary. Trump after the summit: 'We may have to do a little cleanup work because we had a month-long ceasefire.'", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 15, 2026", readTime: "5 min" },
  { id: 103, title: "EIA Crude Stocks Drop 4.3M Barrels — Nearly Double Expectations", excerpt: "The Energy Information Administration's Weekly Petroleum Status Report Wednesday showed U.S. commercial crude oil inventories fell by 4.3 million barrels to 452.9 million for the week ending May 8 — nearly double consensus. Gasoline inventories fell 4.1M barrels; distillate inventories rose 0.19M, the first weekly build since March. Refinery utilization climbed to 91.7%. SPR fell 8.6M to 384.1M, the lowest level since October 2024.", cat: "Oil Markets", slug: "oil-prices", author: "EnergyPricesToday Editorial", date: "May 13, 2026", readTime: "5 min" },
  { id: 104, title: "IEA: Global Oil Inventories Drawing at Record 4M bpd Pace; Severe Undersupply Through October", excerpt: "The International Energy Agency reported crude and fuel flows through the Strait of Hormuz fell by around 4 million barrels per day in March and April, warning the global oil market could remain materially undersupplied through October even if the conflict ends sooner. Inventories drawing sharply means further volatility is likely ahead of the peak summer demand season.", cat: "Oil Markets", slug: "oil-prices", author: "EnergyPricesToday Editorial", date: "May 13, 2026", readTime: "6 min" },
  { id: 105, title: "UAE Officially Departs OPEC Effective May 1; EIA Cuts 2027 Spare Capacity Forecast", excerpt: "The EIA's May Short-Term Energy Outlook released May 12 incorporates the UAE's departure from OPEC, effective May 1, 2026. With UAE spare capacity removed, EIA now expects OPEC's 2027 spare capacity to average 2.5 million bpd compared with a previous 3.8 million bpd forecast. EIA also reported Saudi Arabia informed OPEC its output fell to the lowest level since 1990.", cat: "Oil Markets", slug: "oil-prices", author: "EnergyPricesToday Editorial", date: "May 13, 2026", readTime: "6 min" },
];

const COMPANY_NEWS = [
  { id: 201, title: "Trump-Xi Summit in Beijing: Both Sides Agree Strait of Hormuz Must Remain Open", date: "May 15, 2026" },
  { id: 202, title: "Trump Warns Iran to Reach a Deal or Face 'Annihilation'", date: "May 15, 2026" },
  { id: 203, title: "EIA Crude Stocks Drop 4.3M Barrels — Nearly Double Expectations", date: "May 13, 2026" },
  { id: 204, title: "IEA: Global Oil Inventories Drawing at Record 4M bpd Pace; Severe Undersupply Through October", date: "May 13, 2026" },
  { id: 205, title: "UAE Officially Departs OPEC Effective May 1; EIA Cuts 2027 Spare Capacity Forecast", date: "May 13, 2026" },
  { id: 206, title: "Saudi Arabia Informed OPEC Its Oil Output Fell to Lowest Level Since 1990", date: "May 14, 2026" },
];

const GEO_ITEMS = [
  { id: 301, region: "China", title: "Trump-Xi Summit in Beijing: Both Sides Agree Strait of Hormuz Must Remain Open", desc: "President Trump and President Xi held a two-day summit in Beijing concluding May 14. The White House readout said both leaders agreed Hormuz must remain open and that Iran cannot have a nuclear weapon. Trump told Fox News Xi offered to help broker peace. Xi opposed militarization of the strait and any effort to charge a toll, and expressed interest in purchasing more American oil to reduce China's dependence on the strait." },
  { id: 302, region: "Iran", title: "Trump Warns Iran to Reach a Deal or Face 'Annihilation'", desc: "Speaking after the Beijing summit, Trump warned Iran to reach a deal or face annihilation, saying his patience with Tehran was running out. The administration has reportedly proposed a 20-year verified moratorium on Iran's nuclear program, surrender of all highly enriched uranium, and free commercial traffic through Hormuz as conditions to end hostilities. Pakistan has been acting as an intermediary." },
  { id: 303, region: "Strait of Hormuz", title: "Iran Allowing Some Chinese Vessel Transit; Strait Otherwise Effectively Closed", desc: "Reports indicate around 30 vessels have crossed the strait in recent days, with Iran reportedly allowing transit for some Chinese ships. The strait otherwise remains under a dual blockade. Treasury Secretary Bessent told CNBC China has 'a much bigger interest in reopening the strait than the U.S. does' and would use its influence on Iran behind the scenes. China is Iran's biggest oil customer." },
  { id: 304, region: "United States", title: "Rubio: China Should Use Influence on Iran to Help Reopen Hormuz", desc: "Secretary of State Marco Rubio said in a pre-summit Fox News interview: 'It's in their interest to resolve this. We hope to convince them to play a more active role in getting Iran to walk away from what they're doing now and trying to do now in the Persian Gulf.' The U.S. came to Beijing wanting China to leverage its position as Iran's largest oil customer to push Tehran toward a settlement." },
  { id: 305, region: "OPEC", title: "Saudi Arabia Informed OPEC Its Oil Output Fell to Lowest Level Since 1990", desc: "Saudi Arabia informed OPEC its crude oil production has dropped to its lowest level since 1990, the EIA reported. The EIA also confirmed Iraq, Saudi Arabia, Kuwait, the UAE, Qatar, and Bahrain collectively shut in 10.5 million barrels per day of crude oil production in April. EIA expects shut-ins to peak at nearly 10.8 million bpd in May as storage limits force additional producer cutbacks." },
  { id: 306, region: "Global Markets", title: "IEA: Global Oil Inventories Drawing at Record 4M bpd Pace; Severe Undersupply Through October", desc: "The International Energy Agency reported crude and fuel flows through the Strait of Hormuz fell by around 4 million barrels per day in March and April. The IEA warned the global oil market could remain materially undersupplied through October even if the conflict ends sooner. With inventories already drawing sharply, further volatility is likely ahead of peak summer demand." },
];
