...
const COMMODITIES = [
  { name: "WTI Crude", price: 101.94, change: -3.15, pct: -3.00, unit: "$/bbl", spark: [99.93,103.40,105.80,108.20,111.05,105.09,101.94], loading: false },
  { name: "Brent Crude", price: 108.17, change: -2.21, pct: -2.00, unit: "$/bbl", spark: [111.26,112.50,113.40,114.10,114.05,110.40,108.17], loading: false },
  { name: "Natural Gas", price: 2.68, change: 0.07, pct: 2.68, unit: "$/MMBtu", spark: [2.61,2.63,2.65,2.66,2.69,2.71,2.68], loading: false },
  { name: "Gasoline RBOB", price: 3.42, change: 0.08, pct: 2.40, unit: "$/gal", spark: [3.34,3.36,3.39,3.42,3.46,3.45,3.42], loading: false },
  { name: "Heating Oil", price: 4.12, change: 0.08, pct: 1.98, unit: "$/gal", spark: [4.04,4.06,4.09,4.12,4.16,4.15,4.12], loading: false },
  { name: "Murban Crude", price: 110.50, change: -1.55, pct: -1.38, unit: "$/bbl", spark: [112.05,112.80,113.20,113.50,113.10,111.40,110.50], loading: false },
  { name: "Diesel ULSD", price: 4.12, change: 0.08, pct: 1.98, unit: "$/gal", spark: [4.04,4.06,4.09,4.12,4.16,4.15,4.12], loading: false },
  { name: "Jet Fuel", price: 4.46, change: 0.08, pct: 1.83, unit: "$/gal", spark: [4.38,4.40,4.42,4.44,4.50,4.48,4.46], loading: false },
  { name: "Coal", price: 138.5, change: 1.1, pct: 0.80, unit: "$/ton", spark: [137.4,137.6,137.8,138.0,138.2,138.4,138.5], loading: false },
  { name: "Gold", price: 4710.85, change: 28.70, pct: 0.61, unit: "$/oz", spark: [], loading: false },
];
...
const BREAKING_NEWS = [
  ...
  { title: "Oil price hits highest since 2022 after report Trump to be briefed on new Iran options", cat: "Oil Markets", slug: "oil-prices", time: "2h" },
  ...
  { title: "Current price of oil as of May 1, 2026", cat: "Oil Markets", slug: "oil-prices", time: "5h" },
  { title: "Iran Warns of $140 Oil as Trump Holds Hormuz Blockade", cat: "Oil Markets", slug: "oil-prices", time: "6h" },
  { title: "Stocks End April on a High, Even as Oil Prices Touch New Peak", cat: "Oil Markets", slug: "oil-prices", time: "7h" },
...
const MARKET_DRIVERS = [
  { cat: "Iran Diplomacy", icon: "users", title: "Iran Sends Updated Peace Proposal Through Pakistan; Trump 'Not Satisfied'", desc: "Pakistani officials confirmed Friday May 1 they delivered an updated Iranian peace proposal to the U.S. Trump told reporters: 'Iran wants to make a deal, but I'm not satisfied with it.' WTI fell 3% to $101.94, Brent down 2% to $108.17 on the proposal news, retracing from Thursday's 4-year highs. Conflict now in its tenth week." },
  { cat: "Trump Pressure", icon: "alert-triangle", title: "Trump Briefed on Expanded Iran Military Options as Crude Hit 4-Year High", desc: "Reports Thursday April 30 that CENTCOM Adm. Brad Cooper briefed Trump on expanded military options against Iran, including a planned short-and-intense wave of strikes. WTI hit a 4-year intraday high of $111, Brent reached $114 — highest since June 2022. Trump faces a 60-day War Powers deadline; admin claims April 10 ceasefire 'terminated' hostilities." },
  { cat: "Pump Prices", icon: "fuel", title: "U.S. Gas Average Surges to $4.39, Up 25 Cents in Three Days", desc: "AAA reported Friday the U.S. national average for regular gasoline reached $4.392 — highest since July 2022. Up sharply from $4.144 on Apr 28. Michigan jumped to $4.86 on a Midwest refinery issue in Indiana; California $6.45, Chicago $5.05. Pass-through from Apr 28 crude rally now flowing through to retail." },
  { cat: "Earnings", icon: "trending-up", title: "ExxonMobil Q1 Profit at 5-Year Low; Permian on Track for 1.8M boe/d", desc: "ExxonMobil reported Q1 net income of $4.2B (5-year low) but beat estimates with $1.16 adj EPS and $85.14B revenue (vs $79.78B est). Production reached 4.6M bpd; Guyana set quarterly record at 900K+ gross bpd. Free cash flow dropped to $2.7B from $8.8B yr-ago. CEO Woods: 'Events in the Middle East tested that strength.'" },
  { cat: "Earnings", icon: "trending-up", title: "Chevron Posts Biggest Beat Since 2020 on $1.41 Adj EPS, Production Up 15%", desc: "Chevron reported Q1 adj EPS of $1.41 (vs $0.95 est) — biggest earnings beat since October 2020. Reported profit $2.2B / $1.11 GAAP after a $2.9B charge from financial hedges. Production rose 15% YoY to 3.9M bpd. Less Middle East exposure cushioned the quarter relative to Exxon." },
  { cat: "Hormuz", icon: "anchor", title: "Strait Closed for 10th Week; Mojtaba Khamenei Refuses to Cede Nuclear Program", desc: "The Strait of Hormuz remains essentially closed in the conflict's tenth week. Iran's Supreme Leader Mojtaba Khamenei pledged not to relinquish the country's nuclear or missile capabilities and indicated Tehran would retain control over the strait. The IEA has called it an 'unprecedented supply shock'; final pre-blockade Persian Gulf cargoes have now reached destinations. U.S. crude exports surged to record levels." },
];

const FEATURED_ARTICLES = [
  { id: 101, title: "Iran Sends Updated Peace Proposal Through Pakistan; Trump 'Not Satisfied'", excerpt: "Pakistani officials confirmed Friday May 1 that Iranian mediators delivered an updated peace proposal to the U.S. through Islamabad. President Trump told reporters he was unsatisfied: 'Iran wants to make a deal, but I'm not satisfied with it. They have no military left.' WTI fell 3% to $101.94, Brent down 2% to $108.17 on the proposal news, retracing from Thursday's 4-year highs.", cat: "Geopolitics", slug: "geopolitics", author: "EnergyPricesToday Editorial", date: "May 1, 2026", readTime: "6 min", featured: true },
  { id: 102, title: "Trump Briefed on Expanded Iran Military Options as Crude Hit 4-Year High", excerpt: "Reports Thursday April 30 that CENTCOM Adm. Brad Cooper briefed President Trump on expanded military options against Iran, including a planned short-and-intense wave of strikes reportedly under review. WTI hit a 4-year intraday high of $111, Brent reached $114 — the highest since June 2022 — before profit-taking trimmed gains.", cat: "Oil Markets", slug: "oil-prices", author: "EnergyPricesToday Editorial", date: "Apr 30, 2026", readTime: "5 min" },
  { id: 103, title: "ExxonMobil Q1 Profit Falls to 5-Year Low at $4.2B Despite Beating Estimates", excerpt: "ExxonMobil reported first-quarter net income of $4.2 billion — its lowest in five years — but beat Wall Street estimates with adjusted EPS of $1.16 and revenue of $85.14 billion. Production hit 4.6M bpd, with Guyana setting a quarterly record above 900,000 gross bpd. Free cash flow dropped sharply to $2.7B from $8.8B a year ago.", cat: "Company News", slug: "company-news", author: "EnergyPricesToday Editorial", date: "May 1, 2026", readTime: "5 min" },
  { id: 104, title: "Chevron Posts Biggest Earnings Beat Since 2020 on Record Production", excerpt: "Chevron reported Q1 adjusted EPS of $1.41 versus a $0.95 estimate — its biggest earnings beat since October 2020. GAAP profit was $2.2 billion / $1.11 per share after a $2.9 billion charge tied to financial hedges. Production rose 15% YoY to 3.9 million bpd. Less Middle East exposure cushioned the quarter relative to Exxon's results.", cat: "Company News", slug: "company-news", author: "EnergyPricesToday Editorial", date: "May 1, 2026", readTime: "4 min" },
  { id: 105, title: "U.S. Gas Average Surges to $4.39, Up 25 Cents in Three Days", excerpt: "AAA reported Friday the U.S. national average for regular gasoline reached $4.392 — highest since July 2022. Up sharply from $4.144 just three days ago. Michigan spiked to $4.86 on a Midwest refinery issue in Indiana; California averages $6.45, Chicago $5.05. The pass-through from Tuesday's crude rally is flowing through to retail with a multi-day lag.", cat: "Gas Prices", slug: "gas-prices", author: "EnergyPricesToday Editorial", date: "May 1, 2026", readTime: "4 min" },
];
...
const GAS_PRICES_BY_STATE = [
  { state:"Alabama", abbr:"AL", regular:4.096, mid:4.58, premium:5.022, diesel:5.806 },
  { state:"Alaska", abbr:"AK", regular:4.987, mid:5.226, premium:5.478, diesel:6.391 },
  { state:"Arizona", abbr:"AZ", regular:4.981, mid:5.398, premium:5.74, diesel:6.481 },
  { state:"Arkansas", abbr:"AR", regular:3.903, mid:4.394, premium:4.797, diesel:5.543 },
  { state:"California", abbr:"CA", regular:6.308, mid:6.573, premium:6.765, diesel:8.214 },
  { state:"Colorado", abbr:"CO", regular:4.235, mid:4.671, premium:5.022, diesel:5.542 },
  { state:"Connecticut", abbr:"CT", regular:4.398, mid:4.988, premium:5.412, diesel:6.373 },
  { state:"Delaware", abbr:"DE", regular:4.249, mid:4.903, premium:5.235, diesel:6.206 },
  { state:"District of Columbia", abbr:"DC", regular:4.638, mid:5.285, premium:5.696, diesel:6.365 },
  { state:"Florida", abbr:"FL", regular:4.432, mid:4.938, premium:5.296, diesel:6.028 },
  { state:"Georgia", abbr:"GA", regular:3.93, mid:4.431, premium:4.889, diesel:5.63 },
  { state:"Hawaii", abbr:"HI", regular:6.132, mid:6.387, premium:6.648, diesel:7.717 },
  { state:"Idaho", abbr:"ID", regular:4.655, mid:4.98, premium:5.273, diesel:5.939 },
  { state:"Illinois", abbr:"IL", regular:4.67, mid:5.298, premium:5.804, diesel:5.836 },
  { state:"Indiana", abbr:"IN", regular:4.137, mid:4.731, premium:5.268, diesel:5.83 },
  { state:"Iowa", abbr:"IA", regular:3.893, mid:4.134, premium:4.798, diesel:5.436 },
  { state:"Kansas", abbr:"KS", regular:3.753, mid:4.107, premium:4.469, diesel:5.112 },
  { state:"Kentucky", abbr:"KY", regular:4.254, mid:4.86, premium:5.321, diesel:5.754 },
  { state:"Louisiana", abbr:"LA", regular:4.005, mid:4.48, premium:4.899, diesel:5.628 },
  { state:"Maine", abbr:"ME", regular:4.302, mid:4.889, premium:5.416, diesel:6.312 },
  { state:"Maryland", abbr:"MD", regular:4.385, mid:5.048, premium:5.392, diesel:6.257 },
  { state:"Massachusetts", abbr:"MA", regular:4.279, mid:4.921, premium:5.334, diesel:6.335 },
  { state:"Michigan", abbr:"MI", regular:4.179, mid:4.827, premium:5.44, diesel:5.65 },
  { state:"Minnesota", abbr:"MN", regular:3.964, mid:4.432, premium:4.964, diesel:5.469 },
  { state:"Mississippi", abbr:"MS", regular:4.005, mid:4.469, premium:4.899, diesel:5.621 },
  { state:"Missouri", abbr:"MO", regular:3.929, mid:4.372, premium:4.71, diesel:5.259 },
  { state:"Montana", abbr:"MT", regular:4.179, mid:4.51, premium:4.882, diesel:5.38 },
  { state:"Nebraska", abbr:"NE", regular:3.886, mid:4.071, premium:4.571, diesel:5.261 },
  { state:"Nevada", abbr:"NV", regular:5.323, mid:5.669, premium:5.98, diesel:6.766 },
  { state:"New Hampshire", abbr:"NH", regular:4.253, mid:4.853, premium:5.354, diesel:6.266 },
  { state:"New Jersey", abbr:"NJ", regular:4.288, mid:4.887, premium:5.173, diesel:6.282 },
  { state:"New Mexico", abbr:"NM", regular:4.212, mid:4.675, premium:5.01, diesel:5.826 },
  { state:"New York", abbr:"NY", regular:4.458, mid:5.005, premium:5.417, diesel:6.429 },
  { state:"North Carolina", abbr:"NC", regular:4.12, mid:4.603, premium:5.035, diesel:6.132 },
  { state:"North Dakota", abbr:"ND", regular:3.872, mid:4.242, premium:4.692, diesel:5.246 },
  { state:"Ohio", abbr:"OH", regular:4.043, mid:4.623, premium:5.179, diesel:5.79 },
  { state:"Oklahoma", abbr:"OK", regular:3.694, mid:4.146, premium:4.457, diesel:5.124 },
  { state:"Oregon", abbr:"OR", regular:5.365, mid:5.61, premium:5.905, diesel:6.793 },
  { state:"Pennsylvania", abbr:"PA", regular:4.423, mid:4.901, premium:5.309, diesel:6.512 },
  { state:"Rhode Island", abbr:"RI", regular:4.274, mid:4.999, premium:5.459, diesel:6.235 },
  { state:"South Carolina", abbr:"SC", regular:4.041, mid:4.523, premium:4.958, diesel:6.001 },
  { state:"South Dakota", abbr:"SD", regular:3.946, mid:4.136, premium:4.65, diesel:5.204 },
  { state:"Tennessee", abbr:"TN", regular:4.119, mid:4.622, premium:5.046, diesel:5.828 },
  { state:"Texas", abbr:"TX", regular:4.013, mid:4.53, premium:4.937, diesel:5.653 },
  { state:"Utah", abbr:"UT", regular:4.514, mid:4.818, premium:5.087, diesel:5.769 },
  { state:"Vermont", abbr:"VT", regular:4.404, mid:4.939, premium:5.439, diesel:6.327 },
  { state:"Virginia", abbr:"VA", regular:4.242, mid:4.756, premium:5.166, diesel:6.164 },
  { state:"Washington", abbr:"WA", regular:5.793, mid:6.09, premium:6.344, diesel:7.471 },
  { state:"West Virginia", abbr:"WV", regular:4.207, mid:4.657, premium:5.153, diesel:5.946 },
  { state:"Wisconsin", abbr:"WI", regular:4.036, mid:4.587, premium:5.225, diesel:5.34 },
  { state:"Wyoming", abbr:"WY", regular:4.15, mid:4.487, premium:4.805, diesel:5.435 }
];
